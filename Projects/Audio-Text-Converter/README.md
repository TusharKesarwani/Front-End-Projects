This is the app which is made using HTML and JavaScript.In order to run the app on your device so just for and clone the repo and start to run index.html file.
