      ...
      lines: [
        {
          ...
          alpha: 0.3,
          latitudes: [
            23.684994, 48.8567, 43.8163, 34.3, 23, 61.52401, 20.593684,
            33.223191,
          ],
          longitudes: [
            90.356331, 2.351, -79.4287, -118.15, -82, 105.318756, 78.96288,
            43.679291,
          ],
        },
        {
        ...
        eventDataLoader: {
          ...
          postProcess: function (data) {
            for (var x in data) {
              ...
              data[x].Description = data[x].Description.replace(
                "Upgrade",
                '<strong style="color: #0c0">Upgrade</strong>'
              ).replace(
                "Downgrade",
                '<strong style="color: #c00">Downgrade</strong>'
              );
              data[x] = {
                type: "pin",
                graph: "g1",
