        ...
        $selectOptions.each(function (index) {
          ...
          if (isOptgroup && $this.data("divider") !== true) {
            ...
            if ($this.index() === 0) {
              ...
              liIndex++;
              _li.push(
                generateDiv(label, "dropdown-header" + optGroupClass, optID)
              );
            }
            ...
            _li.push(
              generateA(generateSpan(text, optionClass, inline, tokens), index)
            );
          }
          ...
          var getSize = function () {
            var minHeight,
              ...
              lisVisible = Array.prototype.filter
                ? Array.prototype.filter.call(lis, hasClass("d-none", false))
                : that.$lis.not(".d-none"),
