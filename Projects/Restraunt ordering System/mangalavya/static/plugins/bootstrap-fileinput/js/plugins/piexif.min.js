!(function () {
  ...
  function r(e, t, r) {
    ...
    if ("Byte" == t)
      ...
      (o = e.length), 1 >= o ? (S = n(e)) : ((S = s(">L", [r])), (c = n(e)));
    else if ("Ascii" == t)
      (l = e + "\x00"),
        (o = l.length),
        o > 4 ? ((S = s(">L", [r])), (c = l)) : (S = l + p("\x00", 4 - o));
    else if ("Rational" == t) {
      if ("number" == typeof e[0])
        (o = 1), (m = e[0]), (y = e[1]), (l = s(">L", [m]) + s(">L", [y]));
      else {
        (o = e.length), (l = "");
        for (var f = 0; o > f; f++)
  ...
  function o(e, t, a) {
    ...
    for (var m in e)
      if (
        ("string" == typeof m && (m = parseInt(m)),
        !(
          ("0th" == t && [34665, 34853].indexOf(m) > -1) ||
          ("Exif" == t && 40965 == m) ||
          ("1st" == t && [513, 514].indexOf(m) > -1)
        ))
      ) {
        var c = e[m],
          S = s(">H", [m]),
  ...
  function l(e) {
    ...
    if ("د" == e.slice(0, 2))
      (t = y(e)),
        (a = c(t)),
        a ? (this.tiftag = a.slice(10)) : (this.tiftag = null);
  ...
  function s(e, t) {
    ...
    if (e.length - 1 != t.length)
      throw (
        "'pack' error. " + (e.length - 1) + " marks, " + t.length + " elements."
      );
    var a;
    if ("<" == e[0]) a = !0;
    else {
    ...
    for (var i = "", n = 1, r = null, o = null, l = null; (o = e[n]); ) {
      if ("b" == o.toLowerCase()) {
        if (((r = t[n - 1]), "b" == o && 0 > r && (r += 256), r > 255 || 0 > r))
          throw "'pack' error.";
        l = String.fromCharCode(r);
      } else if ("H" == o) {
        if (((r = t[n - 1]), r > 65535 || 0 > r)) throw "'pack' error.";
        (l =
          String.fromCharCode(Math.floor((r % 65536) / 256)) +
          String.fromCharCode(r % 256)),
          a && (l = l.split("").reverse().join(""));
      } else {
        if ("l" != o.toLowerCase()) throw "'pack' error.";
        if (
          ((r = t[n - 1]),
          "l" == o && 0 > r && (r += 4294967296),
          r > 4294967295 || 0 > r)
        )
          throw "'pack' error.";
        (l =
          String.fromCharCode(Math.floor(r / 16777216)) +
          String.fromCharCode(Math.floor((r % 16777216) / 65536)) +
          String.fromCharCode(Math.floor((r % 65536) / 256)) +
          String.fromCharCode(r % 256)),
          a && (l = l.split("").reverse().join(""));
      }
  ...
  function m(e, t) {
    ...
    for (
      var r = [], o = 0, l = 1, s = null, m = null, p = null, y = "";
      (m = e[l]);
      ...
      if ("b" == m.toLowerCase())
        ...
        (p = 2),
          (y = t.slice(o, o + p)),
          n && (y = y.split("").reverse().join("")),
          (s = 256 * y.charCodeAt(0) + y.charCodeAt(1));
      else {
        ...
        (p = 4),
          ...
          n && (y = y.split("").reverse().join("")),
          (s =
            16777216 * y.charCodeAt(0) +
            65536 * y.charCodeAt(1) +
            256 * y.charCodeAt(2) +
            y.charCodeAt(3)),
          "l" == m && s >= 2147483648 && (s -= 4294967296);
      }
      r.push(s), (o += p), (l += 1);
    }
    return r;
  ...
  function y(e) {
    ...
    for (var t = 2, a = ["د"]; ; ) {
      ...
      var i = m(">H", e.slice(t + 2, t + 4))[0],
        n = t + i + 2;
      if ((a.push(e.slice(t, n)), (t = n), t >= e.length))
  ...
  function c(e) {
    for (var t, a = 0; a < e.length; a++)
      if (
        ((t = e[a]), "؇" == t.slice(0, 2) && "Exif\x00\x00" == t.slice(4, 10))
      )
        return t;
    return null;
  }
  function S(e, t) {
    return (
      "؈" == e[1].slice(0, 2) &&
      "؇" == e[2].slice(0, 2) &&
      "Exif\x00\x00" == e[2].slice(4, 10)
        ? t
          ? ((e[2] = t), (e = ["د"].concat(e.slice(2))))
          : (e =
              null == t
                ? e.slice(0, 2).concat(e.slice(3))
                : e.slice(0).concat(e.slice(2)))
        : "؈" == e[1].slice(0, 2)
        ? t && (e[1] = t)
        : "؇" == e[1].slice(0, 2) && "Exif\x00\x00" == e[1].slice(4, 10)
        ? t
          ? (e[1] = t)
          : null == t && (e = e.slice(0).concat(e.slice(2)))
        : t && (e = [e[0], t].concat(e.slice(1))),
      e.join("")
    );
  }
  var f = {};
  if (
    ...
    (f.remove = function (e) {
      ...
      var a = y(e);
      if ("؇" == a[1].slice(0, 2) && "Exif\x00\x00" == a[1].slice(4, 10))
        a = [a[0]].concat(a.slice(2));
      else {
        if ("؇" != a[2].slice(0, 2) || "Exif\x00\x00" != a[2].slice(4, 10))
    ...
    (f.insert = function (e, t) {
      ...
      if ("د" == t.slice(0, 2));
        ...
        if (
          "data:image/jpeg;base64," != t.slice(0, 23) &&
          "data:image/jpg;base64," != t.slice(0, 22)
        )
          throw "Given data is not jpeg.";
        (t = d(t.split(",")[1])), (a = !0);
      }
    ...
    (f.load = function (e) {
      ...
      if (
        ...
        34665 in a["0th"] &&
          ((n = a["0th"][34665]), (a.Exif = i.get_ifd(n, "Exif"))),
        34853 in a["0th"] &&
          ((n = a["0th"][34853]), (a.GPS = i.get_ifd(n, "GPS"))),
        40965 in a.Exif &&
          ((n = a.Exif[40965]), (a.Interop = i.get_ifd(n, "Interop"))),
        "\x00\x00\x00\x00" != r &&
          ((n = m(i.endian_mark + "L", r)[0]),
          (a["1st"] = i.get_ifd(n, "1st")),
          513 in a["1st"] && 514 in a["1st"]))
      ) {
    ...
    (f.dump = function (a) {
      var i,
        ...
        u = !1;
      (i = "0th" in y ? y["0th"] : {}),
        ("Exif" in y && Object.keys(y.Exif).length) ||
        ("Interop" in y && Object.keys(y.Interop).length)
          ? ((i[34665] = 1),
            (S = !0),
            (n = y.Exif),
            "Interop" in y && Object.keys(y.Interop).length
              ? ((n[40965] = 1), (d = !0), (r = y.Interop))
              : Object.keys(n).indexOf(
                  f.ExifIFD.InteroperabilityTag.toString()
                ) > -1 && delete n[40965])
          : Object.keys(i).indexOf(f.ImageIFD.ExifTag.toString()) > -1 &&
            delete i[34665],
        "GPS" in y && Object.keys(y.GPS).length
          ? ((i[f.ImageIFD.GPSTag] = 1), (h = !0), (l = y.GPS))
          : Object.keys(i).indexOf(f.ImageIFD.GPSTag.toString()) > -1 &&
            delete i[f.ImageIFD.GPSTag],
        "1st" in y &&
          "thumbnail" in y &&
          null != y.thumbnail &&
          ((u = !0), (y["1st"][513] = 1), (y["1st"][514] = 1), (m = y["1st"]));
      var P,
        C,
        R,
        L,
        ...
        w = "";
      if (
        (S && ((P = o(n, "Exif", D)), (A = P[0].length + 12 * d + P[1].length)),
        h && ((C = o(l, "GPS", D + A)), (v = C.join("")), (b = v.length)),
        d)
      ) {
        var F = D + A + b;
      ...
      if (u) {
        var F = D + A + b + k;
        if (((L = o(m, "1st", F)), (x = t(y.thumbnail)), x.length > 64e3))
    ...
    (l.prototype = {
      get_ifd: function (e, t) {
        ...
        return (
          "0th" == t &&
            ((e = r + 12 * n),
            (i.first_ifd_pointer = this.tiftag.slice(e, e + 4))),
          i
        );
      },
      convert_value: function (e) {
        ...
        if (1 == i)
          n > 4
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = m(
                this.endian_mark + p("B", n),
                this.tiftag.slice(t, t + n)
              )))
            : (a = m(this.endian_mark + p("B", n), r.slice(0, n)));
        else if (2 == i)
          n > 4
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = this.tiftag.slice(t, t + n - 1)))
            : (a = r.slice(0, n - 1));
        else if (3 == i)
          n > 2
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = m(
                this.endian_mark + p("H", n),
                this.tiftag.slice(t, t + 2 * n)
              )))
            : (a = m(this.endian_mark + p("H", n), r.slice(0, 2 * n)));
        else if (4 == i)
          n > 1
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = m(
                this.endian_mark + p("L", n),
                this.tiftag.slice(t, t + 4 * n)
              )))
            : (a = m(this.endian_mark + p("L", n), r));
        else if (5 == i)
          if (((t = m(this.endian_mark + "L", r)[0]), n > 1)) {
            ...
            for (var o = 0; n > o; o++)
              a.push([
                m(
                  this.endian_mark + "L",
                  this.tiftag.slice(t + 8 * o, t + 4 + 8 * o)
                )[0],
                m(
                  this.endian_mark + "L",
                  this.tiftag.slice(t + 4 + 8 * o, t + 8 + 8 * o)
                )[0],
              ]);
          } else
            a = [
              m(this.endian_mark + "L", this.tiftag.slice(t, t + 4))[0],
              m(this.endian_mark + "L", this.tiftag.slice(t + 4, t + 8))[0],
            ];
        else if (7 == i)
          n > 4
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = this.tiftag.slice(t, t + n)))
            : (a = r.slice(0, n));
        else {
          if (10 != i)
            throw (
              "Exif might be wrong. Got incorrect value type to decode. type:" +
              i
            );
          if (((t = m(this.endian_mark + "L", r)[0]), n > 1)) {
            a = [];
    ...
    var h = function (e) {
      for (
        ...
        (t = e.charCodeAt(m++)),
          ...
          (o = ((15 & a) << 2) | (i >> 6)),
          (l = 63 & i),
          isNaN(a) ? (o = l = 64) : isNaN(i) && (l = 64),
          (s = s + p.charAt(n) + p.charAt(r) + p.charAt(o) + p.charAt(l));
      return s;
    };
  ...
  if ("undefined" == typeof d)
    var d = function (e) {
      ...
      for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); m < e.length; )
        (n = p.indexOf(e.charAt(m++))),
          (r = p.indexOf(e.charAt(m++))),
          (o = p.indexOf(e.charAt(m++))),
          (l = p.indexOf(e.charAt(m++))),
          (t = (n << 2) | (r >> 4)),
          (a = ((15 & r) << 4) | (o >> 2)),
          (i = ((3 & o) << 6) | l),
          (s += String.fromCharCode(t)),
          64 != o && (s += String.fromCharCode(a)),
          64 != l && (s += String.fromCharCode(i));
      return s;
    };
  var g = {
      Byte: 1,
  ...
  (u["0th"] = u.Image),
    ...
    (f.InteropIFD = { InteroperabilityIndex: 1 }),
    (f.GPSHelper = {
