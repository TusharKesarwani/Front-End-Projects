    ...
    (t = {
      ...
      dataURI2Blob: function (e) {
        ...
        return (
          ...
          d
            ? new Blob([t.hasArrayBufferViewSupport() ? r : a], { type: s })
      ...
      arrayBuffer2String: function (e) {
        ...
        for (t = n.length; o < t; )
          switch ((i = n[o++]) >> 4) {
            ...
            case 13:
              (a = n[o++]),
                (s += String.fromCharCode(((31 & i) << 6) | (63 & a)));
              break;
            case 14:
              (a = n[o++]),
                (r = n[o++]),
        ...
        if (e && e.length) {
          ...
          e.off(r).on(r, function () {
            var r = e.get(0),
              ...
              l = t.getRotation(a);
            if (
              (e.data("orientation", a), n && i.data("orientation", a), a < 5)
            )
              return t.setTransform(r, l), void t.setTransform(n, l);
            var d = Math.atan(o / s),
              c = Math.sqrt(Math.pow(s, 2) + Math.pow(o, 2)),
              h = c ? s / Math.cos(Math.PI / 2 + d) / c : 1,
              p = " scale(" + Math.abs(h) + ")";
    ...
    ((i = function (i, a) {
      ...
      _cleanup: function () {
        (this.reader = null),
          ...
          (this.uploadStatus = {}),
          (this.uploadLog = []),
          (this.uploadAsyncCount = 0),
          (this.loadedImages = []),
          (this.totalImagesCount = 0),
          (this.ajaxRequests = []),
          this.clearStack(),
          (this.fileBatchCompleted = !0),
          this.isPreviewable || (this.showPreview = !1),
          (this.isError = !1),
          (this.ajaxAborted = !1),
          (this.cancelling = !1);
      },
      ...
      _initTemplateDefaults: function () {
        var i,
          ...
          c,
          h = this;
        (i = t.closeButton("fileinput-remove")),
          (a =
            '<div id="' +
            t.MODAL_ID +
          ...
          (d =
            ...
            t.DEFAULT_PREVIEW +
            "\n</div>\n"),
          (c = { width: "100%", height: "100%", "min-height": "480px" }),
          h._isPdfRendered() &&
            (l = h.pdfRendererTemplate.replace("{renderer}", h.pdfRendererUrl)),
          (h.defaults = {
            layoutTemplates: {
              main1:
            ...
            previewMarkupTags: {
              tagBefore1:
                '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-template="{template}"><div class="kv-file-content">\n',
              tagBefore2:
                '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-template="{template}" title="{caption}"><div class="kv-file-content">\n',
              tagAfter: "</div>{footer}\n</div>\n",
            },
            previewContentTemplates: {
              ...
              office:
                '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}" {style}></iframe>',
              gdocs:
          ...
          e.each(h.defaults, function (t, i) {
            "allowedPreviewTypes" !== t
              ? (h[t] = e.extend(!0, {}, i, h[t]))
              : void 0 === h.allowedPreviewTypes && (h.allowedPreviewTypes = i);
          }),
        ...
        (i.previewCache = {
          ...
          get: function (a, r) {
            ...
            return m
              ? ((r = void 0 === r || r),
                ...
                (c = t.ifSet("filetype", f, o)),
                (l = i.previewCache.footer(a, r, (f && f.size) || null)),
                (h = t.ifSet("frameClass", f)),
                (n = v
                  ? w(o, m, d, c, g, l, p, h)
                  : w("generic", m, d, c, g, l, p, h, o).setTokens({
                      content: u.content[a],
                    })),
                u.tags.length && u.tags[a] && (n = t.replaceTags(n, u.tags[a])),
                t.isEmpty(f) ||
          ...
          footer: function (e, a, r) {
            ...
            var s,
              ...
              c = t.ifSet("url", o, !1),
              h = t.ifSet("key", o, null),
              p = i.fileActionSettings,
              u = i.initialPreviewShowDelete || !1,
              f = o.downloadUrl || i.initialPreviewDownloadUrl || "",
              m = o.filename || o.caption || "",
              g = !!f,
              ...
              b = t.ifSet("showDrag", o, t.ifSet("showDrag", p, !0)),
              C = !1 === c && a;
            return (
              (w = w && !1 !== o.downloadUrl && !!f),
              (s = i._renderFileActions(!1, w, v, _, b, C, c, h, !0, f, m)),
              i
      ...
      _setValidationError: function (e) {
        (e = (e ? e + " " : "") + "has-error"),
          ...
          t.addCss(this.$captionContainer, "is-invalid");
      },
      _resetErrors: function (e) {
        var t = this.$errorContainer;
        (this.isError = !1),
          this.$container.removeClass("has-error"),
          this.$captionContainer.removeClass("is-invalid"),
          t.html(""),
        ...
        return (
          ...
          this.showAjaxErrorDetails &&
            ...
            ((n = (o = e.trim(o.replace(/\n\s*\n/g, "\n"))).length
              ...
              : ""),
            (s += s ? n : o)),
          s || (s = this.msgAjaxError.replace("{operation}", t)),
          (this.cancelling = !1),
          r ? "<b>" + r + ": </b>" + s : s
        );
      },
      ...
      _listen: function () {
        ...
        i._handler(a, "click", function (e) {
          ...
          i._handler(
            n.find(".fileinput-remove:not([disabled])"),
            "click",
            e.proxy(i.clear, i)
          ),
          i._handler(
            n.find(".fileinput-cancel"),
            "click",
            e.proxy(i.cancel, i)
          ),
          i._initDragDrop(),
              ...
              r.readEntries(function (r) {
                if (r && r.length > 0) {
                  for (a = 0; a < r.length; a++)
                    s._scanDroppedItems(r[a], t, i + e.name + "/");
                  n();
                }
                return null;
              }, o);
      ...
      _zoneDragEnter: function (i) {
        ...
        if ((this._zoneDragDropInit(i), this.isDisabled || !a))
          return (
      ...
      _zoneDragLeave: function (e) {
        this._zoneDragDropInit(e),
          this.isDisabled || this.$dropZone.removeClass("file-highlighted");
      },
      _zoneDrop: function (e) {
        ...
        if ((e.preventDefault(), !a.isDisabled && !t.isEmpty(s)))
          if (l > 0) {
          ...
          ((i = {
            ...
            onSort: function (i) {
              var r = i.oldIndex,
                n = i.newIndex,
                o = 0;
              (a.initialPreview = t.moveArray(a.initialPreview, r, n, s)),
      ...
      _initZoomButtons: function () {
        ...
        s.show(),
          ...
          n &&
            ...
            t.length && t.attr("id") === a && s.attr("disabled", !0),
      ...
      _maximizeZoomDialog: function () {
        ...
        t.addClass("file-zoom-fullscreen"),
          ...
          r && r.length && (n -= r.outerHeight(!0) - r.height()),
      ...
      _setZoomContent: function (i, a) {
        var r,
          ...
          m = f.find(".btn-prev"),
          g = f.find(".btn-next"),
          v = f.find(".btn-fullscreen"),
          w = f.find(".btn-borderless"),
          _ = f.find(".btn-toggleheader"),
          b = p.$preview.find("#zoom-" + u);
        (n = b.attr("data-template") || "generic"),
          (s = (r = b.find(".kv-file-content")).length ? r.html() : ""),
          (o = (i.data("caption") || "") + " " + (i.data("size") || "")),
          f
            .find(".kv-zoom-title")
            .attr("title", e("<div/>").html(o).text())
            .html(o),
          (l = f.find(".kv-zoom-body")),
          f.removeClass("kv-single-content"),
          a
            ? ((h = l.addClass("file-thumb-loading").clone().insertAfter(l)),
              l.html(s).hide(),
          ...
          p._handler(_, "click", function () {
            var e,
              t = f.find(".modal-header"),
              i = f.find(".modal-body .floating-buttons"),
              a = t.find(".kv-zoom-actions"),
              r = function (e) {
                var i = p.$modal.find(".kv-zoom-body"),
                  a = p.zoomModalHeight;
                f.hasClass("file-zoom-fullscreen") &&
          ...
          p._handler(f, "keydown", function (e) {
            ...
            37 !== t || m.attr("disabled") || p._zoomSlideShow("prev", u),
              39 !== t || g.attr("disabled") || p._zoomSlideShow("next", u);
          });
      },
      _zoomPreview: function (e) {
        ...
        t.initModal(a),
          a.html(this._getModalContent()),
          (i = e.closest(t.FRAMES)),
          this._setZoomContent(i),
          a.modal("show"),
      ...
      _zoomSlideShow: function (t, i) {
        var a,
          r,
          n,
          s = this.$modal.find(".kv-zoom-actions .btn-" + t),
        ...
        if (!s.attr("disabled")) {
          ...
          n < 0 ||
            n >= l ||
            !o[n] ||
            ((a = e(o[n])).length && this._setZoomContent(a, !0),
            this._initZoomButtons(),
        ...
        this._inputFileCount() &&
          ...
          (this.isAjaxUpload
            ? ((e = this.getFileStack()),
              ...
              e.length
                ? this._clearFileInput()
                : (e = this.$element.get(0).files))
            : (e = this.$element.get(0).files),
          e && e.length && (this.readFiles(e), this._setFileDropZoneTitle()));
      },
      ...
      _resetUpload: function () {
        (this.uploadCache = { content: [], config: [], tags: [], append: !0 }),
          (this.uploadCount = 0),
          (this.uploadStatus = {}),
          (this.uploadLog = []),
          (this.uploadAsyncCount = 0),
      ...
      _resetPreview: function () {
        var e, t;
        this.previewCache.count()
          ? ((e = this.previewCache.out()),
            this._setPreviewContent(e.content),
            this._setInitThumbAttr(),
            (t = this.initialCaption ? this.initialCaption : e.caption),
            this._setCaption(t))
      ...
      _getPreviewTemplate: function (e) {
        ...
        return t.isEmpty(this.customPreviewTags)
          ? i
          : t.replaceTags(i, this.customPreviewTags);
      },
      _getOutData: function (e, t, i) {
        return (
          (e = e || {}),
          (t = t || {}),
          (i = i || this.filestack.slice(0) || {}),
          {
            form: this.formdata,
            files: i,
      ...
      _getMsgSelected: function (e) {
        ...
        return e > 0
          ? this.msgSelected.replace("{n}", e).replace("{files}", t)
      ...
      _getFrame: function (t) {
        ...
        return i.length
          ? i
          : (this._log('Invalid thumb frame with id: "' + t + '".'), null);
      },
          ...
          e.upload &&
            e.upload.addEventListener(
              ...
              function (e) {
                ...
                e.lengthComputable && (r = Math.floor((s / n) * 100)),
      ...
      _mergeAjaxCallback: function (e, t, i) {
        ...
        "delete" === i &&
          ((r = this._ajaxDeleteSettings), (n = this.mergeAjaxDeleteCallbacks)),
          (a = r[e]),
          (r[e] =
            n && "function" == typeof a
              ? "before" === n
      ...
      _ajaxSubmit: function (t, i, a, r, n, s) {
        var o,
          l = this;
        l._raise("filepreajax", [n, s]) &&
          (l._uploadExtra(n, s),
          l._initAjaxSettings(),
          l._mergeAjaxCallback("beforeSend", t),
          l._mergeAjaxCallback("success", i),
          l._mergeAjaxCallback("complete", a),
          l._mergeAjaxCallback("error", r),
          (o = e.extend(
            !0,
            {},
            {
      ...
      _initUploadSuccess: function (i, a, r) {
        ...
        f.showPreview &&
          ...
          ((f.hasInitData = !0),
          (c = i.initialPreview || []),
          (h = i.initialPreviewConfig || []),
          (p = i.initialPreviewThumbTags || []),
          (n = void 0 === i.append || i.append),
          c.length > 0 &&
            !t.isArray(c) &&
            (c = c.split(f.initialPreviewDelimiter)),
          f._mergeArray("initialPreview", c),
          f._mergeArray("initialPreviewConfig", h),
          f._mergeArray("initialPreviewThumbTags", p),
          void 0 !== a
            ? r
              ? ((u = a.attr("data-fileindex")),
                (f.uploadCache.content[u] = c[0]),
                (f.uploadCache.config[u] = h[0] || []),
                (f.uploadCache.tags[u] = p[0] || []),
                (f.uploadCache.append = n))
              : ((o = f.previewCache.add(c, h[0], p[0], n)),
                (s = f.previewCache.get(o, !1)),
                (d = (l = e(document.createElement("div"))
                  .html(s)
                  .hide()
                  .insertAfter(a)).find(".kv-zoom-cache")) &&
                  d.length &&
                  d.insertAfter(a),
                a.fadeOut("slow", function () {
                  ...
                  e &&
                    ...
                    f._initPreviewActions(),
                    f._clearFileInput(),
                    t.cleanZoomCache(f.$preview.find("#zoom-" + a.attr("id"))),
                    a.remove(),
                    l.remove(),
                    f._initSortable();
                }))
            : (f.previewCache.set(c, h, p, n),
              f._initPreview(),
              f._initPreviewActions()));
      },
      ...
      _checkAsyncComplete: function () {
        var t, i;
        for (i = 0; i < this.filestack.length; i++)
          if (
            this.filestack[i] &&
            ((t = this.previewInitId + "-" + i),
            -1 === e.inArray(t, this.uploadLog))
          )
            return !1;
      ...
      _uploadSingle: function (i, a) {
        var r,
          ...
          v = new FormData(),
          w = m.previewInitId + "-" + i,
          _ = m.filestack.length > 0 || !e.isEmptyObject(m.uploadExtraData),
          b = e("#" + w).find(".file-thumb-progress"),
          C = { id: w, index: i };
        (m.formdata = v),
          m.showPreview &&
            ((n = e("#" + w + ":not(.file-preview-initial)")),
            (o = n.find(".kv-file-upload")),
            (l = n.find(".kv-file-remove")),
            b.show()),
          0 === g ||
            !_ ||
            ...
            (s = function () {
              var e,
                ...
                r = m.uploadCache,
                n = 0,
                s = m.cacheInitialPreview;
              m.fileBatchCompleted &&
                (s && s.content && (n = s.content.length),
                setTimeout(function () {
                  ...
                  if (m.showPreview) {
                    if (
                      ...
                      for (i = 0; i < r.content.length; i++)
                        (a = i + n),
                          (s.content[a] = r.content[i]),
                          s.config.length && (s.config[a] = r.config[i]),
                          s.tags.length && (s.tags[a] = r.tags[i]);
                      (m.initialPreview = t.cleanArray(s.content)),
                        (m.initialPreviewConfig = t.cleanArray(s.config)),
                        (m.initialPreviewThumbTags = t.cleanArray(s.tags));
                    } else
              ...
              (r = m._getOutData(s)),
                ...
                m.showPreview &&
                  (n.hasClass("file-preview-success") ||
                    (m._setThumbStatus(n, "Loading"),
                    t.addCss(n, "file-uploading")),
                  o.attr("disabled", !0),
                  l.attr("disabled", !0)),
                a || m.lock(),
                m._raise("filepreupload", [r, w, i]),
                e.extend(!0, C, r),
                m._abort(C) &&
                  (s.abort(),
                  a ||
                    (m._setThumbStatus(n, "New"),
              ...
              (r = m._getOutData(c, s)),
                ...
                setTimeout(function () {
                  t.isEmpty(s) || t.isEmpty(s.error)
                    ? (m.showPreview &&
                        (m._setThumbStatus(n, "Success"),
                        o.hide(),
                        m._initUploadSuccess(s, n, a),
                        m._setProgress(101, b)),
                      m._raise("fileuploaded", [r, h, i]),
                      a ? f(i, h) : m.updateStack(i, void 0))
                    : ((d = !0),
                      m._showUploadError(s.error, C),
                      m._setPreviewError(
                        n,
                        i,
                        m.filestack[i],
                      ...
                      m.retryErrorUploads || o.hide(),
                      a && f(i, h),
                      m._setProgress(
                        101,
                        e("#" + h).find(".file-thumb-progress"),
                        m.msgUploadError
                      ));
                }, 100);
            }),
            (p = function () {
              setTimeout(function () {
                m.showPreview &&
                  ...
                  l.removeAttr("disabled"),
                  n.removeClass("file-uploading")),
                  a ? s() : (m.unlock(!1), m._clearFileInput()),
            ...
            (u = function (t, r, s) {
              var l = m.ajaxOperations.uploadThumb,
                c = m._parseError(
                  ...
                  t,
                  s,
                  a && m.filestack[i].name ? m.filestack[i].name : null
                );
              (d = !0),
                setTimeout(function () {
                  a && f(i, w),
                    (m.uploadStatus[w] = 100),
                    m._setPreviewError(
                      n,
                      i,
                      m.filestack[i],
                    ...
                    m._showUploadError(c, C);
                }, 100);
            }),
            v.append(m.uploadFileAttr, m.filestack[i], m.filenames[i]),
            v.append("file_id", i),
            m._ajaxSubmit(c, h, p, u, w, i));
      },
      _uploadBatch: function () {
        ...
        (o.formdata = new FormData()),
          0 !== d &&
                ...
                o.showPreview &&
                  o._getThumbs().each(function () {
                    ...
                    i.hasClass("file-preview-success") ||
                      (o._setThumbStatus(i, "Loading"),
                      t.addCss(i, "file-uploading")),
                      a.attr("disabled", !0),
                      r.attr("disabled", !0);
                  }),
                o._raise("filebatchpreupload", [a]),
                o._abort(a) &&
                  (i.abort(),
                  o._getThumbs().each(function () {
                    var t = e(this),
            ...
            (a = function (i, a, r) {
              ...
              t.isEmpty(i) || t.isEmpty(i.error)
                ...
                : (o.showPreview &&
                    ...
                    o._initUploadSuccess(i)),
                  o._showUploadError(i.error, n, "filebatchuploaderror"),
                  o._setProgress(101, o.$progress, o.msgUploadError));
            }),
            (n = function () {
              o.unlock(),
                o._initSuccessThumbs(),
                o._clearFileInput(),
            ...
            (r = function (t, i, a) {
              var r = o._getOutData(t),
                n = o.ajaxOperations.uploadBatch,
                s = o._parseError(n, t, a);
              o._showUploadError(s, r, "filebatchuploaderror"),
                (o.uploadFileCount = d - 1),
                o.showPreview &&
                  (o._getThumbs().each(function () {
                    var t = e(this),
                      i = t.attr("data-fileindex");
                    t.removeClass("file-uploading"),
                      void 0 !== o.filestack[i] && o._setPreviewError(t);
                  }),
                  o._getThumbs().removeClass("file-uploading"),
                  o._getThumbs(" .kv-file-upload").removeAttr("disabled"),
                  o._getThumbs(" .kv-file-delete").removeAttr("disabled"),
                  o._setProgress(
                    101,
                    o.$progress,
                    o.msgAjaxProgressError.replace("{operation}", n)
                  ));
            }),
            e.each(l, function (e, i) {
              t.isEmpty(l[e]) ||
                o.formdata.append(o.uploadFileAttr, i, o.filenames[e]);
            }),
          ...
          n._abort(s) ||
            ((e = function (e) {
              ...
              n._raise("filebatchpreupload", [t]),
                ...
                (s.data = t),
                (s.xhr = e),
                n._abort(s) && (e.abort(), n._setProgressCancelled());
            }),
            (i = function (e, i, a) {
            ...
            (r = function (e, t, i) {
              ...
              (s.data = a),
                n._showUploadError(o, a, "filebatchuploaderror"),
                n._setProgress(
                  101,
                  n.$progress,
      ...
      _deleteFileIndex: function (i) {
        ...
        "init_" === a.substring(0, 5) &&
          ((a = parseInt(a.replace("init_", ""))),
          ...
          this.getFrames().each(function () {
            ...
            "init_" === i.substring(0, 5) &&
              (i = parseInt(i.replace("init_", ""))) > a &&
              (i--, t.attr("data-fileindex", "init_" + i));
          }),
        ...
        i.showPreview &&
          ...
          i.getFrames(" .kv-file-remove").each(function () {
            ...
            i._handler(o, "click", function () {
              if (
                !1 === i._raise("filepreremove", [d, c]) ||
                !i._validateMinCount()
              )
                return !1;
              (r = l.hasClass("file-preview-error")),
                t.cleanMemory(l),
                l.fadeOut("slow", function () {
                  t.cleanZoomCache(a.find("#zoom-" + d)),
                    i.updateStack(c, void 0),
                    i._clearObjects(l),
                    l.remove(),
                    d &&
                      r &&
                      i.$errorContainer
                        .find('li[data-file-id="' + d + '"]')
                        .fadeOut("fast", function () {
                          e(this).remove(),
                            i._errorsExist() || i._resetErrors();
                        }),
                    i._clearFileInput();
                  var o = i.getFileStack(!0),
                    h = i.previewCache.count(),
                    p = o.length,
          ...
          a.find(n).each(function () {
            ...
            if (!t.isEmpty(p) && void 0 !== u) {
              ...
              (b = parseInt(b.replace("init_", ""))),
                ...
                "function" ==
                  typeof (v =
                    t.isEmpty(g) || t.isEmpty(g.extra) ? r : g.extra) &&
                  (v = v()),
                (m = { id: h.attr("id"), key: u, extra: v }),
                (n = function (e) {
                  (i.ajaxAborted = !1),
                    i._raise("filepredelete", [u, e, v]),
                    i._abort()
                      ? e.abort()
                      : (h.removeClass(l),
                        t.addCss(w, "file-uploading"),
                        t.addCss(h, "disabled " + o));
                }),
                (s = function (e, r, n) {
                  var s, c;
                  if (!t.isEmpty(e) && !t.isEmpty(e.error))
                    return (
                      (m.jqXHR = n),
                      (m.response = e),
                      i._showError(e.error, m, "filedeleteerror"),
                      w.removeClass("file-uploading"),
                      h.removeClass("disabled " + o).addClass(l),
                      void d()
                    );
                  w.removeClass("file-uploading").addClass("file-deleted"),
                    w.fadeOut("slow", function () {
                      (b = parseInt(
                        ...
                        (c = s > 0 ? i._getMsgSelected(s) : ""),
                        i._setCaption(c),
                        i._raise("filedeleted", [u, n, v]),
                ...
                (c = function (e, t, a) {
                  ...
                  (m.jqXHR = e),
                    (m.response = {}),
                    i._showError(n, m, "filedeleteerror"),
                    w.removeClass("file-uploading"),
                    h.removeClass("disabled " + o).addClass(l),
                    d();
                }),
                ...
                i._handler(h, "click", function () {
                  if (!i._validateMinCount()) return !1;
                  (i.ajaxAborted = !1),
                    i._raise("filebeforedelete", [u, v]),
      ...
      _getSize: function (t) {
        ...
        return e.isNumeric(t) && e.isNumeric(n)
          ? ("function" == typeof s
              ? (r = s(n))
              : 0 === n
              ? (r = "0.00 B")
              : ((i = Math.floor(Math.log(n) / Math.log(1024))),
                ...
                (r = 1 * (n / Math.pow(1024, i)).toFixed(2) + " " + a[i])),
        ...
        var u,
          ...
          w =
            (window.innerWidth ||
              ...
              ? f.previewSettingsSmall[i] || f.defaults.previewSettingsSmall[i]
              : f.previewSettings[i] || f.defaults.previewSettings[i],
          _ = c || f._renderFileFooter(m, l, "auto", o),
          b = f._getPreviewIcon(r),
          C = "type-default",
          y = b && f.preferIconicPreview,
          x = b && f.preferIconicZoomPreview;
        return (
          w &&
          ...
          (u = function (a, o, l, c) {
            var u = l ? "zoom-" + s : s,
              g = f._getPreviewTemplate(a),
              w = (d || "") + " " + c;
            return (
              f.frameClass && (w = f.frameClass + " " + w),
              l && (w = w.replace(" " + t.SORT_CSS, "")),
              (g = f._parseFilePreviewIcon(g, r)),
              "text" === a && (o = t.htmlEncode(o)),
              "object" !== i ||
                n ||
                e.each(f.defaults.fileTypeSettings, function (e, t) {
                  "object" !== e &&
                    "other" !== e &&
                    t(r, n) &&
                    (C = "type-" + e);
          ...
          (h = h || s.slice(s.lastIndexOf("-") + 1)),
          f.fileActionSettings.showZoom &&
            (g = u(x ? "other" : i, a, !0, "kv-zoom-thumb")),
          (g =
            "\n" +
            f._getLayoutTemplate("zoomCache").replace("{zoomContent}", g)),
          u(y ? "other" : i, a, !1, "kv-preview-thumb") + g
        );
      },
      ...
      _previewDefault: function (i, a, r) {
        ...
        if (this.showPreview) {
          var s,
            ...
            d = i.size || 0,
            c = this.slug(o),
            h = !0 === r && !this.isAjaxUpload,
            p = t.objUrl.createObjectURL(i);
          this._clearDefaultPreview(),
            (s = this._generatePreviewTemplate("other", p, o, l, a, h, d)),
            this._addToPreview(n, s),
            this._setThumbAttr(a, c, d),
            !0 === r &&
              this.isAjaxUpload &&
              this._setThumbStatus(e("#" + a), "Error");
        }
      },
      _previewFile: function (e, t, i, a, r, n) {
        if (this.showPreview) {
          var s,
            ...
            h = this.allowedPreviewTypes,
            p = this.allowedPreviewMimeTypes,
            u = this.$preview,
            f = t.size || 0,
            m = h && h.indexOf(c) >= 0,
            g = p && -1 !== p.indexOf(l),
            v =
              "text" === c || "html" === c || "image" === c
                ? i.target.result
                : r;
          if (
            ("html" === c &&
              this.purifyHtml &&
              window.DOMPurify &&
              (v = window.DOMPurify.sanitize(v)),
            m || g)
          ) {
            (s = this._generatePreviewTemplate(c, v, o, l, a, !1, f)),
              this._clearDefaultPreview(),
      ...
      _setThumbAttr: function (t, i, a) {
        var r = e("#" + t);
        r.length &&
          ((a = a && a > 0 ? this._getSize(a) : ""),
          r.data({ caption: i, size: a }));
      },
      _setInitThumbAttr: function () {
        var e,
          ...
          s = this.previewCache.count();
        if (0 !== s)
          for (var o = 0; o < s; o++)
            (e = n.config[o]),
              (r = this.previewInitId + "-init_" + o),
              (i = t.ifSet("caption", e, t.ifSet("filename", e))),
              (a = t.ifSet("size", e)),
              this._setThumbAttr(r, i, a);
      },
      ...
      _updateFileDetails: function (e) {
        var i = this.$element,
          ...
          r =
            ...
            "",
          n = this.slug(r),
          s = this.isAjaxUpload ? a.length : e,
          o = this.previewCache.count() + s,
        ...
        this.isError
          ? (this.$previewContainer.removeClass("file-thumb-loading"),
            ...
            this.$captionContainer.removeClass("icon-visible"))
          : this._showFileIcon(),
          this._setCaption(l, this.isError),
          this.$container.removeClass("file-input-new file-input-ajax-new"),
          1 === arguments.length && this._raise("fileselect", [e, n]),
          this.previewCache.count() && this._initPreviewActions();
      },
      ...
      _setProgress: function (e, i, a) {
        var r,
          n = Math.min(e, 100),
          s = this.progressUploadThreshold,
        ...
        (i = i || this.$progress),
          t.isEmpty(l) ||
            ((r =
              s && n > s && e <= 100
                ? l.setTokens({ percent: s, status: this.msgUploadThreshold })
                : l.setTokens({
                    percent: n,
      ...
      _setFileDropZoneTitle: function () {
        ...
        this.isClickable &&
          ...
          !this.showPreview ||
            0 === i.length ||
            this.getFileStack().length > 0 ||
            !this.dropZoneEnabled ||
            (!this.isAjaxUpload && this.$element.files) ||
      ...
      _setAsyncUploadStatus: function (t, i, a) {
        var r = 0;
        this._setProgress(i, e("#" + t).find(".file-thumb-progress")),
          (this.uploadStatus[t] = i),
          e.each(this.uploadStatus, function (e, t) {
            r += t;
          }),
      ...
      _getFileCount: function (e) {
        return (
          this.validateInitialCount &&
            !this.overwriteInitial &&
            (e += this.previewCache.count()),
          e
        );
      },
      _getFileId: function (e) {
        var t,
          i = this.generateFileId;
        return "function" == typeof i
          ? i(e, event)
          : e &&
            (t = String(e.webkitRelativePath || e.fileName || e.name || null))
          ? e.size + "-" + t.replace(/[^0-9a-zA-Z_-]/gim, "")
          : null;
      },
      ...
      _setPreviewError: function (e, t, i, a) {
        void 0 !== t && this.updateStack(t, i),
          this.showPreview &&
            (!this.removeFromPreviewOnError || a
              ? (this._setThumbStatus(e, "Error"),
                this._refreshUploadButton(e, a))
              : e.remove());
      },
      _refreshUploadButton: function (e, t) {
        var i = e.find(".kv-file-upload"),
          ...
          n = a.uploadTitle;
        i.length &&
          (t && ((r = a.uploadRetryIcon), (n = a.uploadRetryTitle)),
          i.attr("title", n).html(r));
      },
      _checkDimensions: function (e, i, a, r, n, s, o) {
        var l,
          d,
          c,
          h = this[("Small" === i ? "min" : "max") + "Image" + s];
        !t.isEmpty(h) &&
          a.length &&
          ((c = a[0]),
          (d =
          ...
          ("Small" === i ? d >= h : d <= h) ||
            ((l = this["msgImage" + s + i].setTokens({ name: n, size: h })),
            this._showUploadError(l, o),
            this._setPreviewError(r, e, null)));
      },
      ...
      _validateImageOrientation: function (e, i, a, r, n, s, o) {
        var l, d;
        (d = (l = e.length && this.autoOrientImage ? this._getExifObj(o) : null)
          ? l["0th"][piexif.ImageIFD.Orientation]
          : null)
          ? (t.setImageOrientation(
              e,
              this.$preview.find("#zoom-" + a + " img"),
              d
            ),
            this._raise("fileimageoriented", { $img: e, file: i }),
            this._validateImage(a, r, n, s, o, l))
          : this._validateImage(a, r, n, s, o, l);
      },
          ...
          f
            .one("load", function () {
              (l = p.width()),
                ...
                l > d && f.css("width", "100%"),
                (o = { ind: u, id: t }),
                c._checkDimensions(u, "Small", f, p, i, "Width", o),
                c._checkDimensions(u, "Small", f, p, i, "Height", o),
                c.resizeImage ||
                  (c._checkDimensions(u, "Large", f, p, i, "Width", o),
                  c._checkDimensions(u, "Large", f, p, i, "Height", o)),
      ...
      _validateAllImages: function () {
        var e,
          ...
          i,
          a = { val: 0 },
          r = this.loadedImages.length,
          n = this.resizeIfSizeMoreThan;
        if (
          r === this.totalImagesCount &&
          (this._raise("fileimagesloaded"), this.resizeImage)
        )
          for (e = 0; e < this.loadedImages.length; e++)
            (t = this.loadedImages[e]).validated ||
              ((i = t.siz) && i > 1e3 * n && this._getResizedImage(t, a, r),
              (this.loadedImages[e].validated = !0));
      },
      _getResizedImage: function (i, a, r) {
        var n,
          ...
          m = 1,
          g = h.maxImageWidth || u,
          v = h.maxImageHeight || f,
          w = !(!u || !f),
          _ = h.imageCanvas,
          b = h.imageCanvasContext,
          C = i.typ,
          y = i.pid,
          x = i.ind,
          T = i.thumb,
        ...
        if (
          ((d = function (e, t, i) {
            h.isAjaxUpload
              ? h._showUploadError(e, t, i)
              : h._showError(e, t, i),
              h._setPreviewError(T, x);
          }),
          (h.filestack[x] && w && !(u <= g && f <= v)) ||
            (w && h.filestack[x] && h._raise("fileimageresized", [y, x]),
            a.val++,
            a.val === r && h._raise("fileimagesresized"),
            w))
        ) {
          (C = C || h.resizeDefaultImageType),
            (s = u > g),
            (o = f > v),
            (m =
            ...
            (_.height = f);
          try {
            b.drawImage(p, 0, 0, u, f),
              (l = _.toDataURL(C, h.resizeQuality)),
              E &&
                ((c = window.piexif.dump(E)), (l = window.piexif.insert(c, l))),
              (n = t.dataURI2Blob(l)),
              (h.filestack[x] = n),
              h._raise("fileimageresized", [y, x]),
              a.val++,
              a.val === r && h._raise("fileimagesresized", [void 0, void 0]),
              n instanceof Blob ||
                d(
                  h.msgImageResizeError,
                  { id: y, index: x },
            ...
            a.val++,
              a.val === r && h._raise("fileimagesresized", [void 0, void 0]),
              d(
                h.msgImageResizeException.replace("{errors}", e.message),
                { id: y, index: x },
                "fileimageresizeexception"
              );
          }
        } else
          d(h.msgImageResizeError, { id: y, index: x }, "fileimageresizeerror");
      },
        ...
        if (this.$caption.length) {
          if ((this.$captionContainer.removeClass("icon-visible"), a))
            (r = e("<div>" + this.msgValidationError + "</div>").text()),
              (l = (o = d.length)
                ? 1 === o && d[0]
                  ? this._getFileNames()[0]
                  : this._getMsgSelected(o)
                : this._getMsgSelected(this.msgNo)),
              (n = t.isEmpty(i) ? l : i),
              (s =
                '<span class="' +
      ...
      _renderButton: function (e) {
        ...
        return (
          ...
          t.isEmpty(s) ||
            (s =
              ' <span class="' + this.buttonLabelClass + '">' + s + "</span>"),
          i.setTokens({
            type: l,
            css: a,
            title: r,
      ...
      _renderThumbProgress: function () {
        return (
          ...
          this.progressTemplate.setTokens({
            percent: "0",
      ...
      _renderFileFooter: function (e, i, a, r) {
        var n,
          ...
          p = this._getLayoutTemplate("indicator"),
          u = r ? s.indicatorError : s.indicatorNew,
          f = r ? s.indicatorErrorTitle : s.indicatorNewTitle,
      ...
      _renderFileActions: function (e, t, i, a, r, n, s, o, l, d, c) {
        ...
        return (
          ...
          e &&
            (m = this._getLayoutTemplate("actionUpload").setTokens({
              uploadClass: b.uploadClass,
              uploadIcon: b.uploadIcon,
              uploadTitle: b.uploadTitle,
            })),
          t &&
            (g = (g = this._getLayoutTemplate("actionDownload").setTokens({
            ...
            })).setTokens({ filename: c, key: o })),
          a &&
            (v = this._getLayoutTemplate("actionZoom").setTokens({
          ...
          r &&
            l &&
            ((h = "drag-handle-init " + b.dragClass),
            (w = this._getLayoutTemplate("actionDrag").setTokens({
              dragClass: h,
      ...
      _change: function (i) {
        ...
        if (!a.changeTriggered) {
          var r,
            ...
            v = a.isAjaxUpload,
            w = [],
            _ = g ? arguments[1] : m.get(0).files,
            b = !v && t.isEmpty(m.attr("multiple")) ? 1 : a.maxFileCount,
            C = a.filestack.length,
            y = t.isEmpty(m.attr("multiple")) && C > 0,
            x = a._getFileIds();
          if (
            ((a.reader = null),
            a._resetUpload(),
            ...
            v
              ...
              : ((_ =
                  i.target && void 0 === i.target.files
                    ...
                    : i.target.files || {}),
                (w = _)),
            t.isEmpty(w) || 0 === w.length)
          )
            return v || a.clear(), void a._raise("fileselectnone");
          if (
            (a._resetErrors(),
            (n = w.length),
            (r = a._getFileCount(v ? a.getFileStack().length + n : n)),
            b > 0 && r > b)
          ) {
            if (!a.autoReplace || n > b)
              return (
                (s = a.autoReplace && n > b ? n : r),
                (o = b),
                (f = a.msgFilesTooMany.replace("{m}", o).replace("{n}", s)),
                (a.isError =
                  ((l = f),
                  (d = null),
                  (c = null),
                  (h = null),
                  (p = e.extend(!0, {}, a._getOutData({}, {}, _), {
                    id: c,
                    index: h,
                  })),
                  (u = { id: c, index: h, file: d, files: _ }),
                  v ? a._showUploadError(l, p) : a._showError(l, u))),
            ...
            !v || y
              ? (a._resetPreviewThumbs(!1), y && a.clearStack())
              : !v ||
                0 !== C ||
      ...
      _abort: function (t) {
        ...
        return this.ajaxAborted &&
          ...
          ? (((i = e.extend(!0, {}, this._getOutData(), t)).abortData =
          ...
          "-1" !== l &&
            ...
            (void 0 !== d
              ? ((r[a] = d),
                ...
                (s[a] = i._getFileId(d)),
                o.attr({ id: i.previewInitId + "-" + a, "data-fileindex": a }),
                a++)
              : o.attr({
      ...
      _isFileSelectionValid: function (e) {
        return (
          ...
          this.required && !this.getFilesCount()
            ? (this.$errorContainer.html(""),
              this._showUploadError(this.msgFileRequired),
              !1)
            : !(
                this.minFileCount > 0 &&
      ...
      updateStack: function (e, t) {
        return (
          (this.filestack[e] = t),
          (this.filenames[e] = this._getFileName(t)),
          (this.fileids[e] = (t && this._getFileId(t)) || null),
          this.$element
        );
      },
      addToStack: function (e) {
        return (
          this.filestack.push(e),
          this.filenames.push(this._getFileName(e)),
          this.fileids.push(this._getFileId(e)),
          this.$element
        );
      },
          ...
          y = function (t, n, s, o) {
            ...
            r._previewDefault(n, s, !0),
              r.isAjaxUpload
                ...
                : (u = 0),
              r._initFileActions(),
              (l = e("#" + s)).find(".kv-file-upload").hide(),
        ...
        (r.loadedImages = []),
          ...
          (a = function (x) {
            ...
            var T,
              ...
              O = f.image,
              L = f.html,
              M = B && B.name ? r.slug(B.name) : "",
              Z = ((B && B.size) || 0) / 1e3,
              N = "",
              H = B ? t.objUrl.createObjectURL(B) : null,
              W = 0,
              q = "",
              V = 0,
              K = function () {
            ...
            if (B) {
              ...
              if (!1 !== M) {
                ...
                if (
                  ...
                  (T = Z.toFixed(2)),
                  r.maxFileSize > 0 && Z > r.maxFileSize)
                )
                  return (
                ...
                if (!t.isEmpty(g) && t.isArray(g)) {
                  ...
                  if (0 === W)
                    return (
                      (S = r.msgInvalidFileType.setTokens({
                        name: M,
                        types: q,
                      })),
                      void y(S, B, U, x)
                ...
                if (!r.showPreview)
                  return (
                    ...
                    void r._raise("fileloaded", [B, U, x, o])
                  );
                if (!C && Z > b)
                  return (
                    r.addToStack(B),
                    l.addClass("file-thumb-loading"),
                    r._previewDefault(B, U),
                    r._initFileActions(),
                    r._updateFileDetails(u),
                    void a(x + 1)
                  );
                s.length && void 0 !== FileReader
                  ? ((D = R(B.type, M)),
                    (z = L(B.type, M)),
                    ($ = O(B.type, M)),
                    d.html(c.replace("{index}", x + 1).replace("{files}", u)),
                    l.addClass("file-thumb-loading"),
                    ...
                    (o.onload = function (i) {
                      ...
                      if (
                        ...
                        for (
                          s = new Uint8Array(i.target.result), E = 0;
                          E < s.length;
                          E++
                        )
                          (l = s[E].toString(16)), u.push(l);
                        if (
                          ((a = u.join("").toLowerCase().substring(0, 8)),
                          (c = t.getMimeType(a, "", "")),
                          t.isEmpty(c) &&
                            ((d = t.arrayBuffer2String(o.result)),
                            (c = t.isSvg(d)
                              ? "image/svg+xml"
                          ...
                          return (
                            (h = j),
                            ((p = new FileReader()).onerror = function (e) {
                              r._errorHandler(e, M);
                            }),
                            (p.onload = function (e) {
                              r._previewFile(x, B, e, U, H, n),
                                r._initFileActions(),
                                K();
                            }),
                            void (h
                              ? p.readAsText(B, r.textEncoding)
                              : p.readAsDataURL(B))
                          );
                      }
                      r._previewFile(x, B, i, U, H, n),
                        r._initFileActions(),
                        K();
                    }),
          ...
          r._updateFileDetails(u, !1);
      },
      lock: function () {
        return (
          this._resetErrors(),
          this.disable(),
          this.showRemove && this.$container.find(".fileinput-remove").hide(),
          this.showCancel && this.$container.find(".fileinput-cancel").show(),
      ...
      unlock: function (e) {
        return (
          void 0 === e && (e = !0),
          this.enable(),
          this.showCancel && this.$container.find(".fileinput-cancel").hide(),
          this.showRemove && this.$container.find(".fileinput-remove").show(),
          e && this._resetFileStack(),
          this._raise("fileunlock", [this.filestack, this._getExtraData()]),
          this.$element
        );
      },
      cancel: function () {
      ...
      reset: function () {
        if (this._raise("filereset"))
          return (
            ...
            (this.getFrames().length || this.dropZoneEnabled) &&
              this.$container.removeClass("file-input-new"),
            this.clearStack(),
            (this.formdata = {}),
      ...
      disable: function () {
        return (
          ...
          this.$container
            ...
            .attr("disabled", !0),
          t.addCss(this.$container.find(".btn-file"), "disabled"),
          this._initDragDrop(),
          this.$element
        );
      },
      enable: function () {
        return (
          ...
          this.$container
            ...
            .removeAttr("disabled"),
          this.$container.find(".btn-file").removeClass("disabled"),
          this._initDragDrop(),
          this.$element
        );
      },
      upload: function () {
        var i,
          a,
          r,
          n = this.getFileStack().length,
          s = !e.isEmptyObject(this._getExtraData());
        if (
          this.isAjaxUpload &&
          !this.isDisabled &&
          this._isFileSelectionValid(n)
        )
          if ((this._resetUpload(), 0 !== n || s))
            if (
              (this.$progress.show(),
              (this.uploadCount = 0),
              (this.uploadStatus = {}),
              ...
              this._uploadExtraOnly();
            else {
              if (
                ((r = this.filestack.length),
                (this.hasInitData = !1),
                !this.uploadAsync)
              )
                return this._uploadBatch(), this.$element;
              for (
                a = this._getOutData(),
                  this._raise("filebatchpreupload", [a]),
                  this.fileBatchCompleted = !1,
                  this.uploadCache = {
                    content: [],
                    config: [],
                    tags: [],
                  ...
                  this.uploadAsyncCount = this.getFileStack().length,
                  i = 0;
                i < r;
                i++
              )
                (this.uploadCache.content[i] = null),
                  (this.uploadCache.config[i] = null),
                  (this.uploadCache.tags[i] = null);
              for (
                this.$preview
                  .find(".file-preview-initial")
                  .removeClass(t.SORT_CSS),
                  this._initSortable(),
                  this.cacheInitialPreview = this.getPreview(),
                  i = 0;
                i < r;
                i++
              )
                this.filestack[i] && this._uploadSingle(i, !0);
            }
