...
(function ($) {
  ...
  $.fn.fileinputLocales["pt"] = {
    ...
    msgFilesTooLess:
      "Deve seleccionar pelo menos <b>{n}</b> {files} para fazer upload.",
    msgFilesTooMany:
      "Número máximo de ficheiros seleccionados <b>({n})</b> excede o limite máximo de <b>{m}</b>.",
    msgFileNotFound: 'Ficheiro "{name}" não encontrado!',
    msgFileSecured:
      'Restrições de segurança preventem a leitura do ficheiro "{name}".',
    ...
    msgProgress:
      "A carregar ficheiro {index} de {files} - {name} - {percent}% completo.",
