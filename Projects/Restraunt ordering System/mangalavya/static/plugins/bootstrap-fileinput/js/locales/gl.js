...
(function ($) {
  ...
  $.fn.fileinputLocales["gl"] = {
    ...
    msgSizeTooSmall:
      'O arquivo "{name}" (<b>{size} KB</b>) é demasiado pequeño e debe ser maior de <b>{minSize} KB</b>.',
    msgSizeTooLarge:
      'El arquivo "{name}" (<b>{size} KB</b>) excede o tamaño máximo permitido de <b>{maxSize} KB</b>.',
    ...
    msgFileSecured:
      'Non é posible acceder o arquivo "{name}" porque estará sendo usado por outra aplicación ou non teñamos permisos de lectura.',
    ...
    msgInvalidFileName:
      'Caracteres non válidos o no soportados no nome do arquivos "{name}".',
    msgInvalidFileType:
      'Tipo de archivo no válido para "{name}". Sólo se permiten arquivos do tipo "{types}".',
    msgInvalidFileExtension:
      'Extensión de arquivo non válido para "{name}". Só se permiten arquivos "{extensions}".',
    msgFileTypes: {
      image: "imaxe",
      html: "HTML",
      text: "text",
    ...
    msgProgress:
      "Subiendo arquivo {index} de {files} - {name} - {percent}% completado.",
    msgSelected: "{n} {files} seleccionado(s)",
    msgFoldersNotAllowed:
      "Arrastra e solta únicamente arquivoa. Omitida(s) {n} carpeta(s).",
    msgImageWidthSmall:
      'O ancho da imaxe "{name}" debe ser de al menos {size} px.',
    msgImageHeightSmall:
      'A altura de la imaxe "{name}" debe ser de al menos {size} px.',
    msgImageWidthLarge:
      'El ancho de la imaxe "{name}" no puede exceder de {size} px.',
    msgImageHeightLarge:
      'La altura de la imaxe "{name}" no puede exceder de {size} px.',
    msgImageResizeError:
      "No se pudieron obtener las dimensiones de la imaxe para cambiar el tamaño.",
    msgImageResizeException:
      "Erro o cambiar o tamaño da imaxe.<pre>{errors}</pre>",
    msgAjaxError:
      "Algo foi mal ca operación {operation}. Por favor, intentao de novo mais tarde.",
