...
(function () {
  ...
  d.wordwrap = function (a, b, c, e) {
    ...
    for (a = (k = a.split(/\r\n|\n|\r/)).length; ++g < a; k[g] += h) {
      ...
      for (
        k[g] = "";
        h.length > b;
        k[g] += d.trim(h.slice(0, f)) + ((h = h.slice(f)).length ? c : "")
      )
        f =
          2 == e || (f = h.slice(0, b + 1).match(/\S*(\s)?$/))[1]
            ? b
            : f.input.length - f[0].length ||
              (1 == e && b) ||
              f.input.length + (f = h.slice(b).match(/^\S*/))[0].length;
      h = d.trim(h);
    }
    return k.join(c);
  };
  ...
  d.formatDuration = function (a, b, c, e, g, f) {
    ...
    "ss" == b &&
      ((a = d.formatNumber(a, f)), 1 == a.split(k)[0].length && (a = "0" + a));
    ...
    if (b) {
      ...
      for (l = 0; l < c.length; l++) {
        var m = c[l],
          n = b[m];
        void 0 !== n &&
          ((n = f ? d.addPrefix(n, k, h, e) : d.formatNumber(n, e)),
          (a = a.replace(
            new RegExp("\\[\\[" + g + "" + m + "\\]\\]", "g"),
            n
          )));
  ...
  d.easeOutElastic = function (a, b, c, e, d) {
    ...
    h < Math.abs(e)
      ? ((h = e), (a = f / 4))
      : (a = (f / (2 * Math.PI)) * Math.asin(e / h));
    return (
      h * Math.pow(2, -10 * b) * Math.sin((2 * (b * d - a) * Math.PI) / f) +
      e +
      c
    );
  };
      ...
      if (a) {
        ...
        switch (this.position) {
          ...
          case "left":
            ...
            m = -90;
            c =
              ("left" == p ? l + 1 : "right" == p ? -1 : l / 2) + this.titleDY;
    ...
    parseDatesDraw: function () {
      ...
      var B = Math.ceil(this.timeDifference / y) + 5,
        D = (l = d
          ...
          .getTime());
      if (
        (h == A && 1 == u && this.centerLabelOnFullPeriod) ||
        this.autoWrap ||
        this.centerLabels
      )
        (n = y * this.stepWidth),
      ...
      if (0 < this.gridCountR)
        for (
          ...
          "MM" == A &&
            ((g = (p - l) / y),
            1.5 <= (p - l) / y &&
              ((p = p - (g - 1) * y + d.getPeriodDuration("DD", 3)),
          ...
          if ("radar" == b.type) {
            ...
            this.rotate
              ...
              : "date" == this.type && (g = this.axisWidth - g);
          f = !1;
          this.nextPeriod[h] &&
            (f = this.checkPeriodChange(this.nextPeriod[h], 1, p, l, h));
          l = !1;
          f && this.markPeriodChange
            ? ((f = this.dateFormatsObject[this.nextPeriod[h]]),
              this.twoLineMode &&
                ((f = this.dateFormatsObject[h] + "\n" + f),
                (f = d.fixBrakes(f))),
              (l = !0))
            : (f = this.dateFormatsObject[h]);
          r || (l = !1);
          ...
          if ((a == k && !c) || (a == B && !e)) f = " ";
          this.labelFunction &&
            (f = this.labelFunction(f, new Date(p), this, A, u, m).toString());
          this.boldLabels && (l = !0);
...
(function () {
  ...
  d.ValueAxis = d.Class({
    ...
    draw: function () {
      ...
      if (
        ...
        if (this.logarithmic) {
          ...
          this.relativeStart = d.roundTo(
            (Math.log(this.minReal) / Math.LN10 - Math.log(h) * Math.LOG10E) /
              r,
            5
          );
        ...
        !0 === g
          ? ((z =
            ...
            z > this.logGridLimit &&
              ...
              r > this.gridCountR && (p = Math.ceil(r / this.gridCountR))))
        ...
        this.duration &&
          (this.maxInterval = d.getMaxInterval(this.max, this.duration));
        var x = this.step,
          y,
      ...
      !this.visible || e
        ? (b.hide(), g.hide(), u.hide())
        : (b.show(), g.show(), u.show());
      this.axisY = this.y;
      this.axisX = this.x;
    },
    ...
    formatValue: function (a, b, c) {
      ...
      if (f)
        return (
          ...
          e
            ? ((c =
                -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a)),
              (e = c.split("e")),
              (c = Number(e[0])),
              (e = Number(e[1])),
              (c = d.roundTo(c, 14)),
            ...
            : (g &&
              ...
              (c = this.usePrefixes
                ? d.addPrefix(
                    a,
                    h.prefixesOfBigNumbers,
                    h.prefixesOfSmallNumbers,
                    f,
                    !b
                  )
          ...
          "date" == this.type &&
            (c = d.formatDate(new Date(a), this.currentDateFormat, h)),
          this.recalculateToPercents
            ? (c += "%")
            : (b = this.unit) &&
      ...
      for (p = n; p <= l; p++) {
        ...
        for (q = 0; q < k.length; q++)
          if (((n = k[q]), n.hidden))
            ...
            if (
              ((m = this.data[p].axes[this.id].graphs[n.id]),
              (h = m.values.value),
              isNaN(h))
            )
              n.newStack && ((g[p] = NaN), (e[p] = NaN));
              ...
              r &&
                z &&
                (z = this.data[p].axes[this.id].graphs[z.id]) &&
                ...
                "column" == a &&
                  ...
                  0 > h
                    ? ((m.values.close = h),
                      isNaN(e[p])
                        ? (m.values.open = t)
                        : ((m.values.close += e[p]), (m.values.open = e[p])),
                      (e[p] = m.values.close))
                    : ((m.values.close = h),
                      isNaN(g[p])
                        ? (m.values.open = t)
                        : ((m.values.close += g[p]), (m.values.open = g[p])),
                      (g[p] = m.values.close))));
            }
      }
              ...
              n.chart == this.chart &&
                ...
                isNaN(h) ||
                  ...
                  "100%" == b &&
                    ...
                    isNaN(g[p]) && (g[p] = 0),
                    0 > c
                      ? ((m.values.close = d.fitToBounds(c + e[p], -100, 100)),
                        (m.values.open = e[p]),
                        (e[p] = m.values.close))
                      : ((m.values.close = d.fitToBounds(c + g[p], -100, 100)),
                        (m.values.open = g[p]),
                        (g[p] = m.values.close))))));
    },
        ...
        if (e.valueAxis == this) {
          ...
          if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
            var n = m.minDuration(),
              ...
              q = d
                .resetDateToMin(new Date(a.startTime), m.minPeriod)
                .getTime();
          ...
          for (
            m = h;
            m <= k &&
            ((h = this.data[m].axes[this.id].graphs[e.id]),
            (f = h.values[g]),
            e.recalculateValue &&
              (f = h.dataContext[e.valueField + e.recalculateValue]),
            isNaN(f));
            m++
          );
          this.recBaseValue = f;
    ...
    zoomToValues: function (a, b, c) {
      ...
      if (this.logarithmic) {
        ...
        this.relativeStart = d.roundTo(
          (Math.log(a) / Math.LN10 - Math.log(e) * Math.LOG10E) / g,
          9
        );
    ...
    construct: function (a) {
      ...
      "H" == a.orientation
        ...
        : ((this.axisWidth = a.height),
          "right" == a.position
            ? ((e = d.line(p, [0, 0, -h], [0, n, n - k], e, g, c)),
              (k = m + k),
              (c = c / 2 + f + h + q + l - 1))
            : ((e = d.line(p, [0, 0], [0, n], e, g, c)),
              (k = m),
              (c = -c / 2 - f + l)));
      e.translate(c, k);
      c = b.container.set();
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
      ...
      var ia = a.counter,
        ...
        Ba;
      h
        ? (void 0 !== h.id && (q = p.classNamePrefix + "-guide-" + h.id),
          (P = !0),
          ...
          isNaN(h.labelOffset) || (aa = h.labelOffset))
        : "" === c && (B = 0);
      ...
      P &&
        ...
        ((ca =
          a.autoWrap && 0 === n
            ? d.wrappedText(z, c, w, t, r, ga, k, Math.abs(g), 0)
...
(function () {
  ...
  d.RecFill = d.Class({
    construct: function (a, b, c, e) {
      ...
      "V" == h
        ? ((h = d.rect(l, a.width, c, n, m)), h.translate(g, b - k + f))
        : ((h = d.rect(l, c, a.height, n, m)), h.translate(b - k + g, f));
  ...
  d.AmGraph = d.Class({
    ...
    draw: function () {
      ...
      if (a.drawGraphs) {
        ...
        this.behindColumns
          ? (a.graphsBehindSet.push(e), a.bulletBehindSet.push(g))
          : (a.graphsSet.push(e), a.bulletSet.push(g));
        ...
        g ||
          ...
          (g = "top"),
          "column" == this.type &&
            (a.rotate && (g = "right"), "100%" == f || "regular" == f) &&
            (g = "middle"),
    ...
    createRadarGraph: function () {
      ...
      for (m = this.start; m <= this.end; m++) {
        ...
        "none" == a || "3d" == a
          ? (q = n.values.value)
          : ((q = n.values.close), (p = n.values.open));
        if (isNaN(q))
          this.connect ||
          ...
          var t =
              this.valueAxis.getCoordinate(q, this.noRounding) - this.height,
          ...
          if (!isNaN(p)) {
            var w =
                this.valueAxis.getCoordinate(p, this.noRounding) - this.height,
    ...
    positionLabel: function (a, b, c, e, d) {
      if (e) {
        ...
        !this.showAllValueLabels &&
          ...
          l &&
          ((n = e.getBBox()),
          n.height > a.columnHeight || n.width > a.columnWidth) &&
          (e.remove(), (e = null));
        if (e && "radar" != f.type)
          if (q) {
      ...
      if (
        ...
        t
          ? ((ha = q),
            ...
            (vb = Math.abs(nb - Ka)),
            (mb = tb = 0),
            f.reversed ? ((ca = 0), (lb = Ka)) : ((ca = Ka), (lb = 0)))
          : ((Qa = n),
            (ha = Math.abs(Mb - Ka)),
            (vb = n),
            (ub = Math.abs(nb - Ka)),
            (lb = ca = 0),
            f.reversed ? ((mb = p), (tb = Ka)) : (mb = Ka));
      }
      var La = Math.round;
      this.pmx = La(ca);
      this.pmy = La(tb);
      ...
      if ("line" == h || "step" == h || "smoothedLine" == h) {
        if (0 < P) {
          ...
          if (this.dashLengthField)
            for (L = P; -1 < L; L--)
              if (
                ((G = e[L]), (v = G.axes[f.id].graphs[b]), !isNaN(v.dashLength))
              ) {
      ...
      for (L = P; L <= ia; L++) {
        ...
        if (m && void 0 == this.openField)
          for (
            ...
            yb < e.length &&
            (!e[yb] ||
              !(fb = e[L + 1].axes[f.id].graphs[b]) ||
              !fb.values ||
              ((Ta = fb.values.value), isNaN(Ta)));
            yb++
          );
        var S,
          R,
        ...
        "none" == M &&
          (Z = isNaN(v.columnIndex) ? this.columnIndex : v.columnIndex);
        if (Ia) {
                ...
                if (va) {
                  ...
                  if (!J) {
                    ...
                    "3d" == M &&
                      (t
                        ? ((I =
                            (this.end + 1 - L) * C - c - 1e3 * this.depthCount),
                          (ya += H * Z),
                          (ka += H * Z),
                          (v.y += H * Z))
            ...
            case "ohlc":
              if (!(isNaN(ua) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                ...
                if (t) {
                  ...
                  0 <= O &&
                    O <= pa &&
                    ($a = d.line(g, [O, O], [Ib, Tb], Ha, X, da, ea));
                  0 < F &&
                    F < q &&
                    (Za = d.line(g, [qa, sa], [F, F], Ha, X, da, ea));
                  0 <= E &&
                    E <= pa &&
                    (ab = d.line(g, [E, E], [Tb, Jb], Ha, X, da, ea));
                } else {
                  la = F;
                  "open" == l && (la = N);
                  "high" == l && (la = ta);
                  ...
                  0 <= N &&
                    N <= Fa &&
                    ($a = d.line(g, [Kb, Ub], [N, N], Ha, X, da, ea));
                  0 < E &&
                    E < n &&
                    (Za = d.line(g, [E, E], [ra, ta], Ha, X, da, ea));
                  0 <= F &&
                    F <= Fa &&
                    (ab = d.line(g, [Ub, Lb], [F, F], Ha, X, da, ea));
                }
                fa.push($a);
                fa.push(Za);
                fa.push(ab);
    ...
    createLabel: function (a, b, c) {
      ...
      if (void 0 !== b && "" !== b)
        return (
          (a = d.text(this.container, b, g, e.fontFamily, c)),
    ...
    drawLineGraph: function (a, b, c, e) {
      ...
      if (1 < a.length) {
        ...
        var z = g.negativeLineColor,
          ...
          y = g.baseCoord;
        0 !== g.negativeBase &&
          ((y = g.valueAxis.getCoordinate(g.negativeBase, f)),
        ...
        if (0 < h || 0 < A)
          if (
            ...
            0 < h &&
              ((b = d.polygon(l, p, r, w, h, 1, "#000", 0, a, f)),
    ...
    drawSmoothedGraph: function (a, b, c, e) {
      if (1 < a.length) {
        ...
        k.push(m.path);
        void 0 !== r &&
          ((n = new d.Bezier(h, a, b, r, A, n, t, 0, g, void 0, u)),
    ...
    animateGraphs: function () {
      ...
      b &&
        ...
        b.animate({ opacity: 1, translate: e + "," + d }, f, h),
        c.animate({ opacity: 1, translate: e + "," + d }, f, h),
        a.animatable.push(b));
    },
    animate: function (a) {
      var b = this.chart,
      ...
      if (
        ...
        if (p) {
          ...
          if ("serial" == e.type || "gantt" == e.type)
            if (-0.5 > b || b > this.width || c < -h / 2 || c > this.height)
              p.remove(), (p = null);
          p &&
            (this.bulletSet.push(p),
            p.translate(b, c),
      ...
      if (a) {
        ...
        m
          ? m.valueBalloonsEnabled ||
            ((h = f.balloon), (k = this.x), (l = this.y), (n = !1))
          : ((h = f.balloon), (k = this.x), (l = this.y), (n = !1));
            ...
            ? ((e = f.getBalloonColor(this, a)),
              ...
              isNaN(b) || isNaN(g)
                ...
                : ((a = this.width),
                  ...
                  !c &&
                  "radar" != f.type &&
                  (b < k - 0.5 || b > a + k || g < l - 0.5 || g > q + l)
                    ? (h.showBalloon(m), h.hide(0))
                    : (h.followCursor(c), h.showBalloon(m))))
            : (this.hideBalloonReal(), h.hide(), this.resizeBullet(a, e, g));
    ...
    resizeBullet: function (a, b, c) {
      ...
      if (a && d.isModern && (1 != b || !isNaN(c))) {
        ...
        e &&
          ...
          isNaN(c) ||
            (e.setAttr("fill-opacity", c), e.setAttr("stroke-opacity", c)),
          (this.resizedDItem = a));
      }
    },
  });
  ...
  d.ChartCursor = d.Class({
    ...
    showCursor: function (a) {
      !this.drawing &&
        ...
        this.updateFullLine(),
        a ||
          this.fire({ target: this, chart: this.chart, type: "onShowCursor" }),
    ...
    dispatchMovedEvent: function (a, b, c, e) {
      ...
      if (
        ...
        this.rotate
          ? ((h.position = b), (h.finalPosition = f))
          : ((h.position = a), (h.finalPosition = d));
        this.prevX = a;
        this.prevY = b;
        e
          ? this.chart.handleCursorMove(h)
          : (this.fire(h), "changed" == c && this.chart.fire(h));
      }
    },
  ...
  d.SimpleChartScrollbar = d.Class({
    ...
    draw: function () {
      ...
      if (a.enabled) {
        ...
        a.set = g;
        c
          ? d.setCN(e, g, "scrollbar-vertical")
          : d.setCN(e, g, "scrollbar-horizontal");
        e.scrollbarsSet.push(g);
        var f, h;
        c
          ? ((f = a.scrollbarHeight), (h = e.plotAreaHeight))
          : ((h = a.scrollbarHeight), (f = e.plotAreaWidth));
        a.width = f;
        if ((a.height = h) && f) {
          var k = d.rect(
            b,
    ...
    clipDragger: function (a) {
      ...
      if (b) {
        ...
        if (this.rotate) {
          if (
            ((c = 0), (g = this.width + 1), this.clipY != d || this.clipH != b)
          )
            f = !0;
        } else if (
          ((d = 0), (b = this.height + 1), this.clipX != c || this.clipW != g)
        )
          f = !0;
    ...
    dispatchScrollbarEvent: function () {
      if (this.skipEvent) this.skipEvent = !1;
        ...
        if (
          this.percentStart != this.prevPercentStart ||
          this.percentEnd != this.prevPercentEnd ||
    ...
    updateDragIconPositions: function () {
      ...
      this.rotate
        ? ((f = this.dragIconWidth),
          ...
          g.translate((k - h) / 2, c + a.height - f / 2))
    ...
    percentZoom: function (a, b, c) {
      ...
      if (this.dragger && this.enabled) {
        ...
        var e, g;
        this.rotate
          ? ((e = this.height), (b = e - e * b), (g = e - e * a))
          : ((e = this.width), (g = e * b), (b = e * a));
    ...
    handleBgClick: function () {
      ...
      if (!a.resizingRight && !a.resizingLeft) {
        ...
        a.updateOnReleaseOnly
          ...
          : ((a.animating = !0),
            (c = Math.round(c)),
            m ? g.animate({ y: c }, e, ">") : g.animate({ x: c }, e, ">"),
            (a.forceClip = !0),
      ...
      if (
        ...
        g.parseDates && !g.equalSpacing
          ? ((a = g.stepWidth),
            ...
            (c = a * (this.endTime - c)))
          : (a[this.start] && (b = a[this.start].x[g.id]),
            a[this.end] && (c = a[this.end].x[g.id]),
            (a = g.stepWidth),
            g.startOnAxis || ((d = a / 2), (b -= d), (c += d)));
        this.stepWidth = a;
    ...
    draw: function () {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          this.className &&
            (n.className =
              n.className + " " + B + "-balloon-div-" + this.className);
          B = n.style;
          ...
          this.drop
            ? ((h = C / 1.6),
              ...
              "V" == x && (x = "down"),
              "H" == x && (x = "left"),
              "down" == x && ((D = a + 1), (y = b - h - h / 3)),
              "up" == x && ((l = 180), (D = a + 1), (y = b + h + h / 3)),
              "left" == x && ((l = 270), (D = a + h + h / 3 + 2), (y = b)),
              "right" == x && ((l = 90), (D = a - h - h / 3 + 2), (y = b)),
              (k = y - H / 2 + 1),
              (m = D - I / 2 - 1),
              (q = d.drop(g, h, l, q, w, r, p, aa)))
            : 0 < u || 0 === z
            ? (0 < M &&
                ((a = d.rect(g, C, A, q, 0, r + 1, P, M, u)),
                d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                f.push(a)),
              (q = d.rect(g, C, A, q, w, r, p, aa, u)))
            : ((t = []),
              (u = []),
              "H" != x
                ? ((h = a - D),
          ...
          0 < this.animationDuration &&
            ...
            f.animate({ translate: D - g + "," + y }, b, "easeOutSine"),
            n &&
...
(function () {
  ...
  d.AmCoordinateChart = d.Class({
    ...
    processValues: function (a, b, c) {
      ...
      for (
        var h = "value error open close low high".split(" "), k = 0;
        k < h.length;
        k++
      ) {
        var l = h[k];
        ...
        null !== m &&
          ...
          "date" == b.valueAxis.type &&
            void 0 !== m &&
            ((g = d.getDate(m, b.chart.dataDateFormat)), (e[l] = g.getTime())));
      }
      return e;
    },
    ...
    processGuides: function () {
      ...
      if (a)
        for (var c = 0; c < a.length; c++) {
          ...
          var g = e.valueAxis;
          g
            ? (d.isString(g) && (g = this.getValueAxisById(g)),
              g ? g.addGuide(e) : this.valueAxes[0].addGuide(e))
      ...
      if (!(isNaN(e) || isNaN(g) || isNaN(f) || isNaN(f))) {
        ...
        q =
          ...
          Math.asin(
            n /
              (((n * q) / Math.abs(n * q)) *
                Math.sqrt(Math.pow(n, 2) + Math.pow(q, 2)))
          );
...
(function () {
  ...
  d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    for (q = 1; q < b.length; q++)
      m && ((b[q] = d.roundTo(b[q], 5)), (c[q] = d.roundTo(c[q], 5))),
        (k += " L" + (h(b[q]) + n) + "," + (h(c[q]) + f));
    a = a.path(k + " Z").attr(g);
  ...
  d.line = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    e = Math.round;
    m &&
      ((e = Number), (b[0] = d.roundTo(b[0], 5)), (c[0] = d.roundTo(c[0], 5)));
    m = d.dx;
    g = d.dy;
    h = "M" + (e(b[0]) + m) + "," + (e(c[0]) + g);
    ...
    for (var d = [], g = [], f = 1; f < a.length; f++)
      for (
        var h = Number(a[f - 1]),
          ...
          n =
            Math.round(
              Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50
            ) + 1,
          l = (l - h) / n,
          m = (m - k) / n,
          q = 0;
  ...
  d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
    ...
    for (n = 1; n < b.length; n++)
      for (
        var p = [b[n - 1], b[n]],
          t = [c[n - 1], c[n]],
          t = d.makeHD(p, t, a.handDrawScatter),
          p = t[0],
          t = t[1],
          r = 1;
        r < p.length;
      ...
      for (l = 0; l < b.length; l++)
        isNaN(b[l]) || isNaN(c[l])
          ? ((e += this.drawSegment(g, p, t)),
            ...
            (g = []))
          : g.push({ x: Number(b[l]), y: Number(c[l]) });
      e += this.drawSegment(g, p, t);
      m && (e += m);
  ...
  d.VMLRenderer = d.Class({
    ...
    setAttr: function (a, b, c) {
      if (void 0 !== c) {
        ...
        "oval" == a.shapeType &&
          ("rx" == b && (h.width = 2 * c), "ry" == b && (h.height = 2 * c));
        ...
        "text" == f &&
          ("text-anchor" == b &&
            ...
            "middle" == c &&
              ((h.marginLeft = -(k / 2) + "px"), (h.textAlign = "center")),
        ...
        if ("shape" == f) {
          ...
          "rx" == b &&
            (e ? (g.arcSize = c + "%") : g.setAttribute("arcsize", c + "%"));
        }
      }
    },
    attr: function (a, b) {
    ...
    move: function (a, b, c) {
      ...
      "oval" == a.shapeType &&
        ((b -= d.removePx(g.width) / 2), (c -= d.removePx(g.height) / 2));
      a = a.bw;
      isNaN(a) || ((b -= a), (c -= a));
      isNaN(b) ||
        isNaN(c) ||
    ...
    rotate: function (a, b, c) {
      if (0 !== Number(b)) {
        ...
        b /= Math.abs(b);
        a.left =
          h + l / 2 - (l / 2) * Math.cos(c) - ((b * e) / 2) * Math.sin(c) + 3;
        ...
        if (g <= e) {
          ...
          "translate" == h
            ? ((l = c.to.split(",")),
              ...
              (l = Number(l[1])),
              f.translate(m, l))
            : ((k = Number(c.to)), this.setAttr(f, h, k)),
  ...
  d.AmLegend = d.Class({
    ...
    arrangeEntries: function () {
      ...
      if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
        "center" == this.align
          ? (b = f + (n - u.width) / 2)
          : "right" == this.align && (b = f + n - u.width);
      z.translate(b, m + 1);
    ...
    createEntry: function (a) {
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (e) {
          ...
          (m = b.createMarker(g, f, h, void 0, void 0, void 0, z, l)) &&
            m.translate(p / 2, p / 2);
        }
        ...
        k &&
          ...
          0 < p &&
          ("x" == k
            ? ((x = b.createX()), x.translate(p / 2, p / 2))
            : (x = b.createV()),
          (x.dItem = a),
          !0 !== a.hidden
            ? "x" == k
        ...
        c.accessible &&
          b.accessibleLabel &&
          ((l = d.massReplace(b.accessibleLabel, { "[[title]]": a.title })),
          c.makeAccessible(q, l));
        l = b.fontSize;
        m &&
          (p <= l &&
            ((p = p / 2 + b.ly - l / 2 + (l + 2 - p) / 2 - r),
            m.translate(w, p),
            x && x.translate(x.x, p)),
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (b.valueText && 0 < b.valueWidth) {
          ...
          b.useMarkerColorForValues &&
            ((l = a.color), a.legendKeyColor && (l = a.legendKeyColor()));
        ...
        b.index++;
        e = b.container
          .rect(a.legendEntryWidth, 0, h, k, 0, 0)
      ...
      if (a)
        for (c = 0; c < a.length; c++) {
          ...
          if (e) f.value ? g.text(f.value) : g.text("");
            ...
            if (void 0 !== f.type) {
              ...
              k
                ...
                : l &&
                  ...
                  ((l = d.massReplace(l, { "[[title]]": f.title })),
            ...
            if (
              !f.pattern &&
              (this.useMarkerColorForValues && g.setAttr("fill", n),
              this.useMarkerColorForLabels)
            ) {
              if ((g = f.legendMarker))
              ...
              (g = f.legendLabel) &&
                (f.hidden
                  ? g.setAttr("fill", this.markerDisabledColor)
                  : g.setAttr("fill", n));
            }
          }
        }
...
(function () {
  ...
  d.resetDateToMin = function (a, b, c, e) {
    ...
    d.useUTC
      ? ((a = new Date()), a.setUTCFullYear(g, f, h), a.setUTCHours(k, l, m, n))
      : (a = new Date(g, f, h, k, l, m, n));
    return a;
  };
  ...
  d.formatDate = function (a, b, c) {
    ...
    b = b.replace(/@P@/g, h);
    return (b =
      12 > k ? b.replace(/@A@/g, c.amString) : b.replace(/@A@/g, c.pmString));
  };
