...
(function make_xlsx(XLSX) {
  ...
  var CFB = (function _CFB() {
    ...
    function parse(file) {
      ...
      if (mver === 3 && nds !== 0)
        throw new Error("# Directory Sectors: Expected 0 saw " + nds);
      blob.l += 4;
  ...
  function parse_isodur(s) {
    ...
    for (var i = 1; i != m.length; ++i) {
      ...
      switch (m[i].substr(m[i].length - 1)) {
        case "Y":
          throw new Error(
            "Unsupported ISO Duration Field: " + m[i].substr(m[i].length - 1)
          );
        case "D":
          mt *= 24;
        case "H":
  ...
  function parseDate(str) {
    ...
    return new Date(
      Date.UTC(+n[0], +n[1] - 1, +n[2], +n[3] || 0, +n[4] || 0, +n[5] || 0)
    );
  }
  function cc2str(arr) {
    var o = "";
  ...
  function parse_Font(blob, length, opts) {
    var o = { dyHeight: blob.read_shift(2), fl: blob.read_shift(2) };
  ...
  var parse_BIFF5OT = [];
  parse_BIFF5OT[8] = function (blob, length, opts) {
    var tgt = blob.l + length;
    blob.l += 10;
    ...
    function dbf_to_aoa(buf, opts) {
      ...
      while (ft == 2 ? d.l < d.length && d[d.l] != 13 : d.l < hend) {
        ...
        field.name = cptable.utils
          .decode(current_cp, d.slice(d.l, d.l + 10))
          .replace(/[\u0000\r\n].*$/g, "");
        d.l += 11;
              ...
              for (rj = 1; rj < record.length; ++rj)
                switch (record[rj].charAt(0)) {
                  ...
                  case "K":
                    ...
                    break;
                  case "E":
                    var formula = rc_to_a1(record[rj].substr(1), {
                      r: R,
                      c: C,
                    });
  ...
  var PRN = (function () {
    ...
    function dsv_to_sheet_str(str, opts) {
      ...
      if (str.substr(0, 4) == "sep=" && str.charCodeAt(5) == 10) {
        sep = str.charAt(4);
        str = str.substr(6);
      } else if (str.substr(0, 1024).indexOf("\t") == -1) sep = ",";
      else sep = "\t";
      var R = 0,
        C = 0,
        v = 0;
  ...
  var WK_ = (function () {
    ...
    var WK1Enum = {
      ...
      1: { n: "EOF", f: parsenoop },
      2: { n: "CALCMODE", f: parsenoop },
      3: { n: "CALCORDER", f: parsenoop },
      4: { n: "SPLIT", f: parsenoop },
      5: { n: "SYNC", f: parsenoop },
      6: { n: "RANGE", f: parse_RANGE },
      7: { n: "WINDOW1", f: parsenoop },
      8: { n: "COLW1", f: parsenoop },
      9: { n: "WINTWO", f: parsenoop },
      10: { n: "COLW2", f: parsenoop },
      11: { n: "NAME", f: parsenoop },
      12: { n: "BLANK", f: parsenoop },
      13: { n: "INTEGER", f: parse_INTEGER },
      14: { n: "NUMBER", f: parse_NUMBER },
      15: { n: "LABEL", f: parse_LABEL },
      16: { n: "FORMULA", f: parse_FORMULA },
      24: { n: "TABLE", f: parsenoop },
      25: { n: "ORANGE", f: parsenoop },
      26: { n: "PRANGE", f: parsenoop },
      27: { n: "SRANGE", f: parsenoop },
      28: { n: "FRANGE", f: parsenoop },
      29: { n: "KRANGE1", f: parsenoop },
      32: { n: "HRANGE", f: parsenoop },
      35: { n: "KRANGE2", f: parsenoop },
      36: { n: "PROTEC", f: parsenoop },
      37: { n: "FOOTER", f: parsenoop },
      38: { n: "HEADER", f: parsenoop },
      39: { n: "SETUP", f: parsenoop },
      40: { n: "MARGINS", f: parsenoop },
      41: { n: "LABELFMT", f: parsenoop },
      42: { n: "TITLES", f: parsenoop },
      43: { n: "SHEETJS", f: parsenoop },
      45: { n: "GRAPH", f: parsenoop },
      46: { n: "NGRAPH", f: parsenoop },
      47: { n: "CALCCOUNT", f: parsenoop },
      48: { n: "UNFORMATTED", f: parsenoop },
      49: { n: "CURSORW12", f: parsenoop },
      50: { n: "WINDOW", f: parsenoop },
      51: { n: "STRING", f: parse_LABEL },
      55: { n: "PASSWORD", f: parsenoop },
      56: { n: "LOCKED", f: parsenoop },
      60: { n: "QUERY", f: parsenoop },
      61: { n: "QUERYNAME", f: parsenoop },
      62: { n: "PRINT", f: parsenoop },
      63: { n: "PRINTNAME", f: parsenoop },
      64: { n: "GRAPH2", f: parsenoop },
      65: { n: "GRAPHNAME", f: parsenoop },
      66: { n: "ZOOM", f: parsenoop },
      67: { n: "SYMSPLIT", f: parsenoop },
      68: { n: "NSROWS", f: parsenoop },
      69: { n: "NSCOLS", f: parsenoop },
      70: { n: "RULER", f: parsenoop },
      71: { n: "NNAME", f: parsenoop },
      72: { n: "ACOMM", f: parsenoop },
      73: { n: "AMACRO", f: parsenoop },
      74: { n: "PARSE", f: parsenoop },
      255: { n: "", f: parsenoop },
    };
    var WK3Enum = {
      0: { n: "BOF", f: parsenoop },
  ...
  function parse_si(x, opts) {
    ...
    if (x.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      z.t = utf8read(
        unescapexml(x.substr(x.indexOf(">") + 1).split(/<\/(?:\w+:)?t>/)[0])
      );
      z.r = utf8read(x);
  ...
  function parse_EncryptionInfo(blob, length) {
    ...
    throw new Error(
      "ECMA-376 Encryped file unrecognized Version: " + vers.Minor
    );
  }
  ...
  function write_CELLSTYLEXFS_bin(ba, data) {
    ...
    write_record(
      ba,
      "BrtXF",
      write_BrtXF({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535)
    );
  ...
  function write_STYLES_bin(ba, data) {
    ...
    write_record(
      ba,
      "BrtStyle",
      write_BrtStyle({ xfId: 0, builtinId: 0, name: "Normal" })
    );
      ...
      data.forEach(function (comment) {
        comment[1].forEach(function (c) {
          ...
          write_record(
            ba,
            "BrtCommentAuthor",
            write_XLWideString(c.a.substr(0, 54))
          );
        });
      });
    ...
    for (var ff = 0, fflen = formula[0].length; ff < fflen; ++ff) {
      ...
      switch (f[0]) {
        ...
        case "PtgArea3d":
          ...
          r = f[1][2];
          sname =
            supbooks && supbooks[1] ? supbooks[1][ixti + 1] : "**MISSING**";
  ...
  function write_ws_xml_sheetviews(ws, opts, idx, wb) {
    return writextag(
      "sheetViews",
      writextag("sheetView", null, { workbookViewId: "0" }),
      {}
    );
  }
  function write_ws_xml_cell(cell, ref, ws, opts, idx, wb) {
    ...
    if (cell.f) {
      var ff =
        cell.F && cell.F.substr(0, ref.length) == ref
          ? { t: "array", ref: cell.F }
          : null;
        ...
        for (ri = 0; ri != cells.length; ++ri) {
          ...
          if (
            ...
            if (_d) {
              p.t = "d";
              p.v = new Date(
                Date.UTC(_d.y, _d.m - 1, _d.d, _d.H, _d.M, _d.S, _d.u)
              );
            }
          }
          if (dense) {
  ...
  function write_ws_xml(idx, opts, wb, rels) {
    ...
    o[o.length] = writextag("sheetPr", null, {
      codeName: escapexml(wb.SheetNames[idx]),
    });
        ...
        switch (RT) {
          ...
          case 11:
            ...
            if (
              ...
              cf &&
              p.t == "n" &&
              SSF.is_date(SSF._table[cf.ifmt])
            ) {
              var _d = SSF.parse_date_code(p.v);
              if (_d) {
                p.t = "d";
  ...
  function write_AUTOFILTER(ba, ws) {
    ...
    write_record(
      ba,
      "BrtBeginAFilter",
      write_UncheckedRfX(decode_range(ws["!autofilter"].ref))
    );
  ...
  function parse_numCache(data) {
    ...
    var nf = unescapexml(
      (data.match(/<c:formatCode>(.*?)<\/c:formatCode>/) || ["", "General"])[1]
    );
    return [col, nf];
  }
  function parse_chart(data, name, opts, rels, wb, csheet) {
    ...
    var C = 0,
      ...
      col = "A";
    var refguess = { s: { r: 2e6, c: 2e6 }, e: { r: 0, c: 0 } };
    (data.match(/<c:numCache>.*?<\/c:numCache>/gm) || []).forEach(function (
      nc
    ) {
  ...
  function write_ws_xlml_cell(cell, ref, ws, opts, idx, wb, addr) {
    ...
    if (
      ...
      var __v = "";
      for (var __i = 0; __i < _v.length; ++__i)
  ...
  function parse_xlscfb(cfb, options) {
    ...
    if (options.bookProps && !options.bookSheets) WorkbookP = {};
      ...
      else if (cfb.find("PerfectOffice_MAIN"))
        WorkbookP = WK_.to_workbook(
          cfb.find("PerfectOffice_MAIN").content,
          options
        );
      else if (cfb.find("NativeContent_MAIN"))
        WorkbookP = WK_.to_workbook(
          cfb.find("NativeContent_MAIN").content,
          options
        );
  ...
  var HTML_ = (function () {
    ...
    function make_html_row(ws, r, R, o) {
      ...
      var oo = [];
      var nullcell =
        "<td" + (o.editable ? ' contenteditable="true"' : "") + "></td>";
      for (var C = r.s.c; C <= r.e.c; ++C) {
        var RS = 0,
          CS = 0;
        ...
        var w =
          cell.h || escapexml(cell.w || (format_cell(cell), cell.w) || "");
        var sp = {};
    ...
    var _BEGIN =
      "<html><head><title>SheetJS Table Export</title></head><body><table>";
  ...
  function parse_dom_table(table, _opts) {
    ...
    for (; R < rows.length; ++R) {
      ...
      for (_C = C = 0; _C < elts.length; ++_C) {
        var elt = elts[_C],
          v = elts[_C].innerText || elts[_C].textContent;
  ...
  var parse_content_xml = (function () {
    var parse_text_p = function (text, tag) {
      return unescapexml(
        text.replace(/<text:s\/>/g, " ").replace(/<[^>]*>/g, "")
      );
    };
    var number_formats = {
      day: ["d", "dd"],
      ...
      while ((Rn = xlmlregex.exec(str)))
        switch ((Rn[3] = Rn[3].replace(/_.*$/, ""))) {
          ...
          case "database-range":
            if (Rn[1] === "/") break;
            try {
              var AutoFilter = ods_to_csf_range_3D(
  ...
  function parse_ods(zip, opts) {
    ...
    if (ods)
      var manifest = parse_manifest(
        getzipdata(zip, "META-INF/manifest.xml"),
        opts
      );
  ...
  var write_styles_ods = (function () {
    var payload =
      '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><office:document-styles xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" office:version="1.2"></office:document-styles>';
  ...
  var write_content_ods = (function () {
    ...
    var write_ws = function (ws, wb, i, opts) {
      var o = [];
      o.push(
        '      <table:table table:name="' + escapexml(wb.SheetNames[i]) + '">\n'
      );
      var R = 0,
        C = 0,
  ...
  function write_zip(wb, opts) {
    ...
    if (wb.Props && wb.Props.SheetNames) {
      ...
      wb.Props.SheetNames = wb.SheetNames.map(function (x, i) {
  ...
  function readSync(data, opts) {
    ...
    switch ((n = firstbyte(d, o))[0]) {
      ...
      case 80:
        ...
        break;
      case 239:
        return n[3] == 60 ? parse_xlml(d, o) : PRN.to_workbook(d, o);
      case 255:
        if (n[1] == 254) {
  ...
  function resolve_book_type(o) {
    if (!o.bookType)
      switch (o.file.slice(o.file.lastIndexOf(".")).toLowerCase()) {
        case ".xlsx":
          o.bookType = "xlsx";
          break;
        case ".xlsm":
