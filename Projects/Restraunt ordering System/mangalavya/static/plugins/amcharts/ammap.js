...
(function () {
  ...
  d.wordwrap = function (a, b, c, e) {
    ...
    for (a = (h = a.split(/\r\n|\n|\r/)).length; ++g < a; h[g] += k) {
      ...
      for (
        h[g] = "";
        k.length > b;
        h[g] += d.trim(k.slice(0, f)) + ((k = k.slice(f)).length ? c : "")
      )
        f =
          2 == e || (f = k.slice(0, b + 1).match(/\S*(\s)?$/))[1]
            ...
            : f.input.length - f[0].length ||
              (1 == e && b) ||
              f.input.length + (f = k.slice(b).match(/^\S*/))[0].length;
      k = d.trim(k);
    }
    return h.join(c);
  };
  ...
  d.formatDuration = function (a, b, c, e, g, f) {
    ...
    "ss" == b &&
      ((a = d.formatNumber(a, f)), 1 == a.split(h)[0].length && (a = "0" + a));
  ...
  d.easeOutElastic = function (a, b, c, e, d) {
    ...
    return (
      k * Math.pow(2, -10 * b) * Math.sin((2 * (b * d - a) * Math.PI) / f) +
      e +
      c
    );
  };
    ...
    draw: function () {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          this.className &&
            (n.className =
              n.className + " " + C + "-balloon-div-" + this.className);
          C = n.style;
          ...
          "H" != u
            ? ((x = a - z / 2),
              b < h + w + 10 && "down" != u
                ...
                : (e && (b -= A), (A = b - w - B), (this.deltaSignY = 1)))
            : (2 * B > w && (B = w / 2),
              (A = b - w / 2),
              a < k + (l - k) / 2
    ...
    for (var e = [], d = [], f = 1; f < a.length; f++)
      for (
        var k = Number(a[f - 1]),
          ...
          n =
            Math.round(
              Math.sqrt(Math.pow(l - k, 2) + Math.pow(m - h, 2)) / 50
            ) + 1,
          l = (l - k) / n,
          m = (m - h) / n,
          p = 0;
    ...
    createEntry: function (a) {
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (e) {
          ...
          (m = b.createMarker(g, f, k, void 0, void 0, void 0, B, l)) &&
            m.translate(r / 2, r / 2);
        }
...
(function () {
  ...
  d.AmMap = d.Class({
      ...
      if (d.isModern) {
        ...
        if (!a.preventHover) {
          ...
          ((a.mouseIsOver && !a.mapWasDragged && !a.skipClick) ||
            ...
            a.fire({ type: "click", x: a.mouseX, y: a.mouseY, chart: a });
        ...
        if ((a = b.mapContainer)) {
          ...
          if (!isNaN(h)) {
            ...
            var t = Math.sqrt(Math.pow(h - g, 2) + Math.pow(l - f, 2)),
              q = b.initialDistance;
            isNaN(q) &&
              (q = Math.sqrt(Math.pow(h - g, 2) + Math.pow(l - f, 2)));
            if (!isNaN(q)) {
      ...
      if (e) {
        if (
          ...
          "MapLine" == a.objectType &&
            ((l = a.lineSvg) && l.setAttr("stroke", f), (l = a.arrowSvg)) &&
        ...
        for (
          ...
          if (
            ...
            "MapLine" == n.objectType &&
              ((e = n.lineSvg) && e.setAttr("stroke", f), (e = n.arrowSvg)) &&
    ...
    milesToPixels: function (a) {
      ...
      return (
        ((this.mapWidth / (b.rightLongitude - b.leftLongitude)) * a) / 69.172
      );
    },
    kilometersToPixels: function (a) {
      var b = this.dataProvider;
      return (
        ((this.mapWidth / (b.rightLongitude - b.leftLongitude)) * a) / 111.325
      );
    },
        ...
        for (g = 0; g < h; g++) {
          ...
          if (0 !== f.childNodes.length || "" !== m || !1 !== n)
            if (3 == f.nodeType || 4 == f.nodeType) {
              ...
              void 0 !== a[b][l].length
                ? this.parseXMLNode(a[b][l], a[b][l].length - 1, f, d + "  ")
    ...
    coordinatesToXY: function (a, b) {
      ...
      this.projectionFunction
        ? ((e = this.projectionFunction(
          ...
          (c =
            this.mapScale * d.roundTo(this.x2c(d.radiansToDegrees(e[0])), 3)),
          (e =
            this.mapScale * d.roundTo(this.y2c(d.radiansToDegrees(e[1])), 3)))
    ...
    coordinateToLongitude: function (a, b) {
      ...
      this.mapSet &&
        (c = (a / b) * (d.rightLongitude - d.leftLongitude) + d.leftLongitude);
      return Math.round(1e6 * c) / 1e6;
    },
  });
})();
  ...
  d.ZoomControl = d.Class({
    ...
    init: function (a, b) {
      ...
      isNaN(c.bottom) ||
        ((z = a.getY(c.bottom, !0)),
        f && (z -= q + 3 * g),
        (z = k ? z - 3 * g : c.homeButtonEnabled ? z - 0.5 * g : z + g));
      e.translate(x, z);
      c.previousDY = NaN;
      var E,
        x = g / 4 - 1;
      ...
      k &&
        (this.isDragging
          ? (k.stopDrag(),
            ...
            k.zoomTo(100 * Math.pow(a, c - (f - g) / b), NaN, NaN, !0))
...
(function () {
  ...
  d.SimpleButton = d.Class({
    ...
    init: function (a, b, c, e, g, f, k, h, l, m, n, p, r) {
      ...
      t.set = m;
      r
        ? ((b /= 2), (e = d.circle(a, b, e, g, f, k, h)), e.translate(b, b))
      ...
      t.svgIcon &&
        ((q = t.svgIcon), r ? q.translate(b, b) : q.translate(b / 2, b / 2));
  ...
  d.SmallMap = d.Class({
    ...
    init: function (a, b) {
      ...
      if (c.enabled) {
        ...
        isNaN(c.right) ||
          ((m = a.getX(c.right, !0) - c.width - f), (t = c.width - h + f / 2));
        f = b.set();
...
(function () {
  ...
  d.AreasProcessor = d.Class({
    ...
    process: function (a) {
      ...
      for (d = 0; d < c; d++)
        if (
          ((g = a[d]), (g.value = Number(g.value)), (g = g.value), !isNaN(g))
        ) {
          if (!1 === k || k < g) k = g;
          if (!1 === h || h > g) h = g;
          f += Math.abs(g);
  ...
  d.ImagesProcessor = d.Class({
    ...
    createImage: function (a, b) {
      ...
      isNaN(k.selectedBrightness) ||
        (m = d.adjustLuminosity(a.colorReal, k.selectedBrightness / 100));
      a.alphaReal = h;
      ...
      if (n) {
        ...
        "miles" == a.widthAndHeightUnits &&
          ((C = c.milesToPixels(a.width)), (F = c.milesToPixels(a.height)));
        if ("circle" == n || "bubble" == n) F = C;
        D = this.createPredefinedImage(G, r, t, n, C, F);
        q = E = 0;
        a.centeredReal
          ? (isNaN(a.right) || (E = C * v), isNaN(a.bottom) || (q = F * v))
          : ((E = (C * v) / 2), (q = (F * v) / 2));
        D.translate(E, q, v, !0);
      } else
        u
      ...
      isNaN(a.longitude) ||
        ...
        a.arrays.push({ arr: this.objectsToResize, el: a.objToResize }));
      ...
      switch (e) {
        ...
        case "hexagon":
          (g /= Math.sqrt(3)),
            (h = d.polygon(
              k,
              [0.866 * g, 0 * g, -0.866 * g, -0.866 * g, 0 * g, 0.866 * g],
              [0.5 * g, 1 * g, 0.5 * g, -0.5 * g, -1 * g, -0.5 * g],
              a,
              1,
              c,
              b,
        ...
        if (0 < w.length) {
          ...
          if (isNaN(q)) {
            for (q = 0; q < w.length - 1; q++)
              (H = Math.sqrt(
                Math.pow(w[q + 1] - w[q], 2) + Math.pow(C[q + 1] - C[q], 2)
              )),
                (a.distances[q] = H);
          ...
          if ("none" != A) {
            ...
            if ("start" == A || "both" == A)
              (r = w[0]),
                (N = C[0]),
                1 < w.length ? ((u = w[1]), (K = C[1])) : ((u = r), (K = N)),
