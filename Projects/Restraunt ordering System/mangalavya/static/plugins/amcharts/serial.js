  ...
  e.AmSerialChart = e.Class({
            ...
            0 > a
              ? d
                ? ((l = this.endTime - this.startTime),
                  ...
                  (g = this.endTime + f * g),
                  0 < f && 0 < e && g >= c && ((g = c), (d = c - l)),
                  this.zoomToDates(new Date(d), new Date(g)))
                : (0 < f && 0 < e && this.end >= l - 1 && (e = f = 0),
                  (d = this.start + e),
                  (g = this.end + f),
      ...
      if (0 < this.realWidth && 0 < this.realHeight) {
        ...
        if (e.ifArray(a)) {
          ...
          if (c.parseDates && !c.equalSpacing) {
            if (
              ((c = this.startTime), (d = this.endTime), isNaN(c) || isNaN(d))
            )
          ...
          for (e = !1, f = 0; f < c; f++)
            (d = this.graphs[f]),
              ...
              d.valueAxis == g &&
                "column" == d.type &&
                (!e && d.stackable && (a++, (e = !0)),
                ((!d.stackable && d.clustered) || (d.newStack && 0 !== m)) &&
                  a++,
                (d.columnIndex = a - 1),
    ...
    updateChartCursor: function () {
      ...
      if (a) {
        ...
        this.rotate
          ? ((a.vLineEnabled = l), (a.hZoomEnabled = h), (a.vZoomEnabled = f))
          : ((a.hLineEnabled = l), (a.vZoomEnabled = h), (a.hZoomEnabled = f));
      ...
      this.rotate
        ? (isNaN(a) ||
            ...
            (this.relativeZoomValueAxes(this.valueAxes, a, b) &&
              this.updateAfterValueZoom()),
          h.vZoomEnabled && ((f = e.start), (l = e.end)))
        : (isNaN(c) ||
            isNaN(d) ||
            (this.relativeZoomValueAxes(this.valueAxes, c, d) &&
              this.updateAfterValueZoom()),
          h.hZoomEnabled && ((f = e.start), (l = e.end)));
      isNaN(f) ||
        isNaN(l) ||
        ((a = this.categoryAxis),
        a.parseDates && !a.equalSpacing
          ? this.zoomToDates(new Date(f), new Date(l))
          : this.zoomToIndexes(f, l));
    },
            ...
            if (this.prevCursorItem != g || k != this.prevMostCloseGraph) {
              ...
              for (h = 0; h < d.length; h++) {
                ...
                if (
                  b.showNextAvailable &&
                  isNaN(l.y) &&
                  ((l = this.getNextItem(l)), !l && f.balloon)
                ) {
                  f.balloon.hide();
                  continue;
                }
    ...
    arrangeBalloons: function (a) {
      ...
      for (c = 0; c < f; c++) {
        ...
        0 < c &&
          b - l < e + 3 &&
          d.setBounds &&
          (d.setBounds(0, e + 3, h, e + l + 3), d.restorePrevious(), d.draw());
        d.set && d.set.show();
        e = d.bottom;
      }
    },
    ...
    draw: function () {
      ...
      if (e.ifArray(a)) {
        ...
        if (this.parseDates && !this.equalSpacing)
          ...
          if (
            ...
            for (
              ...
              "start" == this.gridPosition &&
                ((f -= this.cellWidth / 2), (l = this.cellWidth / 2));
              p = !0;
              E = l;
          ...
          r &&
            1 < v &&
            ((t = this.chooseMinorFrequency(v)), e.getPeriodDuration(g, t));
                ...
                a
                  ...
                  : (w || (u = !1),
                    f - this.previousPos >
                      ...
                      (this.labelFunction &&
                        (n = this.labelFunction(n, new Date(t), this, g, v, E)),
                      this.boldLabels && (u = !0),
                      (p = new this.axisItemRenderer(
                        this,
                        f,
