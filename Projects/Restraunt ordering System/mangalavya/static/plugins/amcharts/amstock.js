  ...
  e.AmStockChart = e.Class({
    ...
    afterWrite: function (a) {
      ...
      c &&
        e.AmExport &&
        !this.AmExport &&
        (this.AmExport = new e.AmExport(this, c));
      this.amExport &&
        e.AmExport &&
        (this.AmExport = e.extend(this.amExport, new e.AmExport(this), !0));
      ...
      this.categoryAxesSettings = e.processObject(
        this.categoryAxesSettings,
        e.CategoryAxesSettings,
        b
      );
      this.valueAxesSettings = e.processObject(
        this.valueAxesSettings,
        e.ValueAxesSettings,
        b
      );
      this.chartCursorSettings = e.processObject(
        this.chartCursorSettings,
        e.ChartCursorSettings,
        b
      );
      this.chartScrollbarSettings = e.processObject(
        this.chartScrollbarSettings,
        e.ChartScrollbarSettings,
        b
      );
      this.legendSettings = e.processObject(
        this.legendSettings,
        e.LegendSettings,
        b
      );
      this.panelsSettings = e.processObject(
        this.panelsSettings,
        e.PanelsSettings,
        b
      );
      this.stockEventsSettings = e.processObject(
        this.stockEventsSettings,
        e.StockEventsSettings,
        b
      );
      this.dataSetSelector &&
        (this.dataSetSelector = e.processObject(
          this.dataSetSelector,
          e.DataSetSelector,
          b
        ));
      this.periodSelector &&
        (this.periodSelector = e.processObject(
          this.periodSelector,
          e.PeriodSelector,
          b
        ));
    ...
    updateDataSets: function () {
      ...
      for (c = 0; c < b.length; c++) {
        ...
        void 0 === d.color &&
          (d.color =
            this.colors.length - 1 > c ? this.colors[c] : e.randomColor());
      }
    ...
    getLastDate: function (a) {
      ...
      var c = e.extractPeriod(a),
        b = e.changeDate(b, c.period, 1 * c.count, !0).getTime();
      -1 == a.indexOf("fff") && --b;
      return new Date(b);
    },
    getFirstDate: function (a) {
      ...
      return new Date(
        e.resetDateToMin(a, b.period, 1 * b.count, this.firstDayOfWeek)
      );
    },
    updateData: function () {
      var a = this,
      ...
      if (b) {
        ...
        -1 == e.getItemIndex(c.minPeriod, c.groupToPeriods) &&
          c.groupToPeriods.unshift(c.minPeriod);
        ...
        if (e.ifArray(d)) {
          ...
          a.periodSelector &&
            a.periodSelector.setRanges(a.firstDate, a.lastDate);
          b.dataParsed ||
            ((a.parsingData = !0),
            0 < a.processTimeout
              ? setTimeout(function () {
                  a.parseStockData.call(
                    a,
                    b,
                    c.minPeriod,
                    c.groupToPeriods,
    ...
    fixGlue: function () {
      if (
        ...
        this.startDate = e.resetDateToMin(
          this.startDate,
          a.period,
          a.count,
          this.firstDayOfWeek
    ...
    isDataParsed: function () {
      if (this.mainDataSet) {
        for (var a = !0, b = 0; b < this.comparedDataSets.length; b++)
          this.comparedDataSets[b].dataParsed || (a = !1);
    ...
    onDataUpdated: function () {
      this.isDataParsed() &&
        ...
        this.skipEvents || this.fire({ type: "dataUpdated", chart: this }));
    },
    updateComparingData: function () {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        d.dataParsed ||
          ((this.parsingData = !0),
          0 < this.processTimeout
            ? this.delayedParseStockData(c, d)
            : this.parseStockData(
                d,
                b.minPeriod,
                b.groupToPeriods,
      ...
      if (n) {
        ...
        for (q = 0; q < t; q++) {
          ...
          for (z = f; z < m; z++) {
            ...
            if (z == f || C >= y[p] || !y[p]) {
              v[p] = {};
              v[p].amCategoryIdField = String(
                e.resetDateToMin(D, F, G, d).getTime()
              );
              var H;
              for (H = 0; H < E; H++)
                (u = A[H].toField),
              ...
              z > f &&
                ((u = e.newDate(D, b)),
                (u = e.changeDate(u, F, G, !0)),
                (u = e.resetDateToMin(u, F, G, d)),
                (y[p] = u.getTime()));
              if (z == f)
                for (var I in B) B.hasOwnProperty(I) && (v[p][I] = B[I]);
              v[p][n] = e.newDate(D, b);
            } else
              for (w = v[p], w.rawData && w.rawData.push(B), p = 0; p < E; p++)
                (u = A[p].toField),
                  q == t - 1 && (w[n] = e.newDate(D, b)),
                  null !== r[u] &&
                    ((x = Number(r[u])),
                    isNaN(x) ||
                      (isNaN(w[u + "Low"]) && (w[u + "Low"] = x),
                      x < w[u + "Low"] && (w[u + "Low"] = x),
                      isNaN(w[u + "High"]) && (w[u + "High"] = x),
                      x > w[u + "High"] && (w[u + "High"] = x),
                      isNaN(w[u + "AbsHigh"]) && (w[u + "AbsHigh"] = x),
                      Math.abs(x) > w[u + "AbsHigh"] && (w[u + "AbsHigh"] = x),
                      (w[u + "Close"] = x),
                      (F = e.getDecimals(w[u + "Sum"])),
                      (G = e.getDecimals(x)),
                      isNaN(w[u + "Sum"]) && (w[u + "Sum"] = 0),
                      (w[u + "Sum"] += x),
                      (w[u + "Sum"] = e.roundTo(w[u + "Sum"], Math.max(F, G))),
                      w[u + "Count"]++,
                      (w[u + "Average"] = w[u + "Sum"] / w[u + "Count"])));
          }
        }
      }
      a.agregatedDataProviders = l;
      e.ifArray(a.stockEvents)
        ? 0 < g.processTimeout
          ? setTimeout(function () {
              g.parseEvents.call(
                g,
        ...
        : ((a.dataParsed = !0), g.onDataUpdated());
    },
    parseEvents: function (a, b, c, d, k, g) {
      d = a.stockEvents;
      d.sort(function (a, b) {
        return a.showOnAxis || b.showOnAxis
      ...
      for (n = 0; n < h; n++) {
        ...
        for (f = 0; f < m; f++)
          (q = t[f]),
            (q.customBulletField = "amCustomBullet" + q.id + "_" + p.id),
            (q.bulletConfigField = "amCustomBulletConfig" + q.id + "_" + p.id),
            (q.chart = p);
        for (f = 0; f < d.length; f++)
          (m = d[f]),
            (q = m.graph),
            e.isString(q) && (q = e.getObjById(t, q)) && (m.graph = q),
            q && (m.panel = q.chart);
      }
      for (var y in l)
        if (l.hasOwnProperty(y))
          for (
            b = l[y], h = e.extractPeriod(y), n = b.length, f = 0;
            f < d.length;
            f++
          ) {
            m = d[f];
            ...
            v &&
              ...
              (p = m.panel),
              q &&
                ((t = "amCustomBullet" + q.id + "_" + p.id),
                (q = "amCustomBulletConfig" + q.id + "_" + p.id),
                v[q]
                  ? (p = v[q])
                  : ((p = {}),
                    (p.eventDispatcher = k),
                    ...
                    (v[t] = e.StackedBullet),
                    (v[q] = p)),
                p.eventObjects.push(m),
                p.letters.push(m.text),
                p.descriptions.push(m.description),
                m.type ? p.shapes.push(m.type) : p.shapes.push(c.type),
                void 0 !== m.backgroundColor
                  ? p.backgroundColors.push(m.backgroundColor)
                  : p.backgroundColors.push(c.backgroundColor),
                isNaN(m.backgroundAlpha)
                  ? p.backgroundAlphas.push(c.backgroundAlpha)
                  : p.backgroundAlphas.push(m.backgroundAlpha),
                isNaN(m.borderAlpha)
                  ? p.borderAlphas.push(c.borderAlpha)
                  : p.borderAlphas.push(m.borderAlpha),
                void 0 !== m.borderColor
                  ? p.borderColors.push(m.borderColor)
                  : p.borderColors.push(c.borderColor),
                void 0 !== m.rollOverColor
                  ? p.rollOverColors.push(m.rollOverColor)
                  : p.rollOverColors.push(c.rollOverColor),
                void 0 !== m.showAt
                  ? p.showAts.push(m.showAt)
                  : p.showAts.push(c.showAt),
                void 0 !== m.fontSize && p.fontSizes.push(m.fontSize),
                p.colors.push(m.color),
                p.values.push(m.value),
                p.showOnAxis.push(m.showOnAxis),
                p.showBullets.push(m.showBullet),
                (p.date = new Date(m.date))));
          }
      a.dataParsed = !0;
      this.onDataUpdated();
    },
    getEventDataItem: function (a, b, c, d, k, g) {
      ...
      "YYYY" == l &&
        (q = e
          .resetDateToMin(new Date(m), l, h, this.firstDayOfWeek)
          .getTime());
      l =
        "fff" == l
          ? m.getTime() + 1
          : e
              .resetDateToMin(
                e.changeDate(new Date(m), g.period, g.count),
                l,
                h,
                this.firstDayOfWeek
              )
      ...
      if (!(1 >= k - d))
        return a < q
          ? this.getEventDataItem(a, b, c, d, n, g)
          : this.getEventDataItem(a, b, c, n, k, g);
    },
    createLayout: function () {
      var a = this.div,
        b,
        c,
        d = this.classNamePrefix,
    ...
    measurePanels: function (a) {
      ...
      if (this.div) {
        ...
        (b = this.periodSelector) &&
          !b.vertical &&
          ((b = b.offsetHeight), (c -= b + e));
        (b = this.dataSetSelector) &&
          !b.vertical &&
          ((b = b.offsetHeight), (c -= b + e));
        a ||
          (c == this.prevPH && this.prevPW == d) ||
          this.fire({ type: "resized", chart: this });
        ...
        if (c != this.prevPH) {
          ...
          for (b = 0; b < a.length; b++)
            if ((g = a[b]))
              (g.percentHeight = (g.percentHeight / d) * 100),
                g.panelBox &&
                  (g.panelBox.style.height =
                    Math.round((g.percentHeight * this.panelsHeight) / 100) +
                    "px");
          this.prevPH = c;
        }
      }
    ...
    addStockPanel: function (a, b) {
      ...
      if ((d = a.stockLegend))
        (d = e.processObject(d, e.StockLegend, this.theme)),
          (d.container = void 0),
          (d.title = a.title),
          ...
          (d.verticalGap = 3),
          (d.position = "top"),
          e.copyProperties(this.legendSettings, d),
    ...
    updatePanel: function (a) {
      ...
      void 0 !== this.mouseWheelScrollEnabled &&
        (a.mouseWheelScrollEnabled = this.mouseWheelScrollEnabled);
      void 0 !== this.mouseWheelZoomEnabled &&
        (a.mouseWheelZoomEnabled = this.mouseWheelZoomEnabled);
      ...
      d = c.length;
      for (b = 0; b < d; b++)
        (k = c[b]), e.copyProperties(this.valueAxesSettings, k);
      a.listenersAdded = !1;
      a.write(a.panelBox);
    },
    zoom: function (a, b) {
    ...
    updatePanelsWithNewData: function () {
      ...
      if (a) {
        ...
        if (b) {
          ...
          if (0 < a.dataProvider.length) {
            ...
            if (g) {
              ...
              this.getLastDate(l[l.length - 1][h]).getTime() - n <
                e.getPeriodDuration(g) && (g = d);
        ...
        0 < a.dataProvider.length &&
          (this.fixGlue(), this.zoomChart(this.startDate, this.endDate));
      }
    ...
    addChartScrollbar: function () {
      ...
      if (a.enabled) {
        ...
        var l;
        d &&
          ((l = new e.AmGraph(this.theme)),
          (l.valueField = d.valueField),
          (l.periodValue = d.periodValue),
          (l.type = d.type),
          (l.connect = d.connect),
          (l.minDistance = a.minDistance),
          b.addGraph(l));
        ...
        "bottom" == a.position
          ...
          : c
          ? "top" == c.position
            ? k.insertBefore(l, d.nextSibling)
        ...
        switch (a.position) {
          ...
          case "bottom":
            (k.style.marginTop = c + "px"),
              "bottom" == d ? h.insertBefore(k, b) : h.appendChild(k);
        }
    ...
    handlePeriodSelectorZoom: function (a) {
      ...
      a.predefinedPeriod
        ? ((this.predefinedStart = a.startDate),
          (this.predefinedEnd = a.endDate))
    ...
    addCursor: function (a) {
      ...
      if (b.enabled) {
        ...
        a.chartCursor &&
          (e.copyProperties(a.chartCursor, c),
          a.chartCursor.categoryBalloonFunction &&
            (d = a.chartCursor.categoryBalloonFunction));
        c.categoryBalloonFunction = d;
        a.removeChartCursor();
        a.addChartCursor(c);
        "mouse" == b.cursorPosition
          ? this.listenTo(c, "moved", this.handleCursorChange)
    ...
    zoomChart: function (a, b) {
      ...
      if (k && g) {
        ...
        if (l) {
          ...
          a.getTime() == b.getTime() &&
            v != n &&
            ((b = e.changeDate(b, v.period, v.count)),
        ...
        v = e.newDate(a);
        c.extendToFullPeriod &&
          (v.getTime() - k.getTime() < 0.1 * A &&
            (v = e.resetDateToMin(a, n.period, n.count, y)),
          g.getTime() - b.getTime() < 0.1 * A &&
            ((b = e.resetDateToMin(g, n.period, n.count, y)),
            (b = e.changeDate(b, n.period, n.count, !0))));
        for (k = 0; k < q.length; k++)
          (g = q[k]), g.chartCursor && g.chartCursor.panning && (v = d);
        for (k = 0; k < q.length; k++) {
          g = q[k];
          d = !1;
          if (l != h) {
            for (d = 0; d < t.length; d++)
              (A = t[d].graph),
                (A.dataProvider = A.dataSet.agregatedDataProviders[l]);
            d = g.categoryAxis;
            d.firstDayOfWeek = y;
            d.minPeriod = l;
            g.dataProvider = c.mainDataSet.agregatedDataProviders[l];
            if ((d = g.chartCursor))
              (d.categoryBalloonDateFormat =
                c.chartCursorSettings.categoryBalloonDateFormat(n.period)),
          ...
          d ||
            ((g.startTime = void 0), (g.endTime = void 0), g.zoomToDates(v, b));
          0 < f.startDuration && c.animationPlayed && !d
            ? ((g.startDuration = 0), g.animateAgain())
            : 0 < f.startDuration && !d && g.animateAgain();
        }
        c.animationPlayed = !0;
        f = e.newDate(b);
        p &&
        ...
        c.skipEvents ||
          ...
          (m.period = l),
          c.fire(m),
          (c.previousStartDate = e.newDate(a)),
          (c.previousEndDate = e.newDate(b)));
      }
      ...
      if (0 < this.dataSets.length) {
        ...
        for (b = 0; b < a.length; b++) {
          ...
          for (l = 0; l < g.length; l++) {
            ...
            g[l] = f;
            if (!f.title || f.resetTitleOnDataSetChange)
              (f.title = d.title), (f.resetTitleOnDataSetChange = !0);
            f.useDataSetColors &&
              ((f.lineColor = d.color),
              (f.fillColors = void 0),
              (f.bulletColor = void 0));
            var m = !1,
              q = d.fieldMappings;
            ...
            var p = c.stockLegend,
              ...
              E;
            p &&
              ((p = e.processObject(p, e.StockLegend, this.theme)),
              (c.stockLegend = p),
              (y = p.valueTextComparing),
              (v = p.valueTextRegular),
              (A = p.periodValueTextComparing),
              (E = p.periodValueTextRegular));
            if (f.comparable) {
              var B = k.length;
              if (f.valueAxis) {
                0 < B &&
                  f.valueAxis.logarithmic &&
                  "never" != c.recalculateToPercents &&
                  ((f.valueAxis.logarithmic = !1), (f.valueAxis.prevLog = !0));
                0 < B &&
                  "whenComparing" == c.recalculateToPercents &&
                  (f.valueAxis.recalculateToPercents = !0);
                p &&
                  f.valueAxis &&
                  !0 === f.valueAxis.recalculateToPercents &&
                  (t = !0);
                var D;
                for (D = 0; D < B; D++) {
                  var C = k[D],
                  ...
                  r ||
                    ((r = new e.AmGraph(this.theme)),
                    (r.id = "comparedGraph_" + f.id + "_" + C.id));
                  f.compareGraphType && (r.type = f.compareGraphType);
                  f.compareGraph &&
                    (e.copyProperties(f.compareGraph, r),
                    f.compareGraph.balloon &&
                      ((r.balloon = {}),
                      e.copyProperties(f.compareGraph.balloon, r.balloon)));
                  ...
                  q = C.fieldMappings;
                  for (h = 0; h < q.length; h++)
                    (n = q[h]), n.toField == z && (m = !0);
                  if (m) {
                    r.valueField = z;
                    r.title = C.title ? C.title : f.title;
                    r.lineColor = C.color;
                    f.compareGraphLineColor &&
                      (r.lineColor = f.compareGraphLineColor);
                    ...
                    if ((h = f.compareGraphNegativeFillColors))
                      r.negativeFillColors = h;
                    if ((h = f.compareGraphFillAlphas)) r.fillAlphas = h;
                    if ((h = f.compareGraphNegativeFillAlphas))
                      r.negativeFillAlphas = h;
                    if ((h = f.compareGraphBullet)) r.bullet = h;
                    if ((h = f.compareGraphNumberFormatter))
                      r.numberFormatter = h;
                    ...
                    if ((h = f.compareGraphBulletBorderColor))
                      r.bulletBorderColor = h;
                    ...
                    p &&
                      (t && y
                        ? ((r.legendValueTextR = y),
                          (r.legendPeriodValueTextR = A))
                        : (v && (r.legendValueTextR = v),
                          (r.legendPeriodValueTextR = E)));
                    c.showComparedOnTop
                      ? c.graphs.push(r)
                      : c.graphs.unshift(r);
                    this.comparedGraphs.push({ graph: r, dataSet: C });
                  }
                }
              }
            }
            p &&
              (t && y
                ? ((f.legendValueTextR = y), (f.legendPeriodValueTextR = A))
                : (v && (f.legendValueTextR = v),
                  (f.legendPeriodValueTextR = E)));
          }
        }
      }
    },
    passFields: function (a, b) {
      for (
        var c =
            "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern gap className".split(
              " "
            ),
          d = 0;
        d < c.length;
    ...
    choosePeriod: function (a, b, c) {
      ...
      return (f - n) / h > m && 0 < m && l ? this.choosePeriod(a + 1, b, c) : g;
    },
    ...
    removePanel: function (a) {
      ...
      for (c = b.length - 1; 0 <= c; c--)
        b[c] == a &&
          (this.fire({ type: "panelRemoved", panel: a, chart: this }),
          b.splice(c, 1),
          a.destroy(),
          a.clear());
    },
    ...
    validateSizeReal: function () {
      ...
      this.measure();
      if (
        this.divRealWidth != this.previousWidth ||
        this.divRealHeight != this.previousHeight
      )
        0 < this.divRealWidth &&
  ...
  e.PeriodSelector = e.Class({
    ...
    zoom: function (a, b) {
      ...
      this.inputFieldsEnabled &&
        ((this.startDateField.value = e.formatDate(a, this.dateFormat, c)),
        (this.endDateField.value = e.formatDate(b, this.dateFormat, c)));
    ...
    write: function (a) {
      ...
      b.div = a;
      a.innerHTML =
        '<fieldset style="border: none; padding:0"><legend style="display: none;">' +
        (c.langObj.periodSelectorAccessibilityText || b.accessibilityText) +
        "</legend></fieldset>";
      var l = a.firstChild;
      a = b.theme;
      k = b.position;
      ...
      if (b.inputFieldsEnabled) {
        ...
        k
          ? e.addBr(n)
          : ((n.style.styleFloat = "left"), (n.style.display = "inline"));
        ...
        e.isIE &&
          m.attachEvent("onkeypress", function (a) {
            b.handleCalendarChange.call(b, a);
          });
        n.appendChild(m);
        b.startDateField = m;
      ...
      if (e.ifArray(n)) {
        ...
        for (var t, c = 0; c < n.length; c++)
          (l = n[c]),
            ...
            (t.count = l.count),
            (t.periodObj = l),
            (t.className = "amChartsButton " + d + "-period-input"),
            a && e.applyStyles(t.style, a.PeriodButton),
            k && (t.style.width = b.width - 1 + "px"),
            (t.style.boxSizing = "border-box"),
            f.appendChild(t),
            b.addEventListeners(t),
            (l.button = t);
    ...
    selectPeriodButton: function (a, b, c) {
      ...
      f &&
        ...
        ("MAX" == g
          ...
          ? h
            ? ((h = f),
              (n = new Date(f)),
              "YYYY" == g && (k *= 12),
              n.setMonth(n.getMonth() + k))
            : ((h = new Date(m)),
              "YYYY" == g && ((g = "MM"), (k *= 12)),
              "MM" == g && (h = e.resetDateToMin(h, "DD")),
              e.changeDate(h, g, k, !1),
              (n = m))
          : "fff" == g
          ? (e.getPeriodDuration(g, k),
            (q = e.getPeriodDuration(g, k)),
            h
              ? ((h = f), n.setMilliseconds(f.getMilliseconds() - q + 1))
              : ((h = new Date(m.getTime())),
                h.setMilliseconds(h.getMilliseconds() - q + 1),
                (n = this.lastDate)))
          : ((q = e.getPeriodDuration(g, k)),
            h
              ? ((h = f), (n = new Date(f.getTime() + q - 1)))
              : ((h = new Date(m.getTime() - q + 1)), (n = m))),
        ...
        h.getTime() > m.getTime() &&
          ((q = e.getPeriodDuration("DD", 1)), (h = new Date(m.getTime() - q))),
        h.getTime() < f.getTime() && (h = f),
        "YTD" == g &&
          ((a.startTime = h.getTime()),
        ...
        b ||
          ...
          (d.className =
            ...
            l.classNamePrefix +
            "-period-input-selected"),
          t && e.applyStyles(d.style, t.PeriodButtonSelected),
          (a = { type: "changed" }),
          (a.startDate = h),
          (a.endDate = n),
          (a.predefinedPeriod = g),
          (a.chart = this.chart),
          (a.count = k),
          (a.event = c),
          this.fire(a)));
  ...
  e.StockPanel = e.Class({
    ...
    createDrawIcons: function () {
      var a = this,
        ...
        g = e.rect(c, b, b, "#000", 0.005),
        l = e.rect(c, b, b, "#000", 0.005);
      l.translate(b + 1, 0);
    ...
    disableDrawing: function (a) {
      ...
      this.stockChart &&
        (this.stockChart.enableCursors(a), b && b.enableDrawing(!a));
    },
    ...
    handleWheelReal: function (a, b) {
      ...
      if (!this.wheelBusy && c) {
        ...
        if (d != e)
          var g = this.mouseX / this.plotAreaWidth,
            d = d * g,
            e = e * (1 - g);
        if ((c = c.chartScrollbar))
          c.getPercents(),
            (g = 0.05 * (c.percentEnd - c.percentStart)),
            0.005 > g && (g = 0.005),
            0 > a
              ? ((d = c.percentStart + d * g), (e = c.percentEnd + e * g))
              : ((d = c.percentStart - d * g), (e = c.percentEnd - e * g)),
            e > d && c.percentZoom(d, e, !0);
      }
    },
  });
})();
  ...
  e.StockLegend = e.Class({
    ...
    drawLegend: function () {
      ...
      if (b.allowTurningOff) {
        var c = a.container,
          d = c.image(
            b.pathToImages + "xIcon" + b.extension,
            b.realWidth - 19,
            3,
            19,
            19
          ...
          b = c.image(
            b.pathToImages + "xIconH" + b.extension,
            b.realWidth - 19,
            3,
            19,
            19
  ...
  e.DataSetSelector = e.Class({
    ...
    write: function (a) {
      ...
      if (0 < b.countDataSets("showInCompare") && 1 < g.length)
        if (
          ...
          (c = document.createTextNode(k.langObj.compareText || b.compareText)),
          a.appendChild(c),
          (f = b.listCheckBoxSize),
          l)
        ) {
          e.addBr(a);
          ...
          a.appendChild(h);
          h.className =
            "amChartsCompareList " + k.classNamePrefix + "-compare-div";
          ...
          for (c = 0; c < g.length; c++)
            (n = g[c]),
              !0 === n.showInCompare &&
                n != b.chart.mainDataSet &&
                ((d = document.createElement("div")),
                (d.style.padding = "4px"),
                (d.style.position = "relative"),
                (d.name = "amCBContainer"),
                (d.className = k.classNamePrefix + "-compare-item-div"),
                (d.dataSet = n),
                (d.style.height = f + "px"),
                n.compared &&
                ...
                (l.style.backgroundColor = n.color),
                d.appendChild(l),
                (l = document.createElement("div")),
                (l.style.width = "100%"),
                (l.style.position = "absolute"),
                (l.style.left = f + 10 + "px"),
                d.appendChild(l),
                (n = document.createTextNode(n.title)),
          ...
          for (c = 0; c < g.length; c++)
            if (
              ((n = g[c]), !0 === n.showInCompare && n != b.chart.mainDataSet)
            ) {
              f = document.createElement("option");
              f.text = n.title;
              f.value = c;
    ...
    handleDataSetChange: function () {
      var a = this.selectCB,
        ...
        b = this.chart;
      b.mainDataSet = a;
      b.zoomOutOnDataSetChange &&
        ((b.startDate = void 0), (b.endDate = void 0));
      b.validateData(!0);
...
(function () {
  ...
  e.StackedBullet = e.Class({
    ...
    write: function (a) {
      ...
      (this.mastHeight + 2 * (this.fontSize / 2 + 2)) * b >
        this.availableSpace && (this.stackDown = !0);
      this.set = a.set();
      this.cset = a.set();
    ...
    addLetter: function (a, b, c) {
      ...
      this.showOnAxis
        ? ((m = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY),
          (f = h * k),
          (this.nextAxisY = m + k * d))
        : this.value
        ? ((m = this.value),
          l.recalculateToPercents && (m = (m / l.recBaseValue) * 100 - 100),
          (m = l.getCoordinate(m) - this.bulletY),
          (f = h * k))
        : this.showAt
        ? ((v = this.graphDataItem.values),
          l.recalculateToPercents && (v = this.graphDataItem.percents),
          v &&
            ((m = l.getCoordinate(v[this.showAt]) - this.bulletY), (f = h * k)))
        : ((m = this.nextY), (f = h * k));
      a.translate(n, f);
      b.push(a);
      b.translate(0, m);
    ...
    handleMouseOver: function (a, b) {
      ...
      d = this.chart;
      d.showBalloon(
        e.fixNewLines(c.description),
        k.stockEventsSettings.balloonColor,
        !0
      );
      c = d.graphs;
