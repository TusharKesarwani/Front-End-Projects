(function () {
  ...
  function p() {
    ...
    return (
      (c.on = function (d, e) {
        ...
        if ((f = b[d]))
          (f._on = !1),
            (a = a.slice(0, (g = a.indexOf(f))).concat(a.slice(g + 1))),
            delete b[d];
  ...
  function bh(a, b) {
    function f() {
      ...
      (c.lastIndex = 0),
        c.test(e) ||
          ((e = m(e + " " + a)), d ? (b.baseVal = e) : (this.className = e));
    }
    function g() {
          ...
          return (
            a.each(function (h, i, j) {
              ...
              function q(a) {
                ...
                if (c >= 1)
                  return r(), (bt = b), e.end.call(l, h, i), (bt = 0), 1;
              }
              function r() {
              ...
              var k = [],
                ...
                o =
                  l.__transition__ ||
                  (l.__transition__ = { active: 0, count: 0 });
  ...
  function bz() {
    ...
    var d = bA() - b;
    d > 24
      ? (isFinite(d) && (clearTimeout(by), (by = setTimeout(bz, d))), (bx = 0))
      : ((bx = 1), bB(bz));
  }
  function bA() {
    var a = null,
  ...
  function bC(a) {
    ...
    (this.translate = [a.e, a.f]),
      (this.rotate = Math.atan2(a.b, a.a) * bH),
      (this.scale = [d, f || 0]),
      (this.skew = f ? (e / f) * bH : 0);
  }
  function bD(a, b) {
  ...
  function bN(a, b) {
    return (
      (a.range = d3.rebind(a, b.range)),
      (a.rangeRound = d3.rebind(a, b.rangeRound)),
      (a.interpolate = d3.rebind(a, b.interpolate)),
      (a.clamp = d3.rebind(a, b.clamp)),
      a
    );
  }
  function bO(a) {
  ...
  function bR(a, b) {
    return d3.format(
      ",." +
        Math.max(0, -Math.floor(Math.log(bP(a, b)[2]) / Math.LN10 + 0.01)) +
        "f"
    );
  }
  function bS(a, b, c, d) {
  ...
  function bU(a, b) {
    ...
    return (
      ...
      (d.domain = function (e) {
        return arguments.length
          ? ((b = e[0] < 0 ? bX : bW), (c = b.pow), a.domain(e.map(b)), d)
          : a.domain().map(c);
      }),
      (d.nice = function () {
  ...
  function cu(a, b) {
    return a.length < 3
      ? cq(a)
      : a[0] +
          cw((a.push(a[0]), a), cx([a[a.length - 2]].concat(a, [a[1]]), b));
  }
  function cv(a, b, c) {
  ...
  function cy(a) {
    ...
    cG(i, g, h);
    while (++b < c)
      (d = a[b]), g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), cG(i, g, h);
    b = -1;
    while (++b < 2)
      g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), cG(i, g, h);
    return i.join("");
  }
  function cz(a) {
    ...
    while (++c < d)
      (e = a[c]), f.shift(), f.push(e[0]), g.shift(), g.push(e[1]), cG(b, f, g);
    return b.join("");
  }
  function cA(a) {
    var b,
  ...
  function cX(a, b) {
    ...
    return (
      cW
        ? ((c.x = b.pageX), (c.y = b.pageY))
        : ((c.x = b.clientX), (c.y = b.clientY)),
  ...
  function dr() {
    d3.event.keyCode == 32 &&
      dg &&
      !dk &&
      ((dm = null), (dn[0] -= dj[1][0]), (dn[1] -= dj[1][1]), (dk = 2), M());
  }
  function ds() {
    d3.event.keyCode == 32 &&
      dk == 2 &&
      ((dn[0] += dj[1][0]), (dn[1] += dj[1][1]), (dk = 0), M());
  }
  function dt() {
    if (dn) {
      ...
      dk ||
        (d3.event.altKey
          ? (dm ||
              (dm = [(dj[0][0] + dj[1][0]) / 2, (dj[0][1] + dj[1][1]) / 2]),
            (dn[0] = dj[+(a[0] < dm[0])][0]),
            (dn[1] = dj[+(a[1] < dm[1])][1]))
          : (dm = null)),
        dh && (du(a, dh, 0), dp(b, dj)),
        di && (du(a, di, 1), dq(b, dj)),
        df("brush");
    }
  }
  function du(a, b, c) {
    var d = bJ(b.range()),
      ...
      h;
    dk && ((d[0] -= e), (d[1] -= f + e)),
      (g = Math.max(d[0], Math.min(d[1], a[c]))),
      dk
        ? (h = (g += e) + f)
        : (dm && (e = Math.max(d[0], Math.min(d[1], 2 * dm[c] - g))),
          e < g ? ((h = g), (g = e)) : (h = e)),
      (dj[0][c] = g),
      (dj[1][c] = h);
  }
  function dv() {
    dn &&
      ...
      d3
        .select(dg)
        .selectAll(".resize")
        .style("pointer-events", de.empty() ? "none" : "all"),
      df("brushend"),
      (de = df = dg = dh = di = dj = dk = dl = dm = dn = null),
      M());
  }
  function dE(a) {
    var b = d3.event,
  ...
  (d3.functor = function (a) {
    ...
    (d3.mean = function (a, b) {
      ...
      else while (++f < c) j((d = b.call(a, a[f], f))) && (e += (d - e) / ++g);
  ...
  (d3.interpolators = [
    ...
    function (a, b) {
      return (
        (typeof b == "string"
          ? b in X || /^(#|rgb\(|hsl\()/.test(b)
          : b instanceof S || b instanceof $) && d3.interpolateRgb(a + "", b)
      );
    },
    function (a, b) {
  ...
  (d3.hsl = function (a, b, c) {
    ...
    ($.prototype.brighter = function (a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        Z(this.h, this.s, this.l / a)
      );
    }),
    ($.prototype.darker = function (a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        Z(this.h, this.s, a * this.l)
      );
    }),
    ...
    (bd.selectAll = function (a) {
      ...
      for (var f = -1, g = this.length; ++f < g; )
        for (var h = this[f], i = -1, j = h.length; ++i < j; )
          if ((e = h[i]))
            b.push((c = d(a.call(e, e.__data__, i)))), (c.parentNode = e);
      return ba(b);
    }),
  ...
  (bd.style = function (a, b, c) {
    ...
    (bd.sort = function (a) {
      ...
      for (var b = 0, c = this.length; b < c; b++)
        for (
          var d = this[b].sort(a), e = 1, f = d.length, g = d[0];
          e < f;
          e++
        ) {
          var h = d[e];
    ...
    (bd.transition = function () {
      ...
      for (var d = -1, e = this.length; ++d < e; ) {
        ...
        for (var f = this[d], g = -1, h = f.length; ++g < h; )
          b.push((c = f[g]) ? { node: c, delay: 0, duration: 250 } : null);
      }
      return bn(a, bt || ++bs, Date.now());
    });
  var bk = ba([[document]]);
  (bk[0].parentNode = document.documentElement),
  ...
  (br.call = bd.call),
    ...
    (d3.transition.prototype = br),
    (br.select = function (a) {
      var b = [],
        c,
        d,
        e;
  ...
  (d3.timer = function (a, b, c) {
    ...
    d || (bw = { callback: a, then: c, delay: b, next: bw }),
  ...
  (d3.transform = function (a) {
    return (
      bG.setAttribute("transform", a),
      new bC(bG.transform.baseVal.consolidate().matrix)
    );
  }),
  ...
  (d3.svg.axis = function () {
    function j(j) {
      j.each(function (k, l, m) {
        var n = d3.select(this),
          ...
          E = o(C),
          F = this.__chart__ || a;
        (this.__chart__ = a.copy()),
          x.append("svg:line").attr("class", "tick"),
          x.append("svg:text"),
    ...
    return (
      ...
      (j.tickSize = function (a, b, f) {
        ...
        return (
          (c = +a), (d = g > 1 ? +b : c), (e = g > 0 ? +arguments[g] : c), j
        );
      }),
        ...
        a.each(function () {
          ...
          h
            ...
            j
              ...
              .attr("height", 6)
              .style("visibility", "hidden")
              .style("pointer-events", e.empty() ? "none" : "all")
            ...
            b &&
              ((k = bJ(b.range())),
              h.attr("x", k[0]).attr("width", k[1] - k[0]),
              dp(a, d)),
            c &&
              ((k = bJ(c.range())),
              h.attr("y", k[0]).attr("height", k[1] - k[0]),
              dq(a, d));
        });
      }
      function f() {
        ...
        (de = e),
          ...
          (dn = d3.svg.mouse(dg)),
          (dk = a.classed("extent"))
            ? ((dn[0] = d[0][0] - dn[0]), (dn[1] = d[0][1] - dn[1]))
            : a.classed("resize")
            ? ((dl = d3.event.target.__data__),
              (dn[0] = d[+/w$/.test(dl)][0]),
              (dn[1] = d[+/^n/.test(dl)][1]))
            : d3.event.altKey && (dm = dn.slice()),
          (dh = !/^(n|s)$/.test(dl) && b),
          (di = !/^(e|w)$/.test(dl) && c),
          (df = g(this, arguments)),
          df("brushstart"),
    ...
    (d3.behavior.drag = function () {
      function b() {
        this.on("mousedown.drag", d).on("touchstart.drag", d),
          d3
            .select(window)
            .on("mousemove.drag", dG)
            .on("touchmove.drag", dG)
            .on("mouseup.drag", dH, !0)
            .on("touchend.drag", dH, !0)
            .on("click.drag", dI, !0);
      }
      function c() {
        (dx = a),
          (dy = d3.event.target),
          (dB = dF((dz = this).parentNode)),
          (dC = 0),
          (dA = arguments);
      }
      function d() {
  ...
  d3.behavior.zoom = function () {
    ...
    function g() {
      e.apply(this, arguments),
        dL || (dL = dW(d3.svg.mouse(dS))),
        eb(dX() + a[2], d3.svg.mouse(dS), dL);
    }
    function h() {
      e.apply(this, arguments);
      var b = d3.svg.mouse(dS);
      eb(
        d3.event.shiftKey ? Math.ceil(a[2] - 1) : Math.floor(a[2] + 1),
        b,
        dW(b)
      );
    }
    function i() {
      ...
      b.length === 1 &&
        d - dN < 300 &&
        eb(1 + Math.floor(a[2]), (c = b[0]), dM[c.identifier]),
        (dN = d);
    }
    var a = [0, 0, 0],
      b = d3.dispatch("zoom"),
