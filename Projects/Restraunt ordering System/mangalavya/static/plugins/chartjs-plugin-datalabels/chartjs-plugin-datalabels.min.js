...
!(function (t, e) {
    ...
    v = {
      toTextLines: function (t) {
        ...
        for (t = [].concat(t); t.length; )
          "string" == typeof (e = t.pop())
            ? n.unshift.apply(n, e.split("\n"))
            : Array.isArray(e)
            ? t.push.apply(t, e)
            : r.isNullOrUndef(t) || n.unshift("" + e);
        return n;
      },
      toFontString: function (t) {
        return !t || r.isNullOrUndef(t.size) || r.isNullOrUndef(t.family)
          ? null
          : (t.style ? t.style + " " : "") +
              (t.weight ? t.weight + " " : "") +
              t.size +
      ...
      textSize: function (t, e, n) {
        var a,
          ...
          o = t.font,
          l = 0;
        for (t.font = n.string, a = 0; a < i; ++a)
          l = Math.max(t.measureText(r[a]).width, l);
      ...
      arrayDiff: function (t, e) {
        ...
        for (n = 0, r = e.length; n < r; ++n)
          (i = e[n]),
            -1 === (a = o.indexOf(i)) ? l.push([i, 1]) : o.splice(a, 1);
  ...
  var s = function (t, e, n) {
      var a,
        ...
        s = t.outerRadius;
      return (
        (a = "start" === e ? l : "end" === e ? s : (l + s) / 2),
        f(t.x + i * a, t.y + o * a, i, o, n)
      );
    },
    d = function (t, e, n, a) {
      var r = u(t, a),
        ...
        o = 0;
      return (
        "start" === e ? (o = -i) : "end" === e && (o = i),
        f(t.x + r.x * o, t.y + r.y * o, r.x, r.y, n)
      );
    },
    c = function (t, e, n, a) {
      var r = t.horizontal,
  ...
  b.extend(p.prototype, {
    _modelize: function (t, e, n) {
      ...
      return {
        ...
        positioner:
          ((a = this._el),
          a instanceof l.elements.Arc
            ? s
            : a instanceof l.elements.Point
            ? d
            : a instanceof l.elements.Rectangle
            ? c
            : h),
    ...
    update: function (t) {
      var e,
        ...
        i = this._index,
        o = this._config;
      b.options.resolve([o.display, !0], t, i) &&
        ((e = t.dataset.data[i]),
        (n = b.valueOrDefault(b.callback(o.formatter, [e, t]), e)),
        (r = (a = b.isNullOrUndef(n) ? [] : v.toTextLines(n)).length
          ? this._modelize(a, o, t)
          : null)),
        (this._model = r);
    },
    draw: function (t) {
      ...
      p &&
        ...
        (n = (function (t, e, n) {
          ...
          var o = e.borderWidth || 0,
            ...
            u = e.rotation,
            f =
              Math.abs((l / 2) * Math.cos(u)) + Math.abs((s / 2) * Math.sin(u)),
            d =
              Math.abs((l / 2) * Math.sin(u)) + Math.abs((s / 2) * Math.cos(u)),
        ...
        this._hitbox.update(n, e.frame, p.rotation),
        g.save(),
        p.clip &&
          ((a = t.chartArea),
          g.beginPath(),
          g.rect(a.left, a.top, a.right - a.left, a.bottom - a.top),
          g.clip()),
        (g.globalAlpha = v.bound(0, p.opacity, 1)),
        g.translate(m(n.x), m(n.y)),
        g.rotate(p.rotation),
        (f = g),
        (d = e.frame),
        (h = (c = p).backgroundColor),
        (y = c.borderColor),
        (x = c.borderWidth),
        (h || (y && x)) &&
          (f.beginPath(),
          b.canvas.roundedRect(
            f,
            m(d.x) - x / 2,
            m(d.y) - x / 2,
            m(d.w) + x,
        ...
        (function (t, e, n, a) {
          ...
          if (f && u)
            for (
              ...
              t.fillText(e[o], m(r), m(i), m(n.w)), (i += s);
        })(g, p.lines, e.text, p),
        g.restore());
    },
    contains: function (t, e) {
        ...
        if (o.isObject(t))
          if (o.isNullOrUndef(t.label))
            if (o.isNullOrUndef(t.r))
              for (r = "", a = 0, n = (e = Object.keys(t)).length; a < n; ++a)
                r += (0 !== a ? ", " : "") + e[a] + ": " + t[e[a]];
            else r = t.r;
          else r = t.label;
        return "" + r;
  ...
  function y(t, e, n) {
    ...
    for (a = l.length - 1; 0 <= a; --a)
      for (r = (i = l[a] || []).length - 1; 0 <= r; --r)
        if ((o = i[r]).contains(e, n)) return { dataset: a, label: o };
    return null;
  }
  function x(t, e, n) {
    var a = e && e[n.dataset];
  ...
  function g(t, e) {
    ...
    if (i.enter || i.leave) {
      ...
      (n = r.hovered),
        ...
        (u = a),
        ((s = n) || u) &&
          (s ? (u ? s.label !== u.label && (d = f = !0) : (d = !0)) : (f = !0),
          d && x(o, l.leave, s),
          f && x(o, l.enter, u));
    }
  }
  (l.defaults.global.plugins.datalabels = n),
    (l.defaults.global.plugins.datalabels = n),
    l.plugins.register({
      id: "datalabels",
      ...
      afterDatasetUpdate: function (t, a, e) {
        var n,
          ...
          x = y.length,
          g = t.ctx;
        for (g.save(), i = 0; i < x; ++i)
          (o = y[i]),
            d && o && !o.hidden && !o._model.skip
              ? (f.push((l = new p(h, g, o, i))),
                l.update(
                  (l.$context = {
                    active: !1,
                    chart: t,
            ...
            (o[w] = l);
        g.restore(),
          _.merge(u.listeners, h.listeners || {}, {
      ...
      beforeEvent: function (t, e) {
        if (t[w].listened)
          switch (e.type) {
            ...
            case "click":
              (a = e),
                (r = (n = t)[w].listeners.click),
                (i = r && y(n, a.x, a.y)) && x(n, r, i);
          }
        var n, a, r, i;
      },
      afterEvent: function (t) {
        ...
        for (e = 0, n = s.length; e < n; ++e)
          (a = s[e])[1] &&
            (r = a[0][w]) &&
            ((r.$context.active = 1 === a[1]), r.update(r.$context));
