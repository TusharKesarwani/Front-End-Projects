      ...
      (c.prototype = {
              ...
              if (
                ...
                if (m && !0 !== n.divider) {
                  ...
                  if (!this.previousElementSibling) {
                    ...
                    D.push(M(S, "dropdown-header" + x, A)),
                      N.push({
                        content: k,
                        subtext: $,
                        type: "optgroup-label",
        ...
        setMenuSize: function (e) {
          ...
          if (
            (this.options.dropupAuto &&
              ((r = a * this.selectpicker.current.elements.length + f.vert),
            ...
            (n =
              ...
              (s = n + d + h + p + u),
              (l = Math.max(n - f.vert, 0)),
              this.$newElement.hasClass(q.DROPUP) &&
                (i =
                  this.sizeInfo.selectOffsetTop -
                  this.sizeInfo.menuExtras.vert),
              (t = (o = i) - d - h - p - u - f.vert);
          else if (
            this.options.size &&
            "auto" != this.options.size &&
            ...
            (t = (i = a * this.options.size + v * m + f.vert) - f.vert),
              (o = i + d + h + p + u),
              (s = l = "");
          }
              ...
              if (
                ...
                (u.activeIndex = void 0),
                  ...
                  t.length ||
                    ...
                    (m.innerHTML = u.options.noneResultsText.replace(
                      "{0}",
                      '"' + G(e) + '"'
                    )),
                    u.$menuInner[0].firstChild.appendChild(m));
        ...
        val: function (e) {
          return void 0 !== e
            ? (this.$element.val(e),
              this.render(),
              this.$element.trigger("changed.bs.select", y),
              (y = null),
              this.$element)
            : this.$element.val();
        },
        ...
        keydown: function (e) {
          ...
          if (
            ...
            void 0 ===
              ...
              (t = -1),
              -1 !== t &&
                ((s = c.selectpicker.current.elements[t + f]).classList.remove(
                  "active"
                ),
              ...
              e.which === H
                ? (-1 !== t && t--,
                  t + f < 0 && (t += a.length),
                  c.selectpicker.view.canHighlight[t + f] ||
                    (-1 ===
                      (t =
                      ...
                      (t = a.length - 1)))
                : (e.which === L || h) &&
                  (++t + f >= c.selectpicker.view.canHighlight.length &&
                    (t = 0),
                  c.selectpicker.view.canHighlight[t + f] ||
                    (t =
                      t +
