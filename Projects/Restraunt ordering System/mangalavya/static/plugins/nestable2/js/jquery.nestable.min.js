    ...
    init: function () {
      ...
      t.each(i, function (e, i) {
        var o = t(i),
          n = o.parent();
        s.setParent(o),
          n.hasClass(s.options.collapsedClass) && s.collapseItem(n.parent());
      }),
    ...
    toArray: function () {
      function e(n, l, a) {
        var r,
          ...
          h = a + 1;
        return (
          n.children(s.options.listNodeName).children(s.options.itemNodeName)
            .length > 0 &&
            (l++,
            n
      ...
      this.scrollTimer && clearTimeout(this.scrollTimer),
        ...
        d.dirAx &&
          ...
          d.distX > 0 &&
            ...
            this.placeEl.parents(r.listNodeName).length + this.dragDepth <=
              r.maxDepth &&
              (o.length
