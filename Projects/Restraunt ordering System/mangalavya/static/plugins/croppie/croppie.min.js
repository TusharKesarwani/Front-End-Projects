!(function (e, t) {
        ...
        try {
          ...
          if (e && ("object" == typeof e || "function" == typeof e)) {
            ...
            if ("function" == typeof i)
              return void s(t(i, e), t(o, this), t(r, this));
          }
      ...
      (i.prototype.catch = function (e) {
        ...
        (i.all = function () {
          var e = Array.prototype.slice.call(
            1 === arguments.length && u(arguments[0]) ? arguments[0] : arguments
          );
      ...
      function () {
        ...
        function h(e, t) {
          ...
          s.options.enforceBoundary
            ? (r.top > i.top + t && r.bottom < i.bottom + t && (a.y = n),
              r.left > i.left + e && r.right < i.right + e && (a.x = o))
            : ((a.y = n), (a.x = o));
        }
        function u(e) {
        ...
        function () {
          ...
          function o(t) {
            ...
            (i = t.wheelDelta
              ...
              ? t.detail / -60
              : 0),
              (o = e._currentZoom + i * e._currentZoom),
              t.preventDefault(),
              L.call(e, o),
              n.call(e);
          }
  ...
  function k(e) {
    ...
    this.options.enforceBoundary &&
      ...
      !e && (l < s.min || l > s.max)
        ...
        : e &&
          ((i = Math.max(h.width / u.width, h.height / u.height)),
          (t = null !== this.data.boundZoom ? this.data.boundZoom : i),
          L.call(this, t)),
      c(s);
  }
  function A(e) {
    ...
    return (
      ...
      l.drawImage(this.elements.preview, i, n, o, r, 0, 0, h, u),
      a &&
        ((l.fillStyle = "#fff"),
      ...
      new Promise(function (e) {
        ...
        .then(function (i) {
          if (
            ...
            a.options.relative &&
              (s = [
                (s[0] * i.naturalWidth) / 100,
                (s[1] * i.naturalHeight) / 100,
                (s[2] * i.naturalWidth) / 100,
                (s[3] * i.naturalHeight) / 100,
              ]);
          else {
            var n,
              o,
  ...
  function P(e) {
    ...
    return (
      "viewport" === r
        ? ((i.outputWidth = m.width), (i.outputHeight = m.height))
        : "object" == typeof r &&
          (r.width && r.height
            ? ((i.outputWidth = r.width), (i.outputHeight = r.height))
            : r.width
            ? ((i.outputWidth = r.width), (i.outputHeight = r.width / f))
            : r.height &&
              ((i.outputWidth = r.height * f), (i.outputHeight = r.height))),
      S.indexOf(a) > -1 && ((i.format = "image/" + a), (i.quality = s)),
      (i.circle = c),
      (i.url = t.data.url),
      (i.backgroundColor = l),
            ...
            e(
              function (e) {
                ...
                return (
                  d(i, "croppie-result"),
                  i.appendChild(n),
                  p(n, { left: -1 * t[0] + "px", top: -1 * t[1] + "px" }),
                  (n.src = e.url),
                  p(i, { width: o + "px", height: r + "px" }),
                  i
                );
              }.call(t, i)
            );
  ...
  function D(e) {
    ...
    (this.data.orientation =
      ...
      (o = n.indexOf(t)),
      (r = (i / 90) % n.length),
      n[(n.length + o + (r % n.length)) % n.length])),
      x(l, this.elements.img, this.data.orientation),
      k.call(this),
      _.call(this),
      (copy = null);
  }
