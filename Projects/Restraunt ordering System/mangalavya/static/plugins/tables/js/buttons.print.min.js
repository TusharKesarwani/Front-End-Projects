(function (e) {
  ...
  i.ext.buttons.print = {
    ...
    action: function (c, b, a, f) {
      ...
      a = function (c, a) {
        for (var b = "<tr>", d = 0, e = c.length; d < e; d++)
          b += "<" + a + ">" + c[d] + "</" + a + ">";
        return b + "</tr>";
      };
      b = '<table class="' + b.table().node().className + '">';
      f.header && (b += "<thead>" + a(c.header, "th") + "</thead>");
      for (var b = b + "<tbody>", j = 0, i = c.body.length; j < i; j++)
        b += a(c.body[j], "td");
      b += "</tbody>";
      ...
      e("style, link").each(function () {
        ...
        "link" === b.nodeName.toLowerCase() &&
          ((g.href = b.href),
          (a = g.host),
          -1 === a.indexOf("/") && 0 !== g.pathname.indexOf("/") && (a += "/"),
          (b.href = g.protocol + "//" + a + g.pathname + g.search));
        k = c + b.outerHTML;
      });
      h.document.head.innerHTML = k;
      h.document.body.innerHTML =
        "<h1>" + c + "</h1><div>" + f.message + "</div>" + b;
