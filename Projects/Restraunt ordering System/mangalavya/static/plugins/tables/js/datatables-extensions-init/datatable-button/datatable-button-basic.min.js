$(document).ready(function () {
  $(".data-basic-initialisation").DataTable({
    ...
    $(".data-class-names").DataTable({
      dom: "Bfrtip",
      buttons: [
        { text: "Red", className: "red btn btn-secondary my-1" },
        { text: "Orange", className: "orange btn btn-secondary my-1" },
        { text: "Green", className: "green btn btn-secondary my-1" },
      ],
    }),
  ...
  new $.fn.dataTable.Buttons(tableMultiple, {
    ...
    tableMultiple
      .buttons(1, null)
      .container()
      .appendTo(tableMultiple.table().container()),
