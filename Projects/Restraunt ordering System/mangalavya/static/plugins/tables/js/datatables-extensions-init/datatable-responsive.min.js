$(document).ready(function () {
  $(".dataex-res-configuration").DataTable({ responsive: !0 });
  ...
  new $.fn.dataTable.FixedHeader(tableFixedHeader, {
    ...
    $(".dataex-res-colreorder").DataTable({ responsive: !0, colReorder: !0 }),
    ...
    $(".dataex-res-controlright").DataTable({
      ...
      columnDefs: [{ className: "control", orderable: !1, targets: -1 }],
    }),
  ...
  $(".dataex-res-scrolling").DataTable({ scrollY: 300, paging: !1 });
  $(function () {
    function resize() {
      setTimeout(function () {
