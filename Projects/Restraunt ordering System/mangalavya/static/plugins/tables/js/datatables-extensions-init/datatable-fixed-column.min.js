$(document).ready(function () {
  ...
  var tableTndex =
    ($(".dataex-lr-fixedcolumns").DataTable({
      scrollY: "300px",
      scrollX: !0,
      scrollCollapse: !0,
      paging: !1,
    ...
    $(".dataex-index-column").DataTable({
      ...
      scrollCollapse: !0,
      paging: !1,
      columnDefs: [{ sortable: !1, class: "index", targets: 0 }],
      order: [[1, "asc"]],
      fixedColumns: !0,
    }));
  tableTndex
  ...
  $(".dataex-individual-filtering tfoot th").each(function (i) {
    var title = $(".dataex-individual-filtering thead th")
      .eq($(this).index())
      .text();
    $(this).html(
  ...
  $(tableIndividualFiltering.table().container()).on(
    "keyup",
    "tfoot input",
    function () {
