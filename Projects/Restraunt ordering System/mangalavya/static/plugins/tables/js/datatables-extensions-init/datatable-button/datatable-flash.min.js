$(document).ready(function () {
  $(".dataex-html5-flashex").DataTable({
    ...
    $(".dataex-html5-separated").DataTable({
      ...
      buttons: [
        "copyFlash",
        { extend: "csvFlash", fieldSeparator: "\t", extension: ".tsv" },
      ],
    }),
    $(".dataex-html5-name").DataTable({
      dom: "Bfrtip",
      buttons: [
        { extend: "excelFlash", filename: "Data export" },
        { extend: "pdfFlash", filename: "Data export" },
      ],
    }),
    ...
    $("#resize").on("click", function () {
      $.fn.dataTable.tables({ visible: !0, api: !0 }).buttons.resize();
    });
});
