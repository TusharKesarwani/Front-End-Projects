$(document).ready(function () {
  $(".datacol-basic-initialisation").DataTable({ colReorder: !0 }),
    ...
    $(".datacol-column-filtering tfoot th").each(function () {
      var title = $(".datacol-column-filtering thead th")
        .eq($(this).index())
        .text();
  ...
  $(".reset").on("click", function (e) {
    e.preventDefault(), tableResetOrdering.colReorder.reset();
  });
  var table = $(".datacol-visibility-integration").DataTable({
    ...
    table = $(".datacol-cixedcolumns-integration").DataTable({
      scrollX: !0,
      scrollCollapse: !0,
      columnDefs: [
  ...
  new $.fn.dataTable.FixedColumns(table, { leftColumns: 1, rightColumns: 1 });
  var table = $(".datacol-responsive-integration").dataTable({
    colReorder: !0,
    responsive: !0,
    columnDefs: [{ targets: 2, responsivePriority: 10001 }],
  });
});
