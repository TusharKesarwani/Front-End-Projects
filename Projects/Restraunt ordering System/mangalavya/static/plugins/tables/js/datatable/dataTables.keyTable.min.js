...
(function (e) {
  ...
  var l = e.fn.dataTable,
    n = function (a, b) {
      ...
      this.c = e.extend(!0, {}, l.defaults.keyTable, n.defaults, b);
      this.s = { dt: new l.Api(a), enable: !0, focusDraw: !1 };
      this.dom = {};
  ...
  e.extend(n.prototype, {
    ...
    _constructor: function () {
      ...
      if (this.c.blurable)
        e(k).on("click.keyTable", function (c) {
      ...
      if (this.c.editor)
        b.on("key.keyTable", function (b, c, d, e, j) {
          a._editor(d, j);
        });
    ...
    _editor: function (a, b) {
      ...
      d.inline(this.s.lastFocus.index());
      e("div.DTE input, div.DTE textarea").select();
      c.keys.enable(this.c.editorKeys);
      c.one("key-blur.editor", function () {
    ...
    _focus: function (a, b, c, d) {
      ...
      if (this.s.enable) {
        ...
        if (-1 !== f.length && (a < f.start || a >= f.start + f.length))
          (this.s.focusDraw = !0),
            g
              .one("draw", function () {
                i.s.focusDraw = !1;
              ...
              .page(Math.floor(a / f.length))
              .draw(!1);
        else if (-1 !== e.inArray(b, this._columns())) {
          f.serverSide && (a -= f.start);
          f = g.cell(":eq(" + a + ")", b, { search: "applied" });
          if (h) {
            if (h.node() === f.node()) return;
            this._blur();
          }
          h = e(f.node());
          ...
          if (c === o || !0 === c)
            this._scroll(e(m), e(k.body), h, "offset"),
              (c = g.table().body().parentNode),
              c !== g.table().header().parentNode &&
                ((c = e(c.parentNode)), this._scroll(c, c, h, "position"));
          this.s.lastFocus = f;
    ...
    _key: function (a) {
      ...
      if (b && !(0 === a.keyCode || a.ctrlKey || a.metaKey || a.altKey)) {
          ...
          if (!(this.c.keys && -1 === e.inArray(a.keyCode, this.c.keys)))
            switch (a.keyCode) {
              ...
              case 34:
                if (c) {
                  ...
                  var f = g
                    ...
                    .indexOf(d.node());
                  g.one("draw", function () {
                    var b = g.cells({ page: "current" }).nodes();
                    i._focus(
                      g.cell(f < b.length ? b[f] : b[b.length - 1]),
                      null,
                      !0,
                      a
                    );
                  })
                    .page(33 === a.keyCode ? "previous" : "next")
                    .draw(!1);
                }
                break;
              case 35:
              case 36:
                c &&
                  (a.preventDefault(),
                  (b = g.cells({ page: "current" }).indexes()),
                  this._focus(
                    g.cell(b[35 === a.keyCode ? b.length - 1 : 0]),
                    null,
                    !0,
                    a
                  ));
              ...
              default:
                !0 === b &&
                  this._emitEvent("key", [g, a.keyCode, this.s.lastFocus, a]);
            }
        }
      }
    },
    _scroll: function (a, b, c, d) {
      var d = c[d](),
        ...
        h = a.height(),
        a = a.width();
      d.top < g && b.scrollTop(d.top);
      d.left < f && b.scrollLeft(d.left);
      d.top + e > g + h && e < h && b.scrollTop(d.top + e - h);
    ...
    _shift: function (a, b, c) {
      ...
      if (f) {
        ...
        d = d.columns(h).indexes().indexOf(f.index().column);
        i = h[d];
        "right" === b
          ? d >= h.length - 1
            ? (j++, (i = h[0]))
          ...
          ? j--
          : "down" === b && j++;
        0 <= j && j < g && -1 !== e.inArray(i, h)
          ? (a.preventDefault(), this._focus(j, i, !0, a))
          : !c || !this.c.blurable
          ? a.preventDefault()
          : this._blur();
      }
    ...
    _tabInput: function () {
      ...
      if (-1 != c)
        e('<div><input type="text" tabindex="' + c + '"/></div>')
          .css({
            position: "absolute",
            height: 1,
            width: 0,
