    ...
    var o = function (s, n) {
      return (
        ...
        t.fn.dataTable.camelToHungarian &&
          t.fn.dataTable.camelToHungarian(o.defaults, n),
        ...
        (this.s.dt = t.fn.dataTable.Api
          ? new t.fn.dataTable.Api(s).settings()[0]
          : s),
        this._fnConstruct(n),
        this
      );
    ...
    return (
      (o.prototype = {
          ...
          for (
            var a = function (t) {
                for (var s = 0, o = t.length; s < o; s++)
                  if (!1 === n[t[s]].bVisible) return !1;
                return !0;
              },
              u = function (t) {
                for (var s = 0, o = t.length; s < o; s++)
                  if (!0 === n[t[s]].bVisible) return !1;
                return !0;
              },
              r = 0,
              d = i.length;
        ...
        _fnAddButtons: function () {
          ...
          if (-1 === t.inArray("all", this.s.aiExclude))
            for (var o = 0, i = n.length; o < i; o++)
              -1 === t.inArray(o, this.s.aiExclude) &&
                (((s = this._fnDomColumnButton(o)).__columnIdx = o),
          ...
          "alpha" === this.s.order &&
            ...
            this.s.restore &&
              (((s = this._fnDomRestoreButton()).className +=
                " ColVis_Restore"),
              this.dom.buttons.push(s)),
            this.s.showAll &&
              (((s = this._fnDomShowXButton(this.s.showAll, !0)).className +=
                " ColVis_ShowAll"),
              this.dom.buttons.push(s)),
            this.s.showNone &&
              (((s = this._fnDomShowXButton(this.s.showNone, !1)).className +=
                " ColVis_ShowNone"),
              this.dom.buttons.push(s)),
        ...
        _fnDomShowXButton: function (s, n) {
          ...
          return t(
            ...
            for (var s = 0, i = o.s.abOriginal.length; s < i; s++)
              -1 === o.s.aiExclude.indexOf(s) &&
                o.s.dt.oInstance.fnSetColumnVis(s, n, !1);
            o._fnAdjustOpenRows(),
        ...
        _fnDomColumnButton: function (s) {
          var n = this,
            ...
            e =
              null === this.s.fnLabel
                ? o.sTitle
                : this.s.fnLabel(s, o.sTitle, o.nTh);
          return t(
            "<li " +
        ...
        _fnCollectionHide: function () {
          ...
          this.s.hidden ||
            ...
            t(this.dom.background).animate(
              ...
              n.s.iOverlayFade,
              function (t) {
                s.body.removeChild(n.dom.background),
                  s.body.removeChild(n.dom.catcher);
              }
            ));
        },
      ...
      (o.fnRebuild = function (t) {
        ...
        for (var n = 0, i = o.aInstances.length; n < i; n++)
          (void 0 !== t && s != o.aInstances[n].s.dt.nTable) ||
            o.aInstances[n].fnRebuild();
      }),
      (o.defaults = {
        active: "click",
