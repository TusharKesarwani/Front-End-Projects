...
(function (e) {
  ...
  function t(b, a, c) {
    ...
    !b.cells({ selected: !0 }).any() && !c
      ? ((d = d(0, a.column)), (c = f(0, a.row)))
      : ((d = d(c.column, a.column)), (c = f(c.row, a.row)));
    c = b.cells(c, d).flatten();
    b.cells(a, { selected: !0 }).any()
      ? b.cells(c).deselect()
      : b.cells(c).select();
  }
  function r(b) {
    ...
    e(b.table().body())
      .off("mousedown.dtSelect", a)
      .off("mouseup.dtSelect", a)
      .off("click.dtSelect", a);
  ...
  function v(b) {
    ...
    a.on("mousedown.dtSelect", d, function (c) {
      if (c.shiftKey || c.metaKey || c.ctrlKey)
        a.css("-moz-user-select", "none").one(
      ...
      .on("click.dtSelect", d, function (c) {
        ...
        if (!i.getSelection || !i.getSelection().toString()) {
          var d = b.settings()[0];
          if (
            e(c.target).closest("div.dataTables_wrapper")[0] ==
            b.table().container()
          ) {
            ...
            if (g.any()) {
              ...
              h.isDefaultPrevented() ||
                ((h = g.index()),
                "row" === a
                  ? ((a = h.row), s(c, b, d, "row", a))
                  : "column" === a
                  ? ((a = g.index().column), s(c, b, d, "column", a))
                  : "cell" === a && ((a = g.index()), s(c, b, d, "cell", a)),
    ...
    e("body").on("click.dtSelect", function (a) {
      c._select.blurable &&
        !e(a.target).parents().filter(b.table().container()).length &&
        (e(a.target).parents("div.DTE").length || p(c, !0));
    });
  }
  function k(b, a, c, d) {
    if (!d || b.flatten().length)
      "string" === typeof a && (a += ".dt"),
        c.unshift(b),
        e(b.table().node()).triggerHandler(a, c);
  }
  function w(b) {
    var a = b.settings()[0];
  ...
  function x(b, a, c, d) {
    var f = b[a + "s"]({ search: "applied" }).indexes(),
      d = e.inArray(d, f),
      m = e.inArray(c, f);
    ...
    b[a](c, { selected: !0 }).any()
      ? (f.splice(e.inArray(c, f), 1), b[a + "s"](f).deselect())
      : b[a + "s"](f).select();
  }
  function p(b, a) {
  ...
  function s(b, a, c, d, f) {
    ...
    "os" === e
      ? b.ctrlKey || b.metaKey
        ...
        : b.shiftKey
        ? "cell" === d
          ? t(a, f, c._select_lastCell || null)
          : x(a, d, f, c._select_lastCell ? c._select_lastCell[d] : null)
        : ((b = a[d + "s"]({ selected: !0 })),
          j && 1 === b.flatten().length
            ? a[d](f).deselect()
            : (b.deselect(), a[d](f).select()))
      : "multi+shift" == e
      ? b.shiftKey
        ? "cell" === d
          ? t(a, f, c._select_lastCell || null)
  ...
  g.select.init = function (b) {
    ...
    if (!0 === c) f = "os";
      ...
      e.isPlainObject(c) &&
      (c.blurable !== h && (m = c.blurable),
      c.info !== h && (j = c.info),
      c.items !== h && (d = c.items),
      c.style !== h && (f = c.style),
      c.selector !== h && (u = c.selector),
      c.className !== h)
    )
      i = c.className;
    b.select.selector(u);
    ...
    e.fn.dataTable.ext.order["select-checkbox"] = function (a, c) {
      return this.api()
        ...
        .nodes()
        .map(function (c) {
          return "row" === a._select.items
            ? e(c).parent().hasClass(a._select.className)
            : "cell" === a._select.items
            ? e(c).hasClass(a._select.className)
            : !1;
        });
    };
    ...
    function (b, a) {
      g.ext.selector[a.type].push(function (c, b, f) {
        ...
        for (var g = 0, i = f.length; g < i; g++)
          (e = c[a.prop][f[g]]),
            ((!0 === b && !0 === e._select_selected) ||
              (!1 === b && !e._select_selected)) &&
              j.push(f[g]);
        return j;
      });
    }
  ...
  g.ext.selector.cell.push(function (b, a, c) {
    ...
    for (var e = 0, g = c.length; e < g; e++)
      (d = b.aoData[c[e].row]),
        ((!0 === a &&
          d._selected_cells &&
          !0 === d._selected_cells[c[e].column]) ||
          (!1 === a &&
            (!d._selected_cells || !d._selected_cells[c[e].column]))) &&
          f.push(c[e]);
    return f;
  });
              ...
              fn: function (c, b, d) {
                ...
                for (d = a.aoColumns.length; c < d; c++)
                  (a.aoColumns[c]._select_selected ||
                    (b._selected_cells && b._selected_cells[c])) &&
                    e(b.anCells[c]).addClass(a._select.className);
              },
    ...
    this.iterator("column", function (a, b) {
      ...
      d.cells(null, b)
        ...
        .each(function (b) {
          ...
          c.anCells &&
            (!d || !d[b.column]) &&
            e(c.anCells[b.column]).removeClass(a._select.className);
        });
    });
    this.iterator("table", function (a, c) {
  ...
  e.extend(g.ext.buttons, {
    ...
    selectedSingle: {
      ...
      init: function (b) {
        ...
        b.on("draw.dt.DT select.dt.DT deselect.dt.DT", function () {
          var c =
            b.rows({ selected: !0 }).flatten().length +
            b.columns({ selected: !0 }).flatten().length +
            b.cells({ selected: !0 }).flatten().length;
          a.enable(1 === c);
        });
        this.disable();
      },
