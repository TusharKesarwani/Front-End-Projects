...
(function (f) {
  ...
  f.fn.dataTableExt.oApi.fnColReorder = function (a, b, d, e, g) {
    ...
    if (b != d)
      if (0 > b || b >= l)
        ...
        if (null !== a.aoFooter) {
          c = 0;
          for (h = a.aoFooter.length; c < h; c++) p(a.aoFooter[c], b, d);
        }
  ...
  f.extend(i.prototype, {
    ...
    fnOrder: function (a, b) {
      ...
      if (a === r) {
        e = 0;
        for (g = c.length; e < g; e++) d.push(c[e]._ColReorder_iOrigCol);
        return d;
      }
      if (b) {
        c = this.fnOrder();
    ...
    _fnCreateDragNode: function () {
      ...
      this.dom.drag = f(g.cloneNode(!1))
        ...
        .append(f(e.cloneNode(!1)).append(f(d.cloneNode(!1)).append(c[0])))
        .css({
          position: "absolute",
          top: 0,
          left: 0,
