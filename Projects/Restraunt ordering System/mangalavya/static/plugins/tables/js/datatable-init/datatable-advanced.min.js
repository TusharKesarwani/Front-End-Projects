$(document).ready(function () {
  ...
  var defaults = { searching: !1, ordering: !1 };
  $(".setting-defaults").dataTable($.extend(!0, {}, defaults, {})),
    $(".created-callback").DataTable({
      createdRow: function (row, data, index) {
        1 * data[5].replace(/[\$,]/g, "") > 15e4 &&
  ...
  $(".row-grouping tbody").on("click", "tr.group", function () {
    ...
    2 === currentOrder[0] && "asc" === currentOrder[1]
    ...
    $(".custom-toolbar-elements").DataTable({ dom: '<"toolbar">frtip' }),
