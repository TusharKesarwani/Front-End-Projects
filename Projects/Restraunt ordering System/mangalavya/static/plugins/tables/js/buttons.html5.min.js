(function (g) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (j, i, q, r) {
        j || (j = window);
  ...
  function E(a, b) {
    v === m &&
      (v =
        -1 ===
        y
          .serializeToString(g.parseXML(F["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
      ...
      if (g.isPlainObject(c)) {
        ...
        if (v) {
          ...
          for (f = e.attributes.length - 1; 0 <= f; f--) {
            ...
            -1 !== h.indexOf(":") &&
              (n.push({ name: h, value: k }), e.removeAttribute(h));
          }
          f = 0;
  ...
  function N(a, b) {
    ...
    for (
      ...
      e < f &&
      !((c = a.body[e][b].toString().length), c > d && (d = c), 40 < d);
      e++
    );
    return 5 < d ? d : 5;
  }
          ...
          k = function () {
            if (g && G && typeof FileReader !== "undefined") {
              ...
              b.onloadend = function () {
                var a = b.result;
                g.location.href =
                  "data:attachment/file" + a.slice(a.search(/[,;]/));
                c.readyState = c.DONE;
                n();
              };
              b.readAsDataURL(a);
  ...
  var x = function (a, b) {
    ...
    R = function (a) {
      ...
      return a.indexOf("*") !== -1
        ? a.replace("*", g("title").text() || "Exported data")
        : a;
    },
    K = function (a) {
      return a.newline
    ...
    L = function (a, b) {
      for (
        var d = K(b),
          ...
          j = b.header ? k(c.header) + d : "",
          i = b.footer && c.footer ? d + k(c.footer) : "",
          u = [],
          D = 0,
          l = c.body.length;
        D < l;
  ...
  s.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
        ...
        d = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            if (
              typeof a[b] === "number" ||
              (a[b].match &&
                g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) &&
                !g.trim(a[b]).match(/^0\d+/))
            )
              d = o(f, "c", {
                attr: { t: "n", r: d },
      ...
      for (l = b.header.length; i < l; i++)
        d.appendChild(
          o(f, "col", {
            attr: { min: i + 1, max: i + 1, width: N(b, i), customWidth: 1 },
          })
        );
