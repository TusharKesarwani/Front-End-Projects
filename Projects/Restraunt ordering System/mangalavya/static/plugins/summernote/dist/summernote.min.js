    ...
    dom = (function () {
      var a = function (a) {
          ...
          return d.length
            ? 1 === d.length
              ...
              : d.reduce(function (a, d) {
                  return (
                    a === b.node && (a = ga(b, c)),
                    ga({ node: d, offset: a ? dom.position(a) : A(d) }, c)
                  );
                })
            : null;
        },
        ia = function (a, b) {
          ...
          var i =
            c &&
            ha(c, a, { isSkipPaddingBlankHTML: b, isNotSplitEdgePoint: b });
          return (
        ...
        c = function (a, d, e, f) {
          ...
          (this.getPoints = function () {
            ...
            (this.deleteContents = function () {
              ...
              var a = this.splitText(),
                b = a.nodes(null, { fullyContains: !0 }),
          ...
          (this.isOnEditable = h(dom.isEditable)),
            ...
            (this.bookmark = function (b) {
              return {
                s: { path: dom.makeOffsetPath(b, a), offset: d },
                e: { path: dom.makeOffsetPath(b, e), offset: f },
              };
            }),
      ...
      (this.fromNode = function (b) {
        ...
        (this.styleNodes = function (a, b) {
          ...
          var f = dom.makePredByNodeName(c),
            g = a.nodes(dom.isText, { fullyContains: !0 }).map(function (a) {
      ...
      (this.insertOrderedList = function (a) {
        ...
        (this.indent = function (a) {
          var b = this,
            ...
            d = c.nodes(dom.isPara, { includeAncestor: !0 }),
        ...
        (this.toggleList = function (b, c) {
          var d = range.create(c).wrapBodyInlineWithPara(),
            e = d.nodes(dom.isPara, { includeAncestor: !0 }),
            f = d.paraBookmark(e),
          ...
          if (list.find(e, dom.isPurePara)) {
            ...
            var i = d
              .nodes(dom.isList, { includeAncestor: !0 })
              .filter(function (a) {
                return !$.nodeName(a, b);
              });
            i.length
              ...
              var e = list.head(d),
                ...
                h =
                  g.childNodes.length > 1
                    ? dom.splitTree(
                        g,
                        { node: f.parentNode, offset: dom.position(f) + 1 },
                        { isSkipPaddingBlankHTML: !0 }
                      )
                    : null,
                i = dom.splitTree(
                  g,
                  { node: e.parentNode, offset: dom.position(e) },
                  { isSkipPaddingBlankHTML: !0 }
                );
              (d = b
      ...
      (this.events = {
              ...
              if (dom.isControlSizing(d.target)) {
                ...
                c
                  .on("mousemove", function (c) {
                    a.invoke(
                      "editor.resizeTo",
                      { x: c.clientX - f.left, y: c.clientY - (f.top - g) },
                      e,
                      !c.shiftKey
                    ),
                      b.update(e[0]);
        ...
        (this.update = function (b) {
          ...
          if ((a.invoke("imagePopover.update", b), c)) {
            var e = $(b),
              f = e.position(),
              g = { w: e.outerWidth(!0), h: e.outerHeight(!0) };
            d.css({
              display: "block",
              left: f.left,
              top: f.top,
              ...
              return c
                .buttonGroup([
                  ...
                  c.dropdown([
                    ...
                    c.buttonGroup({ className: "note-list", children: [k, l] }),
                  ]),
                ])
                .render();
            }),
          ...
          for (var e = 0, f = d.length; f > e; e++) {
            for (
              var g = d[e],
                h = g[0],
                i = g[1],
                j = c.buttonGroup({ className: "note-" + h }).render(),
                k = 0,
                l = i.length;
              l > k;
              k++
