!(function (t, e, o, r, i) {
      ...
      LINEAR: {
        ...
        to: function (t, e, r) {
          ...
          var i = e.options.forceStandard,
            n = e._prefix;
          n || (i = !0),
            r && -1 !== o.inArray(r, e.options.prefixes) && ((i = !1), (n = r));
          var s =
            "linear-gradient(" +
  ...
  (v.prototype = {
    ...
    setCurrentById: function (t) {
      var e = 0;
      for (var o in this.value.stops)
        this.value.stops[o].id !== t ? e++ : (this.current = e);
    },
    get: function (t) {
      return (
    ...
    type: function (t) {
      if ("string" != typeof t || !(t = t.toUpperCase()) || void 0 === c[t])
        return this._type;
      this._type = t;
    },
    ...
    toStringWithAngle: function (t, e) {
      ...
      return (
        (r.angle = v.parseAngle(t)),
        !0 === e && (e = n()),
        c[this.type()].to(r, this, e)
      );
    },
    ...
    (v.parseStop = function (t) {
      var e;
      return (
        null != (e = g.STOP.exec(t)) && {
          color: e[1],
          position: v.parsePosition(e[2]),
        }
      );
    }),
    ...
    (v.parseAngle = function (t, e) {
      if (
        ...
        for (var i in o)
          (a = o[i]),
            /^(top|left|right|bottom)$/i.test(a) && r.push(o[i].toLowerCase());
        var n = r.join(" ");
      ...
      var a,
        p = parseFloat(t, 10);
      return (
        p > 360 ? (p %= 360) : p < 0 && 0 !== (p %= -360) && (p = 360 + p), p
      );
    }),
