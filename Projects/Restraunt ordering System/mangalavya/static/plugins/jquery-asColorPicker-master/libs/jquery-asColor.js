  ...
  (c.prototype = {
    ...
    format: function (e) {
      if ("string" == typeof e && (e = e.toUpperCase()) && void 0 !== d[e])
        ...
        if (!1 !== e)
          return !1 === this._format ? this._matchFormat : this._format;
        this._format = !1;
      }
    },
    toRGBA: function () {
    ...
    toString: function () {
      var e,
        t = this.value;
      if (!this._valid && "string" == typeof (t = this.options.invalidValue))
        return t;
      if (0 === t.a && this.options.zeroAlphaAsTransparent)
        return d.TRANSPARENT.to(t, this);
      if (
      ...
      return (
        1 !== t.a &&
          ...
          ("string" == typeof this.options.alphaConvert &&
            (e = this.options.alphaConvert),
          void 0 !== this.options.alphaConvert[e] &&
            (e = this.options.alphaConvert[e])),
        d[e].to(t, this)
      );
    },
    get: function () {
    ...
    set: function (e) {
      ...
      r > n
        ? ((t = c.RGBtoHSV(this.value)),
          (0 === this.value.r && 0 === this.value.g && 0 === this.value.b) ||
            (this.value.h = t.h),
          (this.value.s = t.s),
          (this.value.v = t.v))
        : n > r &&
    ...
    (c.RGBtoNAME = function (e, t) {
      ...
      return (
        a ||
        (void 0 === t && (t = c.defaults.nameDegradation),
        d[t.toUpperCase()].to(e))
      );
    }),
    (c.matchString = function (e) {
      if ("string" == typeof e) {
        ...
        var t = null;
        for (var r in d)
          if (null != (t = d[r].match.exec(e)) && d[r].parse(t)) return !0;
      }
      return !1;
    }),
    (c.defaults = {
