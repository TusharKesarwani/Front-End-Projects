!(function () {
  ...
  var e,
        ...
        n = function (e, t) {
          ...
          if (!x.removed) {
            ...
            (l = ["bc-tc", "tc-bc", "tl-bl", "bl-tl", "tr-br", "br-tr"]),
              ...
              t && s.show(),
              (d = e.element),
              (f = z.getPos(x.getContentAreaContainer())),
              (h = x.dom.getRect(d)),
              ...
              (r = h),
              (i = z.getRect(s.getEl())),
              (o = z.getRect(x.getContentAreaContainer() || x.getBody()));
            var g,
              p,
              v,
            ...
            if (
              ...
              (o.x += b.x),
              (o.y += b.y),
              "inline" !== z.getStyle(e.element, "display", !0))
            ) {
            ...
            x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
              ...
              (r = C.clamp(r, o)),
              n
                ? ((a = C.relativePosition(i, r, n)),
                  F(s, U(u, a.x, a.y, r, o, i)))
                : ((o.h += i.h),
                  (r = C.intersect(o, r))
                    ? (n = C.findBestRelativePosition(i, r, o, [
                        "bc-tc",
                        "bl-tl",
                        "br-tr",
                      ]))
              ...
              if (!i) {
                ...
                (i = x.selection.getScrollContainer() || x.getWin()),
                  ...
                  x.on("remove", function () {
                    z.unbind(i, "scroll", t), z.unbind(n, "scroll", t);
                  });
              }
            })(t),
    ...
    he = function (c, d, f) {
      return function (e) {
        ...
        (i = d),
          ...
          l && l.visible()
            ? (fe(u, l, "onhide"), l.hide(), s.active(!1))
            : (l
                ? l.show()
                : ((l = b.create({
                    type: "container",
    ...
    me = function (e) {
      return (
        !((de.ie && !(11 <= de.ie)) || !e.sidebars) && 0 < e.sidebars.length
      );
    },
    ge = function (n) {
      return {
        ...
        items: [
          {
            ...
            items: w.map(n.sidebars, function (e) {
              ...
              return {
                ...
                image: t.image,
                tooltip: t.tooltip,
                onclick: he(n, e.name, n.sidebars),
              };
            }),
          },
        ],
    ...
    ye = function (t, e, n) {
      ...
      if (
        (!1 === g(t) && n.skinUiCss
          ? ve.styleSheetLoader.load(n.skinUiCss, pe(t))
          : pe(t)(),
        (i = e.panel =
          b.create({
            type: "panel",
            ...
            items: [
              {
                ...
                items: [
                  !1 === d(t)
                    ? null
                    : { type: "menubar", border: "0 0 1 0", items: oe(t) },
                  L(t, f(t)),
                ],
              },
              me(t)
        ...
        "none" !== p(t) &&
          (r = {
            ...
            onResize: function (e) {
              "both" === p(t)
                ? ue(t, o.width + e.deltaX, o.height + e.deltaY)
                : ue(t, null, o.height + e.deltaY);
            },
          }),
      ...
      return (
        ...
        n.width && ve.setStyle(i.getEl(), "width", n.width),
    ...
    xe = tinymce.util.Tools.resolve("tinymce.dom.DomQuery"),
    we = 0,
    _e = {
      id: function () {
        return "mceu_" + we++;
      ...
      getPos: function (e, t) {
        return v.DOM.getPos(e, t || _e.getContainer());
      },
      getContainer: function () {
        return de.container ? de.container : document.body;
      },
    ...
    Re = function (e) {
      return "static" === _e.getRuntimeStyle(e, "position");
    },
    Ce = function (e) {
  ...
  function Ee(e, t, n) {
    ...
    return (
      (d = ke()),
      (o = (r = _e.getPos(t, O.getUiContainer(e))).x),
      (s = r.y),
      Ce(e) && Re(document.body) && ((o -= d.x), (s -= d.y)),
      (i = e.getEl()),
      (a = (f = _e.getSize(i)).width),
      (l = f.height),
      (u = (f = _e.getSize(t)).width),
      (c = f.height),
      "b" === (n = (n || "").split(""))[0] && (s += c),
      "r" === n[1] && (o += u),
  ...
  var ke = function () {
    ...
    Se = {
      ...
      moveTo: function (e, t) {
        ...
        return (
          s && Re(s) && !Ce(n) && ((e -= s.scrollLeft), (t -= s.scrollTop)),
          s && ((e += 1), (t += 1)),
    ...
    Te = tinymce.util.Tools.resolve("tinymce.util.Class"),
    Me = tinymce.util.Tools.resolve("tinymce.util.EventDispatcher"),
    Ne = function (e) {
      var t;
      if (e)
  ...
  var Oe,
    ...
    Fe = Te.extend({
      init: function (e) {
        ...
        function a(e, t) {
          ...
          do {
            if (
              (ze.exec(""),
              (i = ze.exec(e)) && ((e = i[3]), o.push(i[1]), i[2]))
            ) {
              n = i[3];
              break;
            }
      ...
      find: function (e) {
        ...
        return Oe || (Oe = Fe.Collection), new Oe(u);
      },
    }),
  ...
  (Be = {
    ...
    slice: function () {
      return new Ae(Ve.apply(this, arguments));
    },
    eq: function (e) {
    ...
    reverse: function () {
      return new Ae(w.toArray(this).reverse());
    },
    hasClass: function (e) {
  ...
  var je,
    ...
    Ge = Te.extend({
      ...
      init: function (e) {
        var t, n;
        for (t in (e = e || {}))
          (n = e[t]) instanceof $e && (e[t] = n.create(this, t));
        this.data = e;
      },
      set: function (t, n) {
        var i,
          ...
          Ke[t._id] || (Ke[t._id] = t),
            je ||
              ...
              u.requestAnimationFrame(function () {
                var e, t;
                for (e in ((je = !1), Ke))
                  (t = Ke[e]).state.get("rendered") && t.reflow();
                Ke = {};
              }, document.body));
        }
      },
      remove: function (e) {
        Ke[e._id] && delete Ke[e._id];
      },
    },
    Qe = "onmousewheel" in document,
    et = !1,
    tt = 0,
    nt = {
      ...
      init: function (t) {
        ...
        (i.settings = t = w.extend({}, i.Defaults, t)),
          ...
          (i.data = new Ge(t.data)),
          (i.classes = new De(function () {
          ...
          (i.settings = t),
          (i.borderBox = Ne(t.border)),
          (i.paddingBox = Ne(t.padding)),
          (i.marginBox = Ne(t.margin)),
          t.hidden && i.hide();
      },
      Properties: "parent,name",
      getContainerElm: function () {
        var e = O.getUiContainer(this);
        return e || _e.getContainer();
      },
      ...
      initLayoutRect: function () {
        var e,
          ...
          d = c.settings,
          f = c.getEl();
        (e = c.borderBox = c.borderBox || Pe(f, "border")),
          (c.paddingBox = c.paddingBox || Pe(f, "padding")),
          (c.marginBox = c.marginBox || Pe(f, "margin")),
          (u = _e.getSize(f)),
          (a = d.minWidth),
          (l = d.minHeight),
          (r = a || u.width),
      ...
      parentsAndSelf: function (e) {
        return new Ye(this).add(this.parents(e));
      },
      next: function () {
      ...
      getEl: function (e) {
        ...
        return (
          this._elmCache[t] || (this._elmCache[t] = xe("#" + t)[0]),
          this._elmCache[t]
        );
      },
      show: function () {
      ...
      remove: function () {
        ...
        r &&
          ...
          r.items().set(t),
          (r._lastRect = null)),
          n._eventsRoot && n._eventsRoot === n && xe(i).off();
      ...
      renderBefore: function (e) {
        return xe(e).before(this.renderHtml()), this.postRender(), this;
      },
      renderTo: function (e) {
        return (
          xe(e || this.getContainerElm()).append(this.renderHtml()),
          this.postRender(),
          this
        );
      },
      ...
      postRender: function () {
        var e,
          ...
          o = this,
          s = o.settings;
        for (i in ((o.$el = xe(o.getEl())), o.state.set("rendered", !0), s))
  ...
  function rt(a) {
    ...
    function u(e) {
      ...
      if (r !== o) {
        if (
          ((n = (l._lastHoverCtrl = r).parents().toArray().reverse()).push(r),
          o)
        ) {
          for (
      ...
      for (r in (d || (d = l._delegates = {}), i)) {
        ...
        "wheel" !== r || et
          ? ("mouseenter" === r || "mouseleave" === r
              ? l._hasMouseEnter ||
                (xe(l.getEl()).on("mouseleave", s).on("mouseover", u),
                (l._hasMouseEnter = 1))
              : d[r] || (xe(l.getEl()).on(r, o), (d[r] = !0)),
            (i[r] = !1))
          : Qe
          ? xe(a.getEl()).on("mousewheel", c)
          : xe(a.getEl()).on("DOMMouseScroll", c);
      }
    }
  }
  ...
  var lt = {},
    ut = ot.extend({
      ...
      find: function (e) {
        return (e = lt[e] = lt[e] || new Fe(e)).find(this);
      },
      add: function (e) {
            ...
            e.parent(i),
              e.state.get("rendered") ||
                ...
                t <= n.childNodes.length - 1
                  ? xe(n.childNodes[t]).before(e.renderHtml())
                  : xe(n).append(e.renderHtml()),
                e.postRender(),
                Ze.add(e));
          }),
      ...
      postRender: function () {
        ...
        return (
          ...
          t.parent() || (t.keyboardNav = at({ root: t })),
          t
        );
      },
      initLayoutRect: function () {
      ...
      reflow: function () {
        var e;
        if ((Ze.remove(this), this.visible())) {
          for (
            ot.repaintControls = [],
    ...
    (t = function (e) {
      ...
      ct(e),
        ...
        (m = xe("<div></div>")
          ...
          .appendTo(x.body)),
        xe(x).on("mousemove touchmove", v).on("mouseup touchend", p),
        h.start(e);
    }),
      (v = function (e) {
        if ((ct(e), e.button !== g)) return p(e);
      ...
      (p = function (e) {
        ct(e),
          xe(x).off("mousemove touchmove", v).off("mouseup touchend", p),
          m.remove(),
          h.stop && h.stop(e);
      }),
      ...
      xe(w).on("mousedown touchstart", t);
  }
  var ft,
    ht,
    mt,
          ...
          function t(e, t, n, i, r, o) {
            ...
            if ((a = p.getEl("scroll" + e))) {
              if (
                ((f = t.toLowerCase()),
                (h = n.toLowerCase()),
                xe(p.getEl("absend")).css(f, p.layoutRect()[i] - 1),
                !r)
              )
                return void xe(a).css("display", "none");
              xe(a).css("display", "block"),
                (s = p.getEl("body")),
            ...
            (function () {
              function e(s, a, l, u, c) {
                ...
                xe(p.getEl()).append(
                  ...
                  (p.draghelper = new dt(e + "t", {
                    start: function () {
                      (d = p.getEl("body")["scroll" + a]),
                        xe("#" + e).addClass(t + "active");
                    },
                    drag: function (e) {
                      var t,
                        n,
  ...
  function _t() {
    ft ||
          ...
          (function (e) {
            for (var t = yt.length; t--; ) {
              ...
              if (n.settings.autohide) {
                if (i && (wt(i, n) || n.parent() === i)) continue;
                (e = n.fire("autohide", {
                  target: e.target,
      ...
      xe(document).on("click touchstart", ft));
  }
  function Rt(r) {
    var e = _e.getViewPort().y;
    function t(e, t) {
      for (var n, i = 0; i < yt.length; i++)
        if (yt[i] !== r)
          for (n = yt[i].parent(); n && (n = n.parent()); )
            n === r && yt[i].fixed(e).moveBy(0, t).repaint();
    }
    r.settings.autofix &&
      (r.state.get("fixed")
        ? r._autoFixY > e &&
  ...
  function Ct(e, t) {
    var n,
      ...
      r = Et.zIndex || 65535;
    if (e) xt.push(t);
    else for (n = xt.length; n--; ) xt[n] === t && xt.splice(n, 1);
    if (xt.length)
      for (n = 0; n < xt.length; n++)
        xt[n].modal && (r++, (i = xt[n])),
          (xt[n].getEl().style.zIndex = r),
          (xt[n].zIndex = r),
          r++;
    var o = xe("#" + t.classPrefix + "modal-block", t.getContainerElm())[0];
    i
      ? xe(o).css("z-index", i.zIndex - 1)
      : o && (o.parentNode.removeChild(o), (gt = !1)),
      (Et.currentZIndex = r);
  }
  var Et = vt.extend({
    Mixins: [Se, bt],
      ...
      i._super(e),
            ...
            if (!mt) {
              ...
              (mt = function () {
                (document.all && t === e.clientWidth && n === e.clientHeight) ||
                  ((t = e.clientWidth), (n = e.clientHeight), Et.hideAll());
              }),
                xe(window).on("resize", mt);
            }
          })(),
          yt.push(i)),
        e.autofix &&
          (ht ||
            ((ht = function () {
              var e;
              for (e = yt.length; e--; ) Rt(yt[e]);
            }),
            xe(window).on("scroll", ht)),
          i.on("move", function () {
            Rt(this);
          })),
        i.on("postrender show", function (e) {
          if (e.control === i) {
            ...
            i.modal &&
              !gt &&
              ((t = xe("#" + n + "modal-block", i.getContainerElm()))[0] ||
                (t = xe(
                  '<div id="' +
                    n +
                    'modal-block" class="' +
              ...
              u.setTimeout(function () {
                t.addClass(n + "in"), xe(i.getEl()).addClass(n + "in");
              }),
              (gt = !0)),
              Ct(!0, i);
          }
    ...
    show: function () {
      var e,
        t = this._super();
      for (e = yt.length; e-- && yt[e] !== this; );
      return -1 === e && yt.push(this), t;
    },
    hide: function () {
      return kt(this), Ct(!1, this), this._super();
    },
    hideAll: function () {
      Et.hideAll();
    },
  ...
  Et.hideAll = function () {
    for (var e = yt.length; e--; ) {
      var t = yt[e];
      t && t.settings.autohide && (t.hide(), yt.splice(e, 1));
    }
  };
  var Ht = function (s, n, e) {
    var a,
      i,
      l = v.DOM,
          ...
          : ((a = n.panel =
              b.create({
                ...
                items: [
                  !1 === d(s)
                    ? null
                    : { type: "menubar", border: "0 0 1 0", items: oe(s) },
                  L(s, f(s)),
                ],
              })),
    ...
    return (
      ...
      !1 === g(s) && e.skinUiCss
        ? l.styleSheetLoader.load(e.skinUiCss, pe(s))
        : pe(s)(),
      {}
    );
  };
  ...
  var Tt = function (e, t) {
    ...
    Mt = function (e, t, n) {
      ...
      return (
        ...
        Tt(e, t),
        e.getParam("inline", !1, "boolean") ? Ht(e, t, n) : ye(e, t, n)
      );
    },
    Nt = ot.extend({
      Mixins: [Se],
    ...
    Pt = ot.extend({
      ...
      tooltip: function () {
        return (
          this._tooltip ||
            ((this._tooltip = new Nt({ type: "tooltip" })),
    ...
    Ot = ot.extend({
      ...
      init: function (e) {
        ...
        t._super(e),
          ...
          e.progressBar && (t.progressBar = new Wt()),
      ...
      postRender: function () {
        ...
        return (
          u.setTimeout(function () {
            e.$el.addClass(e.classPrefix + "in"), Dt(e, e.state.get("text"));
          }, 100),
          e._super()
        );
      },
      bindStates: function () {
        ...
        return (
          t.state.on("change:text", function (e) {
            (t.getEl().firstChild.innerHTML = e.value), Dt(t, e.value);
          }),
          t.progressBar &&
            (t.progressBar.bindStates(),
            t.progressBar.state.on("change:value", function (e) {
              Dt(t, t.state.get("text"));
            })),
          t._super()
        );
      },
  ...
  function At(o) {
    ...
    return {
      open: function (e, t) {
        var n,
          i = w.extend(e, { maxWidth: ((n = s(o)), _e.getSize(n).width) }),
          r = new Ot(i);
        return (
          0 < (r.args = i).timeout &&
  ...
  function zt(e) {
    var t,
      n = xe("meta[name=viewport]")[0];
    !1 !== de.overrideViewPort &&
      (n ||
        ((n = document.createElement("meta")).setAttribute("name", "viewport"),
        document.getElementsByTagName("head")[0].appendChild(n)),
      (t = n.getAttribute("content")) && void 0 !== Lt && (Lt = t),
      n.setAttribute(
        "content",
        e
  ...
  function It(e, t) {
    (function () {
      for (var e = 0; e < Bt.length; e++) if (Bt[e]._fullscreen) return !0;
      return !1;
    })() &&
      !1 === t &&
      xe([document.documentElement, document.body]).removeClass(
        e + "fullscreen"
      );
  }
  var Ft = Et.extend({
    ...
    init: function (e) {
      ...
      n._super(e),
        ...
        n.on("click", function (e) {
          ...
          (_e.hasClass(e.target, t) || _e.hasClass(e.target.parentNode, t)) &&
            n.close();
        }),
      ...
      if (e !== i._fullscreen)
        if (
              ...
              if (n)
                i._timer ||
                  (i._timer = u.setTimeout(function () {
                    var e = _e.getWindowSize();
                    i.moveTo(0, 0).resizeTo(e.w, e.h), (i._timer = 0);
                  }, 50));
              else {
                e = new Date().getTime();
                var t = _e.getWindowSize();
          ...
          (i._initial = { x: t.x, y: t.y, w: t.w, h: t.h }),
            ...
            xe([r, document.body]).addClass(o + "fullscreen"),
            i.classes.add("fullscreen");
          var s = _e.getWindowSize();
          i.moveTo(0, 0).resizeTo(s.w, s.h);
        } else
          (i.borderBox = Ne(i.settings.border)),
            (i.getEl("head").style.display = ""),
            (t.deltaH += t.headerH),
            xe([r, document.body]).removeClass(o + "fullscreen"),
    ...
    postRender: function () {
      ...
      setTimeout(function () {
        ...
        n.focus(),
        (this.dragHelper = new dt(n._id + "-dragh", {
          start: function () {
  ...
  !(function () {
    if (!de.desktop) {
      ...
      u.setInterval(function () {
        ...
        (n.w === e && n.h === t) ||
          ((n = { w: e, h: t }), xe(window).trigger("resize"));
      }, 100);
    }
    xe(window).on("resize", function () {
      var e,
        t,
        n = _e.getWindowSize();
      for (e = 0; e < Bt.length; e++)
        (t = Bt[e].layoutRect()),
          Bt[e].moveTo(
            Bt[e].settings.x || Math.max(0, n.w / 2 - t.w / 2),
            Bt[e].settings.y || Math.max(0, n.h / 2 - t.h / 2)
          );
    });
  })();
  var Ut,
        ...
        msgBox: function (e) {
          ...
          switch (e.buttons) {
            ...
            case $t.YES_NO_CANCEL:
              (t = [n("Yes", 1, !0), n("No", 0)]),
                e.buttons === $t.YES_NO_CANCEL && t.push(n("Cancel", -1));
              break;
            default:
              t = [n("Ok", !0, !0)];
          }
    ...
    Gt = Jt.extend({
      ...
      postRender: function () {
        ...
        n._super(),
          ...
          xe(t).on("click", function (e) {
            e.stopPropagation();
          }),
          xe(n.getEl("button")).on("click", function (e) {
            e.stopPropagation(), t.click();
          }),
          n.getEl().appendChild(t);
      },
      remove: function () {
        xe(this.getEl("button")).off(),
          xe(this.getEl("input")).off(),
          this._super();
      },
    }),
    Kt = ut.extend({
    ...
    en = Pt.extend({
      ...
      repaint: function () {
        ...
        n.statusLevel() &&
          "none" !== n.statusLevel() &&
          (s =
            parseInt(_e.getRuntimeStyle(a, "padding-right"), 10) -
            parseInt(_e.getRuntimeStyle(a, "padding-left"), 10)),
          (e = r ? o.w - _e.getSize(r).width - 10 : o.w - 10);
        var l = document;
        return (
          l.all &&
            (!l.documentMode || l.documentMode <= 8) &&
            (t = n.layoutRect().h - 2 + "px"),
          xe(a).css({ width: e - s, lineHeight: t }),
          n._super(),
          n
        );
      },
      postRender: function () {
        var t = this;
        return (
          xe(this.getEl("inp")).on("change", function (e) {
        ...
        r.state.on("change:value", function (e) {
          ...
          r.state.on("change:statusLevel", function (e) {
            var t = r.getEl("status"),
              n = r.classPrefix,
              i = e.value;
            _e.css(t, "display", "none" === i ? "none" : ""),
              _e.toggleClass(t, n + "i-checkmark", "ok" === i),
              _e.toggleClass(t, n + "i-warning", "warn" === i),
              _e.toggleClass(t, n + "i-error", "error" === i),
              r.classes.toggle("has-status", "none" !== i),
              r.repaint();
          }),
          _e.on(r.getEl("status"), "mouseleave", function () {
            r.tooltip().hide();
          }),
          ...
          r.on("keydown", function (e) {
            ...
            "INPUT" === e.target.nodeName &&
              (t === Qt.DOWN
                ...
                : t === Qt.UP && (e.preventDefault(), n(-1, r.menu)));
          }),
          r._super()
        );
      },
      remove: function () {
        xe(this.getEl("inp")).off(),
        ...
        return (
          t.on("click", function (e) {
            (e.aria && "down" === e.aria.key) ||
              e.control !== t ||
              rn.getParent(e.target, "." + t.classPrefix + "open") ||
    ...
    sn = tinymce.util.Tools.resolve("tinymce.util.Color"),
    an = Pt.extend({
      ...
      postRender: function () {
        ...
        function c(e, t) {
          var n = (360 - e.h) / 360;
          _e.css(r, { top: 100 * n + "%" }),
            t || _e.css(s, { left: e.s + "%", top: 100 - e.v + "%" }),
            (o.style.background = sn({ s: 100, v: 100, h: e.h }).toHex()),
        ...
        (i = a.getEl("h")),
          ...
          a._super(),
          (a._svdraghelper = new dt(a._id + "-sv", { start: e, drag: e })),
          (a._hdraghelper = new dt(a._id + "-h", { start: t, drag: t })),
          a._repaint();
      },
      rgb: function () {
      ...
      color: function () {
        return this._color || (this._color = sn()), this._color;
      },
      renderHtml: function () {
        var e,
          t = this._id,
    ...
    ln = Pt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          n.height && _e.css(t, "height", n.height + "px"),
          n.width && _e.css(t, "width", n.width + "px"),
    ...
    pn = {
      ...
      fromPoint: function (e, t, n) {
        var i = e.dom();
        return W.from(i.elementFromPoint(t, n)).map(gn);
      },
    },
    vn =
      (Node.ATTRIBUTE_NODE,
    ...
    kn = {
      unknown: function () {
        return En({ current: undefined, version: _n.unknown() });
      },
      nu: En,
      edge: k("Edge"),
      chrome: k("Chrome"),
    ...
    Wn = {
      unknown: function () {
        return Pn({ current: undefined, version: _n.unknown() });
      },
      nu: Pn,
      windows: k(Hn),
      ios: k("iOS"),
    ...
    In = [
      ...
      },
      {
        ...
        search: function (e) {
          return Bn(e, "chrome") && !Bn(e, "chromeframe");
        },
      },
      {
        name: "IE",
      ...
      },
      {
        ...
        search: function (e) {
          return (Bn(e, "safari") || Bn(e, "mobile/")) && Bn(e, "applewebkit");
        },
      },
    ],
    Fn = [
    ...
    Vn = function (e) {
      var t,
        ...
        f = Un.browsers(),
        h = Un.oses(),
        m = On(f, e).fold(kn.unknown, kn.nu),
        g = An(h, e).fold(Wn.unknown, Wn.nu);
      return {
        browser: m,
        os: g,
        deviceType:
    ...
    Yn =
      ...
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return Yt || ((Yt = !0), (Vt = Ut.apply(null, e))), Vt;
      }),
    $n = bn,
    qn = vn,
    Xn = function (e) {
      return (
        (e.nodeType !== $n && e.nodeType !== qn) || 0 === e.childElementCount
      );
    },
    jn =
      (Yn().browser.isIE(),
    ...
    ei = function (e) {
      return e.id
        ...
        : ((t = "h"),
          (n = new Date().getTime()),
          t + "_" + Math.floor(1e9 * Math.random()) + ++mn + String(n));
      var t, n;
    },
    ti = function (e) {
      return (t = e) && "A" === t.nodeName && (t.id || t.name) && ii(e);
      var t;
    },
    ni = function (e) {
    ...
    oi = function (e) {
      ...
      return Zn(
        ...
        Qn(e),
        "#" + n,
        ni((t = e)) ? parseInt(t.nodeName.substr(1), 10) : 0,
        function () {
          e.id = n;
        }
      );
    ...
    ai = function (e) {
      ...
      return (
        ...
        J(
          ...
          (i = pn.fromDom(n)),
          (r = t),
          (s = (o = i) === undefined ? document : o.dom()),
          Xn(s) ? [] : J(s.querySelectorAll(r), pn.fromDom)),
          function (e) {
            return e.dom();
          }
        )
    ...
    ui = function (e) {
      var t,
        n = ai(e);
      return K(((t = n), J(K(t, ri), oi)).concat(J(K(n, ti), si)), li);
    },
    ci = {},
    di = function (e) {
      return {
      ...
      return !1 === t.typeahead_urls
        ...
        ? ((n = [
            ...
            pi(
              e,
              ((a = f("anchor")),
              (l = hi(t, "anchor_top", "#top")),
              (u = hi(t, "anchor_bottom", "#bottom")),
              null !== l && a.unshift(fi("<top>", l)),
              null !== u && a.push(fi("<bottom>", u)),
              a)
            ),
          ]),
          (o = function (e, t) {
      ...
      /^https?/.test(e) &&
        (o
          ? ((n = o),
            (i = e),
            (r = X(n, i)),
            -1 === r ? W.none() : W.some(r)).isNone() &&
            (ci[t] = o.slice(0, 5).concat(e))
          : (ci[t] = [e]));
    },
    pi = function (e, t) {
      var n = e.toLowerCase(),
        ...
        (e.spellcheck = !1),
          ...
          r.on("PostRender", function () {
            r.getRoot().on("submit", function (e) {
              e.isDefaultPrevented() || gi(r.value(), a);
            });
          }),
          vi(u, d, f);
      },
    ...
    _i = function (e, t) {
      return (
        (n = t),
        (r = (i = e) === undefined ? document : i.dom()),
        Xn(r) ? W.none() : W.from(r.querySelector(n)).map(pn.fromDom)
      );
      var n, i, r;
    },
    Ri = function (e, t) {
    ...
    ki = function (i) {
      var t = ["alignleft", "aligncenter", "alignright", "alignjustify"],
        r = "alignleft",
        e = [
          { text: "Left", icon: "alignleft", onclick: Ri(i, "alignleft") },
          {
            text: "Center",
            icon: "aligncenter",
            onclick: Ri(i, "aligncenter"),
          },
          { text: "Right", icon: "alignright", onclick: Ri(i, "alignright") },
          {
            text: "Justify",
            icon: "alignjustify",
            onclick: Ri(i, "alignjustify"),
          },
        ];
          ...
          l.on("init nodeChange", function (e) {
            var t,
              ...
              s =
                ...
                w.each(t, function (e) {
                  i ||
                    Hi(e.value).toLowerCase() !== Hi(r).toLowerCase() ||
                    (i = e.value);
                }),
                i);
            a.value(s || null), !s && o && a.text(Hi(o));
          });
      };
    },
    Ti = function (n) {
    ...
    Ai = function (n, e) {
      ...
      return (
        e.items().each(function (e) {
          e.menu && e.visible(0 < Ai(n, e.menu)),
            !e.menu && e.settings.menu && e.visible(0 < Oi(n, e.settings.menu));
        ...
        u =
          ...
          }),
          {
            ...
            itemDefaults: {
              ...
              onclick: function () {
                this.settings.format && Ri(i, this.settings.format)(),
    ...
    zi = function (e) {
      ...
      e.addMenuItem("blockformats", {
        ...
        e.addButton("formatselect", Li(e, i));
    },
    Ii = function (t, e) {
      var n, i;
    ...
    Ui = function (e) {
      var t = K(e, function (e, t, n) {
        return !Fi(e) || !Fi(n[t - 1]);
      });
      return K(t, function (e, t, n) {
        return !Fi(e) || (0 < t && t < n.length - 1);
      });
    },
    Vi = function (e) {
      var t,
    ...
    Yi = function (e) {
      ...
      (t = e).addButton("insert", {
        ...
        oncreatemenu: function () {
          this.menu.add(Vi(t)), this.menu.renderNew();
        },
      });
    },
    $i = function (e) {
    ...
    ji = function (e) {
      ...
      (t = e).addMenuItem("undo", {
        ...
        t.addMenuItem("redo", {
          ...
          icon: "redo",
          shortcut: "Meta+Y",
          onPostRender: Xi(t, "redo"),
          cmd: "redo",
        }),
        (n = e).addButton("undo", {
          tooltip: "Undo",
          onPostRender: Xi(n, "undo"),
          cmd: "undo",
        }),
        n.addButton("redo", {
          tooltip: "Redo",
          onPostRender: Xi(n, "redo"),
          cmd: "redo",
        });
    },
    Ji = function (e) {
      ...
      initLayoutRect: function () {
        ...
        return (
          e.settings.multiline &&
            (_e.getSize(e.getEl()).width > t.maxW &&
              ((t.minW = t.maxW), e.classes.add("multiline")),
            (e.getEl().style.width = t.minW + "px"),
            (t.startMinH =
              t.h =
              t.minH =
                Math.min(t.maxH, _e.getSize(e.getEl()).height))),
          t
        );
      },
      repaint: function () {
    ...
    ir = Jt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          t.aria("role", t.parent() instanceof nr ? "menuitem" : "button"),
          '<div id="' +
            n +
            '" class="' +
            t.classes +
        ...
        return (
          r.on("click", function (e) {
            e.control === r &&
              ...
              (r.focus(),
              r.showMenu(!e.aria),
              e.aria && r.menu.items().filter(":visible")[0].focus());
          }),
          r.on("mouseenter", function (e) {
            var t,
              n = e.control,
    ...
    rr = Et.extend({
      ...
      init: function (e) {
        ...
        this._super(e),
          ...
          e.animate && 11 !== de.ie && this.classes.add("animate");
      },
      repaint: function () {
        return (
      ...
      load: function () {
        ...
        n.settings.itemsFactory &&
          (n.throbber ||
            ((n.throbber = new St(n.getEl("body"), !0)),
            0 === n.items().length
    ...
    ar = Zt.extend({ Defaults: { classes: "radio", role: "radio" } }),
    lr = Pt.extend({
      renderHtml: function () {
        var e = this,
          t = e.classPrefix;
      ...
      postRender: function () {
        var t = this;
        t._super(),
          (t.resizeDragHelper = new dt(this._id, {
            start: function () {
              t.fire("ResizeStart");
            },
            drag: function (e) {
  ...
  function hr(e, t) {
    ...
    "v" === e.settings.orientation
      ...
      (s = e.getEl("handle")),
      (o =
        ((e.layoutRect()[n] || 100) - _e.getSize(s)[i]) *
          ((t - e._minValue) / (e._maxValue - e._minValue)) +
        "px"),
      (s.style[r] = o),
      (s.style.height = e.layoutRect().h + "px"),
      fr(s, "valuenow", t),
      fr(s, "valuetext", "" + e.settings.previewFilter(t)),
      fr(s, "valuemin", e._minValue),
      fr(s, "valuemax", e._maxValue);
  }
  var mr = Pt.extend({
      init: function (e) {
        var t = this;
        e.previewFilter ||
          ...
          (t._minValue = q(e.minValue) ? e.minValue : 0),
          (t._maxValue = q(e.maxValue) ? e.maxValue : 100),
      ...
      postRender: function () {
        ...
        (e = m._minValue),
          ...
          (a = t),
          (l = m.getEl("handle")),
          (m._dragHelper = new dt(m._id, {
            handle: m._id + "-handle",
            start: function (e) {
              (u = e[n]),
                (c = parseInt(m.getEl("handle").style[i], 10)),
                (d = (m.layoutRect()[o] || 100) - _e.getSize(l)[r]),
      ...
      repaint: function () {
        this._super(), hr(this, this.value());
      },
      bindStates: function () {
        var t = this;
        return (
    ...
    pr = ir.extend({
      ...
      repaint: function () {
        ...
        return (
          ...
          (e = n.firstChild),
          (t = n.lastChild),
          xe(e).css({ width: i.w - _e.getSize(t).width, height: i.h - 2 }),
          xe(t).css({ height: i.h - 2 }),
          this
        );
      },
      activeMenu: function (e) {
        xe(this.getEl().lastChild).toggleClass(this.classPrefix + "active", e);
      },
      renderHtml: function () {
        var e,
          t,
    ...
    br = vt.extend({
      ...
      activateTab: function (n) {
        ...
        this.activeTabId &&
          ...
          xe(e).removeClass(this.classPrefix + "active"),
          e.setAttribute("aria-selected", "false")),
          (this.activeTabId = "t" + n),
          (e = this.getEl("t" + n)).setAttribute("aria-selected", "true"),
          xe(e).addClass(this.classPrefix + "active"),
      ...
      initLayoutRect: function () {
        var e,
          ...
          n,
          i = this;
        (t = (t = _e.getSize(i.getEl("head")).width) < 0 ? 0 : t),
          (n = 0),
          i.items().each(function (e) {
        ...
        var r = _e.getSize(i.getEl("head")).height;
        return (
    ...
    yr = Pt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          ((e = _e.create(i.multiline ? "textarea" : "input", t)).value =
            n.state.get("value")),
  ...
  w.each(xr(), function (e, t) {
    ...
    wr(window.tinymce ? window.tinymce : {}),
    o.add("modern", function (e) {
      return Gi.setup(e), qt(e);
    });
})();
