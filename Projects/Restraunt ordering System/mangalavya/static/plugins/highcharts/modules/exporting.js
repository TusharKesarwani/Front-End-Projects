...
(function (g) {
  ...
  (function (f) {
    ...
    f.post = function (a, b, e) {
      var c = r(
        "form",
        p({ method: "post", action: a, enctype: "multipart/form-data" }, e),
        { display: "none" },
        y.body
      );
      E(b, function (a, b) {
    ...
    t(z.prototype, {
      ...
      getSVG: function (a) {
        ...
        c =
          h.exporting.sourceWidth ||
          h.chart.width ||
          (/px$/.test(c) && parseInt(c, 10)) ||
          600;
        m =
          h.exporting.sourceHeight ||
          h.chart.height ||
        ...
        a &&
          l(["xAxis", "yAxis", "series"], function (c) {
            var d = {};
        ...
        l(this.axes, function (a) {
          var c = f.find(b.axes, function (b) {
            ...
            d = d.userMax;
          c &&
            ((void 0 !== e && e !== c.min) || (void 0 !== d && d !== c.max)) &&
            c.setExtremes(e, d, !0, !1);
        });
        c = b.getChartHTML();
        B(this, "getSVG", { chartCopy: b });
      ...
      getSVGForExport: function (a, b) {
        ...
        return this.getSVG(
          p({ chart: { borderRadius: 0 } }, e.chartOptions, b, {
            exporting: {
      ...
      print: function () {
        ...
        if (!a.isPrinting) {
          ...
          if ((n = h && a.chartWidth > h))
            (d = [a.options.chart.width, void 0, !1]), a.setSize(h, void 0, !1);
          l(m, function (a, b) {
            1 === a.nodeType &&
      ...
      contextMenu: function (a, b, e, c, v, m, h) {
        ...
        k ||
          ...
          (x = r("div", { className: "highcharts-menu" }, null, k)),
          u(
            x,
            t(
              {
          ...
          (k.hideMenu = function () {
            ...
            h && h.setState(0);
            d.openMenu = !1;
            f.clearTimeout(k.hideTimer);
          }),
          d.exportEvents.push(
            q(k, "mouseleave", function () {
              k.hideTimer = setTimeout(k.hideMenu, 500);
            }),
            q(k, "mouseenter", function () {
              f.clearTimeout(k.hideTimer);
            }),
            q(y, "mouseup", function (b) {
              d.pointer.inClass(b.target, a) || k.hideMenu();
            }),
            q(k, "click", function () {
              d.openMenu && k.hideMenu();
            })
          ),
          l(b, function (a) {
            "string" === typeof a &&
          ...
          d.exportDivElements.push(x, k),
          (d.exportMenuWidth = k.offsetWidth),
          (d.exportMenuHeight = k.offsetHeight));
        b = { display: "block" };
        e + d.exportMenuWidth > g
          ? (b.right = g - e - v - w + "px")
          : (b.left = e - w + "px");
        c + m + d.exportMenuHeight > G && "top" !== h.alignOptions.verticalAlign
          ? (b.bottom = G - c - w + "px")
          : (b.top = c + m - w + "px");
        u(k, b);
        d.openMenu = !0;
      ...
      addButton: function (a) {
        ...
        if (!1 !== c.enabled) {
          ...
          c.text && c.symbol
            ? (g.paddingLeft = A(g.paddingLeft, 25))
            : c.text || t(g, { width: c.width, height: c.height, padding: 0 });
          d = e
            .button(c.text, 0, 0, k, g, q, l)
            .addClass(a.className)
            .attr({
              "stroke-linecap": "round",
              title: A(b.options.lang[c._titleKey || c.titleKey], ""),
            });
          d.menuClassName =
            a.menuClassName || "highcharts-menu-" + b.btnCount++;
          c.symbol &&
            ((h = e
              .symbol(c.symbol, c.symbolX - n / 2, c.symbolY - n / 2, n, n, {
                width: n,
                height: n,
              })
          ...
          d.add(b.exportingGroup).align(
            t(c, { width: d.width, x: A(c.x, b.buttonOffset) }),
            !0,
            "spacingBox"
          );
          b.buttonOffset +=
    ...
    q(z, "init", function () {
      var a = this;
      l(["exporting", "navigation"], function (b) {
        a[b] = {
          update: function (e, c) {
