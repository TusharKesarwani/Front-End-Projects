...
(function (S, K) {
  ...
  (function (a) {
    ...
    a.pad = function (a, f, e) {
      return (
        Array((f || 2) + 1 - String(a).replace("-", "").length).join(e || 0) + a
      );
    };
    ...
    a.numberFormat = function (n, f, e, u) {
      ...
      -1 === f
        ...
        ? f &&
          ...
          ((w = f + +c[1]),
          0 <= w
            ? ((c[0] = (+c[0]).toExponential(w).split("e")[0]), (f = w))
            : ((c[0] = c[0].split(".")[0] || 0),
              (n = 20 > f ? (c[0] * Math.pow(10, c[1])).toFixed(f) : 0),
              (c[1] = 0)))
        : (f = 2);
      y = (
  ...
  (function (a) {
    ...
    a.Color.prototype = {
      ...
      init: function (e) {
        ...
        if (
          (this.input = e =
            this.names[e && e.toLowerCase ? e.toLowerCase() : ""] || e) &&
          e.stops
        )
          ...
          (e &&
            ...
            7 === f
              ? (x = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1])
              : 4 === f &&
                (x = [
                  ((e & 3840) >> 4) | ((e & 3840) >> 8),
                  ((e & 240) >> 4) | (e & 240),
  ...
  (function (a) {
    ...
    k(C.prototype, {
          ...
          function () {
            ...
            m &&
              ...
              c[O]
                ? (l = c[O].attr("id"))
                : ((d.id = l = a.uniqueKey()),
                  (c[O] = h = b.createElement(m).attr(d).add(b.defs)),
                  (h.radAttr = H),
                  (h.stops = []),
                  p(q, function (z) {
                    0 === z[1].indexOf("rgba")
      ...
      applyTextOutline: function (z) {
        ...
        -1 !== z.indexOf("contrast") &&
          (z = z.replace(/contrast/g, this.renderer.getContrast(g.style.fill)));
        z = z.split(" ");
        b = z[z.length - 1];
        if ((d = z[0]) && "none" !== d && a.svg) {
          ...
          for (k = z.length; k--; )
            (r = z[k]),
              "highcharts-text-outline" === r.getAttribute("class") &&
                q(z, g.removeChild(r));
          m = g.firstChild;
          p(z, function (a, z) {
            0 === z &&
      ...
      attr: function (a, g, r, b) {
        ...
        "string" === typeof a &&
          ...
          ((z = a), (a = {}), (a[z] = g));
        "string" === typeof a
          ? (k = (this[a + "Getter"] || this._defaultGetter).call(this, a, d))
          : (N(
              a,
              function (z, g) {
                c = !1;
                ...
                this.symbolName &&
                  ...
                  (m || (this.symbolAttr(a), (m = !0)), (c = !0));
                !this.rotation ||
                  ("x" !== g && "y" !== g) ||
                  (this.doTransform = !0);
                c ||
                  ((H = this[g + "Setter"] || this._defaultSetter),
                  H.call(this, z, g, d),
                  this.shadows &&
          ...
          : m &&
            a.push(
              "rotate(" +
                ...
                " " +
                E(this.rotationOriginY, c.getAttribute("y") || 0) +
                ")"
            );
      ...
      align: function (a, g, r) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = g), !r || D(r))
          )
      ...
      getBBox: function (a, g) {
        ...
        w(H) &&
          ...
          (l += ["", g || 0, c, this.textWidth, m && m.textOverflow].join()));
        l && !a && (z = q[l]);
        if (!z) {
          if (v || r.forExport) {
            try {
              (h =
                ...
                function (a) {
                  p(
                    b.querySelectorAll(".highcharts-text-outline"),
                    function (g) {
                      g.style.display = a;
                    }
                  );
          ...
          r.isSVG &&
            ...
            g &&
              ((z.width =
                Math.abs(r * Math.sin(d)) + Math.abs(a * Math.cos(d))),
              (z.height =
                Math.abs(r * Math.cos(d)) + Math.abs(a * Math.sin(d)))));
          if (l && 0 < z.height) {
      ...
      destroy: function () {
        ...
        b &&
          d &&
          (p(d.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
        ...
        a.safeRemoveChild(g);
        for (a.destroyShadows(); r && r.div && 0 === r.div.childNodes.length; )
        ...
        if (!a) this.destroyShadows();
          ...
          for (d = 1; d <= c; d++)
            (b = m.cloneNode(0)),
              ...
              r &&
                (f(b, "height", Math.max(f(b, "height") - k, 0)),
                (b.cutHeight = k)),
              g
                ? g.element.appendChild(b)
                : m.parentNode && m.parentNode.insertBefore(b, m),
              z.push(b);
          this.shadows = z;
        }
        return this;
    ...
    C.prototype.translateXSetter =
      ...
      C.prototype.rotationOriginXSetter =
      C.prototype.rotationOriginYSetter =
      C.prototype.scaleXSetter =
      C.prototype.scaleYSetter =
      C.prototype.matrixSetter =
        function (a, g) {
          this[g] = a;
          this.doTransform = !0;
        };
    ...
    k(F.prototype, {
          ...
          O = function (m, c) {
            ...
            if (void 0 === p[c])
              if (g.getSubStringLength)
                ...
                z.getSpanWidth &&
                  (l(k(r || d, m)), (p[c] = b + z.getSpanWidth(a, g)));
            return p[c];
          },
          G,
          M;
      ...
      buildText: function (a) {
        var r = a.element,
          ...
          w = function (a) {
            ...
            return M
              ? g(M)
              : b.fontMetrics(d, a.getAttribute("style") ? a : r).h;
          },
          Q = function (a, g) {
            N(b.escapes, function (r, d) {
              (g && -1 !== v(r, g)) ||
                (a = a.toString().replace(new RegExp(r, "g"), d));
            });
            return a;
          },
          u = function (a, g) {
            ...
            if (
              ...
              return (a = a.substring(r + 1)), a.substring(0, a.indexOf(g));
          };
        ...
        if (t !== a.textCache) {
          ...
          z || e || B || G || -1 !== c.indexOf(" ")
            ? (l && l.appendChild(r),
              ...
              p(c, function (g, d) {
                ...
                p(c, function (g) {
                  if ("" !== g || 1 === c.length) {
                    ...
                    (M = u(g, "href")) &&
                      !m &&
                      (f(l, "onclick", 'location.href\x3d"' + M + '"'),
              ...
              B && q && a.attr("title", Q(a.textStr, ["\x26lt;", "\x26gt;"])),
              l && l.removeChild(r),
      ...
      rect: function (a, g, r, d, b, c) {
        ...
        a = B(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: g, width: Math.max(r, 0), height: Math.max(d, 0) };
      ...
      image: function (a, g, r, d, b, c) {
        ...
        1 < arguments.length && k(m, { x: g, y: r, width: d, height: b });
      ...
      symbol: function (a, g, r, d, b, c) {
        var m = this,
          ...
          l =
            w(g) &&
            z &&
            z.call(this.symbols, Math.round(g), Math.round(r), d, b, c),
          G,
          M;
        z
          ? ((H = this.path(l)),
      ...
      symbols: {
        ...
        arc: function (a, g, r, d, b) {
          var c = b.start,
            ...
            k = b.end - 0.001;
          r = b.innerR;
          d = E(b.open, 0.001 > Math.abs(b.end - b.start - 2 * Math.PI));
          var h = Math.cos(c),
            q = Math.sin(c),
            A = Math.cos(k),
            k = Math.sin(k);
        ...
        callout: function (a, g, r, d, b) {
          ...
          H && H > r
            ...
            : H && 0 > H
            ? b > g + m && b < g + d - m
              ? k.splice(33, 3, "L", a, b + 6, a - 6, b, a, b - 6, a, g + c)
              : k.splice(33, 3, "L", a, d / 2, H, b, a, d / 2, a, g + c)
            : b && b > d && H > a + m && H < a + r - m
            ? k.splice(
                23,
                3,
            ...
            : b &&
              ...
              H > a + m &&
              H < a + r - m &&
              k.splice(3, 3, "L", H - 6, g, H, g - 6, H + 6, g, r - c, g);
          return k;
        },
      },
      ...
      fontMetrics: function (a, r) {
        ...
        a = /px/.test(a)
          ? g(a)
          : /em/.test(a)
          ? parseFloat(a) * (r ? this.fontMetrics(null, r.parentNode).f : 16)
          : 12;
      ...
      label: function (g, d, b, c, m, H, h, q, A) {
        ...
        l.xSetter = function (a) {
          l.x = a;
          e &&
            ((a -= e * ((f || z.width) + 2 * B)), (l["forceAnimate:x"] = !0));
          t = Math.round(a);
          l.attr("translateX", t);
        };
        ...
        if (this.added) {
          ...
          if ("SPAN" === c.tagName) {
            ...
            G !== this.cTT &&
              ...
              !n(B) ||
                (B === (this.oldRotation || 0) && l === this.oldAlign) ||
  ...
  (function (a) {
    ...
    a.Time.prototype = {
      ...
      update: function (a) {
        ...
        (this.variableTimezone = !(e && !a.getTimezoneOffset && !a.timezone)) ||
        this.timezoneOffset
          ? ((this.get = function (a, c) {
            ...
            (this.set = function (a, c, h) {
              ...
              if (
                "Milliseconds" === a ||
                "Seconds" === a ||
                ("Minutes" === a && 0 === c.getTimezoneOffset() % 60)
              )
                c["set" + a](h);
              else
      ...
      getTimeTicks: function (a, t, w, y) {
        ...
        if (C(t)) {
          c.set(
            "Milliseconds",
            p,
            d >= e.second ? 0 : b * Math.floor(c.get("Milliseconds", p) / b)
          );
          d >= e.second &&
            c.set(
              "Seconds",
              p,
              d >= e.minute ? 0 : b * Math.floor(c.get("Seconds", p) / b)
            );
          d >= e.minute &&
            c.set(
              "Minutes",
              p,
              d >= e.hour ? 0 : b * Math.floor(c.get("Minutes", p) / b)
            );
          d >= e.hour &&
            c.set(
              "Hours",
              p,
              d >= e.day ? 0 : b * Math.floor(c.get("Hours", p) / b)
            );
          d >= e.day &&
            c.set(
              "Date",
          ...
          d >= e.month &&
            (c.set(
              "Month",
              p,
              d >= e.year ? 0 : b * Math.floor(c.get("Month", p) / b)
            ),
            (q = c.get("FullYear", p)));
          d >= e.year && c.set("FullYear", p, q - (q % b));
          d === e.week &&
            ((q = c.get("Day", p)),
            c.set("Date", p, c.get("Date", p) - q + y + (q < y ? -7 : 0)));
          q = c.get("FullYear", p);
          y = c.get("Month", p);
          var J = c.get("Date", p),
            l = c.get("Hours", p);
              ...
              (t =
                d === e.year
                  ...
                  ? v && d === e.hour && 1 < b
                    ...
                    : t + d * b
                  : c.makeTime(q, y, J + p * b * (d === e.day ? 1 : 7))),
              p++;
          h.push(t);
          d <= e.hour &&
            1e4 > h.length &&
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        w.isDatetimeAxis &&
          ...
          ((n = c.time.resolveDTLFormat(
            y.dateTimeLabelFormats[(!y.grid && d.higherRanks[k]) || d.unitName]
          )),
          (l = n.main));
        f.isFirst = b;
        f.isLast = v;
              ...
              if (
                (J.attr({
                  text: w.labelFormatter.call(
                    a.extend(f.formatCtx, { dateTimeLabelFormat: D[B] })
                  ),
                }),
                J.getBBox().width < w.getSlotWidth(f) - 2 * u(q.padding, 5))
              )
                return;
            J.attr({ text: "" });
          };
      ...
      getPosition: function (e, f, y, c) {
        ...
        e = {
          x: e
            ? a.correctFloat(h.translate(f + y, null, null, c) + h.transB)
            : h.left +
              h.offset +
              (h.opposite
                ? ((c && p.oldChartWidth) || p.chartWidth) - h.right - h.left
                : 0),
          y: e
            ? k - h.bottom + h.offset - (h.opposite ? h.height : 0)
            : a.correctFloat(k - h.translate(f + y, null, null, c) - h.transB),
        };
        ...
        F(t) ||
          (t =
            0 === d.side
              ...
              : 2 === d.side
              ? l.y + 8
              : Math.cos(f.rotation * x) * (l.y - f.getBBox(!1, 0).height / 2));
        ...
        p ||
          ...
          (this.gridLine = p =
            v
              ...
              .add(c.gridGroup)));
        if (p && (f = c.getPlotLinePath(q + b, p.strokeWidth() * f, a, "pass")))
          p[a || this.isNew ? "attr" : "animate"]({ d: f, opacity: e });
      },
  ...
  var W = (function (a) {
    ...
    a.extend(E.prototype, {
      ...
      init: function (a, r) {
        ...
        b.side =
          r.side || (b.horiz ? (b.opposite ? 0 : 2) : b.opposite ? 1 : 3);
        b.setOptions(r);
        var c = this.options,
          m = c.type;
                ...
                (b = g.xData),
                  b.length &&
                    ...
                    v(g) ||
                      ...
                      ((b = q(b, v)), (g = n(b)), (c = I(b))),
                    b.length &&
                      ((a.dataMin = Math.min(D(a.dataMin, b[0], g), g)),
                      (a.dataMax = Math.max(D(a.dataMax, b[0], c), c))));
              else if (
                (g.getExtremes(),
                (c = g.dataMax),
                (g = g.dataMin),
      ...
      toPixels: function (a, r) {
        return (
          this.translate(a, !1, !this.horiz, null, !0) + (r ? 0 : this.pos)
        );
      },
        ...
        if (l && l / d < a.len / 3)
          if (a.isLog)
            y(this.paddedTicks, function (g, r, b) {
              r &&
                c.push.apply(c, a.getLogTickPositions(d, b[r - 1], b[r], !0));
            });
      ...
      adjustForMinRange: function () {
        ...
        this.isXAxis &&
          ...
          (x(a.min) || x(a.max)
            ...
            : (y(this.series, function (a) {
                h = a.xData;
                for (k = q = a.xIncrement ? 1 : h.length - 1; 0 < k; k--)
        ...
        b - r < this.minRange &&
          ...
          (d = (v - b + r) / 2),
          (d = [r - d, D(a.min, r - d)]),
          c && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (r = I(d)),
          (b = [r + v, D(a.max, r + v)]),
          c && (b[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (b = n(b)),
          b - r < v && ((d[0] = b - v), (d[1] = D(a.min, b - v)), (r = I(d))));
        this.min = r;
        this.max = b;
      },
      getClosest: function () {
        ...
        0 < r.length &&
          ...
          y(this.series || [], function (a) {
            ...
            y(a.points, function (r, b) {
              ...
              r.options &&
                ((d = g.nameToX(r)),
                void 0 !== d && d !== r.x && ((r.x = d), (a.xData[b] = d)));
            });
          }));
      },
      setAxisTranslation: function (a) {
        ...
        if (A || q || d)
          (c = g.getClosest()),
            l
              ? ((m = l.minPointOffset), (k = l.pointRangePadding))
      ...
      setTickInterval: function (g) {
        ...
        b.range &&
          x(b.max) &&
          ((b.userMin = b.min = u = Math.max(b.dataMin, b.minFromRange())),
          (b.userMax = n = b.max),
          (b.range = null));
        h(b, "foundExtremes");
        ...
        !(J || b.axisPointRange || b.usePercentage || A) &&
          ...
          x(b.max) &&
          (d = b.max - b.min) &&
          (!x(u) && f && (b.min -= d * f), !x(n) && p && (b.max += d * p));
        ...
        b.tickInterval =
          b.min === b.max || void 0 === b.min || void 0 === b.max
            ? 1
            : A && !G && B === b.linkedParent.options.tickPixelInterval
      ...
      setTickPositions: function () {
        ...
        this.single =
          ...
          x(this.min) &&
          !this.tickAmount &&
          (parseInt(this.min, 10) === this.min || !1 !== g.allowDecimals);
        ...
        !b &&
          ...
          (this.max - this.min) / this.tickInterval >
            ...
            : (b = this.isDatetimeAxis
                ? this.getTimeTicks(
                    this.normalizeTimeTickInterval(this.tickInterval, g.units),
                    this.min,
                    this.max,
                    g.startOfWeek,
                    this.ordinalPositions,
      ...
      setAxisSize: function () {
        var b = this.chart,
          ...
          k = (this.width = Math.round(
            a.relativeLength(D(d.width, b.plotWidth - c[3] + c[1]), b.plotWidth)
          )),
      ...
      unsquish: function () {
        var a = this.options.labels,
          ...
          c = d,
          m =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d),
          k,
          l = a.rotation,
          h = this.labelMetrics(),
          q,
        ...
        b
          ? (A =
              ...
              (x(l)
                ? [l]
                : m < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
            y(A, function (a) {
              var b;
              if (a === l || (a && -90 <= a && 90 >= a))
          ...
          for (f = "clip", q = d.length; !l && q--; )
            if (((B = d[q]), (B = c[B].label)))
              B.styles && "ellipsis" === B.styles.textOverflow
                ...
                : B.textPxLength > h && B.css({ width: h + "px" }),
                B.getBBox().height > this.len / d.length - (A.h - A.f) &&
                  (B.specificTextOverflow = "ellipsis");
        v.rotation &&
          ((p = G > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : G),
          e || (f = "ellipsis"));
        if (
          (this.labelAlign = m.align || this.autoLabelAlign(this.labelRotation))
        )
            ...
            b &&
              ...
              a.shortenLabel
                ...
                : p &&
                  !g &&
                  "nowrap" !== k.whiteSpace &&
                  (p < b.textPxLength || "SPAN" === b.element.tagName)
                ? ((d.width = p),
                  e || (d.textOverflow = b.specificTextOverflow || f),
                  b.css(d))
                : b.styles &&
                  b.styles.width &&
                  !d.width &&
      ...
      addTitle: function (a) {
        ...
        this.axisTitle ||
          ...
          (this.axisTitle = b
            ...
            .attr({ zIndex: 7, rotation: c.rotation || 0, align: m })
      ...
      getOffset: function () {
        ...
        J &&
          ...
          e &&
            !1 !== J.reserveSpace &&
            ((a.titleOffset = p =
              a.axisTitle.getBBox()[l ? "height" : "width"]),
            (G = J.offset),
        ...
        if (b.hasData() || k)
          b.minorTickInterval &&
            ...
            l.length &&
              ...
              E &&
                (0 === b.min || b.single) &&
                (e[-1] || (e[-1] = new N(b, -1, null, !0)), e[-1].render(-1))),
            J &&
              y(l, function (c, g) {
            ...
            b._addedPlotLB ||
              (y((c.plotLines || []).concat(c.plotBands || []), function (a) {
          ...
          k ||
            ...
            k
              .attr({
                stroke:
                  c.color ||
                  (g ? f("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
  ...
  (function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      ...
      renderLabel: function (a, e, c, h) {
        ...
        p ||
          ...
          (p.zIndex = h),
          (this.label = p = k.text(a.text, 0, 0, a.useHTML).attr(p).add()),
          p.css(a.style));
        h = e.xBounds || [e[1], e[4], c ? e[6] : e[1]];
        e = e.yBounds || [e[2], e[5], c ? e[7] : e[2]];
        c = I(h);
        k = I(e);
        p.align(a, !1, { x: c, y: k, width: F(h) - c, height: F(e) - k });
        p.show();
      },
      destroy: function () {
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function (a, e) {
        ...
        if (h && c)
          for (
            a && ((d = h.toString() === c.toString()), (q = 0)), a = 0;
            a < h.length;
            a += 6
          )
            k && c[a + 1] === h[a + 1]
    ...
    a.Tooltip.prototype = {
      ...
      getPosition: function (a, h, e) {
        var c = this.chart,
          ...
          N = function (a, b, c, g) {
            ...
            g < q || g > b - q
              ? (m = !1)
              : (d[a] = g < c / 2 ? 1 : g > b - c / 2 ? b - c - 2 : g - c / 2);
            return m;
          },
          E = function (a) {
            var b = D;
          ...
          !1 === v
            ...
            : ((e = this.getLabel()),
              ...
              this.split
                ...
                : (k.style.width ||
                    e.css({ width: this.chart.spacingBox.width }),
                  e.attr({ text: v && v.join ? v.join("") : v }),
                  e
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass(
                      "highcharts-color-" + x(d.colorIndex, l.colorIndex)
                    ),
                  e.attr({
        ...
        F(c.slice(0, h.length + 1), function (a, c) {
          if (!1 !== a) {
            ...
            A ||
              (m.tt = A =
                d
                  .label(null, null, null, "callout", null, null, v.useHTML)
                  .addClass(
                    "highcharts-tooltip-box " +
                      E +
                      (c.isHeader ? " highcharts-tooltip-header" : "")
                  )
                  .attr({
                    padding: v.padding,
                    r: v.borderRadius,
              ...
              ? ((f = a.height),
                ...
                (p = Math.max(
                  ...
                  Math.min(
                    ...
                    q.chartWidth +
                      (q.scrollablePixels
                        ? q.scrollablePixels - q.marginRight
                        : 0) -
                      p
                  )
                )))
              : (p = c.plotX + q.plotLeft - x(v.distance, 16) - p);
            0 > p && (b = !1);
            a =
      ...
      getDateFormat: function (a, h, e, k) {
        ...
        for (v in y) {
          ...
          if (f[v] && d.substr(f[v]) !== "01-01 00:00:00.000".substr(f[v]))
            break;
          "week" !== v && (l = v);
        }
      ...
      getXDateFormat: function (a, h, e) {
        ...
        return (
          (c ? this.getDateFormat(c, a.x, e.options.startOfWeek, h) : h.day) ||
          h.year
        );
      },
      tooltipFooterHeaderFormatter: function (a, h) {
        ...
        b &&
          e &&
          F((a.point && a.point.tooltipDateKeys) || ["key"], function (a) {
      ...
      bodyFormatter: function (a) {
        return e(a, function (a) {
          ...
          ).call(a.point, c[(a.point.formatPrefix || "point") + "Format"]);
        });
      },
    };
  })(K);
  (function (a) {
    ...
    a.Pointer.prototype = {
      ...
      getChartCoordinatesFromPoint: function (a, b) {
        ...
        if (d && c)
          return b
            ? { chartX: d.len + d.pos - k, chartY: c.len + c.pos - a.plotY }
        ...
        (E && E.touch) ||
          ...
          10 < this.hasDragged &&
            ...
            E &&
              e &&
              ((d -= g),
              E.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + g })),
            E &&
              h &&
              ((d = k - r),
              E.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + r })),
        ...
        b.cancelClick ||
          (c && this.inClass(a.target, "highcharts-tracker")
            ...
            : (x(a, this.getCoordinates(a)),
              b.isInsidePlot(a.chartX - d, a.chartY - k) && w(b, "click", a)));
      },
      setDOMEvents: function () {
        ...
        a.unbindDocumentMouseUp ||
          (a.unbindDocumentMouseUp = C(k, "mouseup", c.onDocumentMouseUp));
        a.hasTouch &&
  ...
  (function (a) {
    ...
    I(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, e, f, n, y, c, h, p) {
        ...
        r
          ? ((N -= 0.8 * (N - h[q][0])), G || (g -= 0.8 * (g - h[q][1])), f())
          : (h[q] = [N, g]);
        D || ((c[q] = u - t), (c[v] = l));
        c = D ? 1 / B : B;
        y[v] = l;
      ...
      pinch: function (a) {
        var u = this,
          ...
          d =
            1 === c &&
            ((u.inClass(a.target, "highcharts-tracker") && t.runTrackerClick) ||
              u.runChartClick),
          b = {};
        1 < c && (u.initiated = !0);
        ...
        "touchstart" === a.type
          ...
          : w.length &&
            (k ||
              (u.selectionMarker = k = I({ destroy: f, touch: !0 }, t.plotBox)),
      ...
      touch: function (f, n) {
        ...
        1 === f.touches.length
          ? ((f = this.normalize(f)),
            (y = t.isInsidePlot(f.chartX - t.plotLeft, f.chartY - t.plotTop)) &&
            !t.openMenu
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
          ...
          f(
            ...
            function (e) {
              var h = e.checkbox,
                k;
              h &&
                ((k = c + b + h.y + (this.scrollOffset || 0) + 3),
                F(h, {
                  left: a.translateX + e.checkboxOffset + h.x - 20 + "px",
                  top: k + "px",
                  display:
                    this.proximate || (k > c - 6 && k < c + d - 6)
                      ? ""
                      : "none",
                }));
            },
      ...
      renderItem: function (a) {
        ...
        l.width ||
          m.css({ width: (b.itemWidth || b.width || c.spacingBox.width) - f });
        this.setText(a);
        c = m.getBBox();
          ...
          f(
            ...
            function (e, l) {
              e.test(h) &&
                ...
                (d[x[l]] = Math.max(
                  d[x[l]],
                  d.legend[(l + 1) % 2 ? "legendHeight" : "legendWidth"] +
                    [1, -1, -1, 1][l] * b[l % 2 ? "x" : "y"] +
                    w(b.margin, 12) +
                    c[l] +
                    (0 === l && void 0 !== d.options.title.margin
                      ? d.titleOffset + d.options.title.margin
                      : 0)
                ));
            }
          );
      ...
      render: function () {
        ...
        d ||
          ((this.group = d = h.g("legend").attr({ zIndex: 7 }).add()),
          (this.contentGroup = h.g().attr({ zIndex: 1 }).add(d)),
        ...
        e &&
          ...
          /(lth|ct|rth)/.test(this.getAlignment()) &&
            (h = t(h, { y: h.y + a.titleOffset + a.options.title.margin })),
          d.align(
            t(n, {
              width: b,
              height: p,
      ...
      handleOverflow: function (a) {
        ...
        t.length = 0;
        a > d && !1 !== n.enabled
          ? ((this.clipHeight = k = Math.max(d - 20 - this.titleHeight - l, 0)),
            ...
            r(k),
            A ||
              ((this.nav = A = b.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = b
      ...
      scroll: function (a, c) {
        ...
        0 < a &&
          ...
          this.up
            .attr({ fill: 1 === a ? e.inactiveColor : e.activeColor })
            .css({ cursor: 1 === a ? "default" : "pointer" }),
          this.down
            .attr({ fill: a === b ? e.inactiveColor : e.activeColor })
    ...
    p(O.prototype, {
      ...
      init: function (b, c) {
        ...
        q(this, "init", { args: arguments }, function () {
          ...
          this.series = [];
          this.time =
            b.time && a.keys(b.time).length ? new a.Time(b.time) : a.time;
        ...
        h(d, function (a) {
          a.isDirty &&
            ("point" === a.options.legendType
              ...
              : e && (e.labelFormatter || e.labelFormat) && (l = !0));
        ...
        h(
          ...
          function (a) {
            ...
            c &&
              ...
              c
                .css({ width: (m.width || g.width + m.widthAdjust) + "px" })
                .align(p({ y: a + h }, m), !1, "spacingBox"),
              m.floating ||
                m.verticalAlign ||
                (b = Math.ceil(b + c.getBBox(m.useHTML).height)));
          },
          this
        );
      ...
      drawChartBox: function () {
        ...
        h[u](h.crisp({ x: p, y: G, width: v, height: E }, -h.strokeWidth()));
        this.isDirtyBox = !1;
      ...
      renderLabels: function () {
        ...
        b.items &&
          h(b.items, function (c) {
            ...
            delete g.left;
            delete g.top;
            a.renderer.text(c.html, d, m).attr({ zIndex: 2 }).css(g).add();
          });
      },
      render: function () {
        var a = this.axes,
  ...
  (function (a) {
    ...
    C(F, "afterSetChartSize", function (n) {
      ...
      (f = f && f.minWidth) &&
        ...
        (this.scrollablePixels = f = Math.max(0, f - this.chartWidth)) &&
        ((this.plotWidth += f),
      ...
      optionsToObject: function (c) {
        ...
        if (x(c) || null === c) e[d[0]] = c;
          ...
          for (
            ...
            c.length > b &&
            ((h = typeof c[0]),
            "string" === h ? (e.name = c[0]) : "number" === h && (e.x = c[0]),
            v++);
            n < b;
            ...
            (f && void 0 === c[v]) ||
              (0 < d[n].indexOf(".")
                ? a.Point.prototype.setNestedProperty(e, c[v], d[n])
                : (e[d[n]] = c[v])),
              v++,
              n++;
        else
      ...
      },
      {
          ...
          t(b.axisTypes || [], function (m) {
            t(d[m], function (a) {
              ...
              if (
                ...
                b.insert(a.series), (b[m] = a), (a.isDirty = !0);
            });
          ...
          if (!N) {
            ...
            if (B && f > B) {
              ...
              for (d = 0; d < f; d++)
                void 0 !== b[d] &&
                  ((G = { series: m }),
                  m.pointClass.prototype.applyOptions.apply(G, [b[d]]),
        ...
        processData: function (b) {
          ...
          var p = this.getExtremesFromAll || k.getExtremesFromAll,
            ...
            B,
            t;
          if (q && !this.isDirty && !f.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          ...
          q &&
            ...
            (c[e - 1] < B || c[0] > t
              ...
              : this.yData &&
                (c[0] < B || c[e - 1] > t) &&
                ((m = this.cropData(this.xData, this.yData, B, t)),
                (c = m.xData),
                (d = m.yData),
                (m = m.start),
                (g = !0)));
        ...
        generatePoints: function () {
          ...
          for (B = 0; B < f; B++)
            (p = k + B),
              q
                ? ((v = new h().init(this, [e[B]].concat(l(g[B])))),
          ...
          if (c && (f !== (d = c.length) || q))
            for (B = 0; B < d; B++)
              B !== k || q || (B += f),
                c[B] && (c[B].destroyElements(), (c[B].plotX = void 0));
          this.data = c;
          this.points = n;
        },
        ...
        translate: function () {
          ...
          for (a = 0; a < l; a++) {
            ...
            var I =
                b &&
                h.stacks[
                  (this.negStacks && F < (t ? 0 : n) ? "-" : "") + this.stackKey
                ],
              K;
            ...
            L.plotX = u = f(
              Math.min(
                Math.max(
                  -1e5,
                  d.translate(C, 0, 0, 0, 1, q, "flags" === this.type)
                ),
                1e5
              )
            );
            b &&
              ...
              (D = F[0]),
              (F = F[1]),
              D === t && w.key === I[C].base && (D = v(k(n) && n, h.min)),
            ...
            L.yBottom = x(D)
              ? Math.min(Math.max(-1e5, h.translate(D, 0, 1, 0, 1)), 1e5)
              : null;
            p && (F = this.modifyValue(F, L));
            L.plotY = D =
              "number" === typeof F && Infinity !== F
                ? Math.min(Math.max(-1e5, h.translate(F, 0, 1, 0, 1)), 1e5)
                : void 0;
            L.isInside =
              void 0 !== D && 0 <= D && D <= h.len && 0 <= u && u <= d.len;
            L.clientX = B ? f(d.translate(C, 0, 0, 0, 1, q)) : u;
            L.negative = L.y < (n || 0);
            L.category = e && void 0 !== e[L.x] ? e[L.x] : L.x;
            L.isNull ||
              (void 0 !== y && (J = Math.min(J, Math.abs(u - y))), (y = u));
              ...
              (d = a[c]),
                ...
                e && !d.isNull
                  ? ((e = v(f.symbol, this.symbol)),
                    (q = this.markerAttribs(d, d.selected && "select")),
                    g
                      ? g[k ? "show" : "hide"](!0).animate(q)
                      : k &&
                        (0 < q.width || d.hasImage) &&
                        (d.graphic = g =
                          b.renderer
                            .symbol(e, q.x, q.y, q.width, q.height, l ? f : h)
                            .add(p)),
        ...
        applyZones: function () {
          ...
          d.length &&
            ...
            t(d, function (d, m) {
              ...
              g = Math.min(
                Math.max(Math.round(q.toPixels(v(d.value, n.max), !0)), 0),
                p
              );
              ...
              x = Math.max(e, g);
              q.isXAxis
                ? ((f = { x: u ? x : w, y: 0, width: y, height: p }),
                  D || (f.x = b.plotHeight - f.x))
                : ((f = { x: 0, y: u ? x : w, width: p, height: y }),
                  D && (f.y = b.plotWidth - f.y));
              u &&
                c.isVML &&
                (f = q.isXAxis
                  ? { x: 0, y: B ? w : x, height: f.width, width: b.chartWidth }
                  : {
  ...
  (function (a) {
    ...
    C.prototype.renderStackTotals = function () {
      ...
      f ||
        (this.stackTotalGroup = f =
          c.g("stack-labels").attr({ visibility: "visible", zIndex: 6 }).add());
      ...
      if (
        ...
        for (E = 0; E < f; E++)
          (g = e[E]),
            ...
            (A = B[A][g]),
            null !== r
              ? ((A.points[x] = A.points[this.index] = [t(A.cumulative, d)]),
                n(A.cumulative) || (A.base = x),
                (A.touched = w.stacksTouched),
                0 < m.index &&
                  !1 === this.singleStacks &&
                  (A.points[x][0] = A.points[this.index + "," + g + ",0"][0]))
    ...
    t(b.prototype, {
      update: function (a, b, c, e) {
        function f() {
          ...
          p.data[k] =
            h(p.data[k], !0) || h(a, !0) ? l.options : d(a, p.data[k]);
    ...
    t(v.prototype, {
      addPoint: function (a, b, c, e) {
        ...
        c &&
          (f[0] && f[0].remove
            ? f[0].remove(!1)
            : (f.shift(), this.updateParallelArrays(k, "shift"), m.shift()));
      ...
      update: function (b, c) {
        ...
        if (L)
          ...
          b = k(
            f,
            B,
            { index: e.index, pointStart: d(f.pointStart, e.xData[0]) },
            { data: e.options.data },
            b
          );
          e.remove(!1, null, !1);
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getGraphPath: function (a) {
          ...
          for (c = 0; c < a.length; c++)
            if (
              ...
              t || L(c, c - 1, "left"),
                (h && !u && t) ||
                  (k.push(a[c]), p.push({ x: c, plotX: d, plotY: l })),
                t || L(c, c + 1, "right");
          c = e.call(this, k, !0, !0);
          p.reversed = !0;
          h = e.call(this, p, !0, !0);
        ...
        drawGraph: function () {
          ...
          F(this.zones, function (e, c) {
            w.push([
              "zone-area-" + c,
              "highcharts-area highcharts-zone-area-" + c + " " + e.className,
              e.color || a.color,
              ...
              : ((h = a[c] =
                  a.chart.renderer
                    ...
                    .attr({
                      fill: n(
                        f[3],
                        C(f[2]).setOpacity(n(t.fillOpacity, 0.75)).get()
                      ),
                      zIndex: 0,
                    })
                    .add(a.group)),
        ...
        getPointSpline: function (a, I, n) {
          ...
          if (
            ...
            t > a && t > e
              ...
              : t < a && t < e && ((t = Math.min(a, e)), (y = 2 * e - t));
            y > n && y > e
              ? ((y = Math.max(n, e)), (t = 2 * e - y))
              : y < n && y < e && ((y = Math.min(n, e)), (t = 2 * e - y));
            I.rightContX = w;
            I.rightContY = y;
          }
          I = [
      ...
      },
      {
        ...
        translate: function () {
          ...
          I(a.points, function (c) {
            ...
            v &&
              Math.abs(w) < v &&
              ((w = v),
              (r = (!q.reversed && !c.negative) || (q.reversed && c.negative)),
              c.y === d && a.dataMax <= d && q.min < d && (r = !r),
              (g = Math.abs(g - b) > v ? h - v : b - (r ? v : 0)));
            ...
            c.tooltipPos = e.inverted
              ? [q.len + q.pos - e.plotLeft - k, a.xAxis.len - n - t / 2, w]
        ...
        pointAttribs: function (a, e) {
          ...
          e &&
            ...
            (b =
              a.color ||
              (void 0 !== e && F(b).brighten(a.brightness).get()) ||
              b),
            (n = a[f] || n),
            (t = a[d] || t),
            (h = a.dashStyle || h));
        ...
        drawPoints: function () {
          ...
          I(a.points, function (b) {
            ...
            if (e(b.plotY) && null !== b.y) {
              ...
              c[h](a.pointAttribs(b, b.selected && "select")).shadow(
                p.shadow,
                null,
          ...
          y &&
            (a
              ? ((d.scaleY = 0.001),
                ...
                q ? (d.translateX = a - e.len) : (d.translateY = a),
                c.group.attr(d))
              : ((v = c.group.attr(b)),
                c.group.animate(
                  { scaleY: 1 },
      ...
      },
      {
        ...
        translate: function (a) {
          ...
          this.getX = function (b, c, d) {
            ...
            return (
              a[0] + (c ? -1 : 1) * Math.cos(l) * (a[2] / 2 + d.labelDistance)
            );
          };
          for (A = 0; A < y; A++) {
            E = w[A];
        ...
        drawPoints: function () {
          ...
          n(a.points, function (l) {
            ...
            if (l.isNull) d && (l.graphic = d.destroy());
              ...
              d
                ? d.setRadialReference(a.center).attr(b).animate(f(h, e))
                : ((l.graphic = d =
                    c[l.shapeType](h)
                      .setRadialReference(a.center)
                      .attr(e)
                      .add(a.group)),
                  d.attr(b).attr({ "stroke-linejoin": "round" }).shadow(t, k));
  ...
  (function (a) {
        ...
        for (f = b.length; f--; )
          (h = b[f]),
            (v =
              ...
              2),
            (h.pos = Math.min(Math.max(0, v - h.size * h.align), c - h.size));
        f = b.length;
        for (h = !1; f--; )
          0 < f &&
            b[f - 1].pos + b[f - 1].size > b[f].pos &&
            ((b[f - 1].size += b[f].size),
            (b[f - 1].targets = b[f - 1].targets.concat(b[f].targets)),
            (b[f - 1].align = 0.5),
    ...
    c.prototype.drawDataLabels = function () {
      ...
      function c(a, b) {
        ...
        if (q(a) && !q(b))
          ...
          for (d = Math.max(a.length, b.length); d--; ) c[d] = x(a[d], b[d]);
        else c = x(a, b);
        return c;
      }
      var f = this,
          ...
          n(t, function (g) {
            ...
            n(m, function (c, d) {
              ...
              l &&
                ...
                (m = I(n)
                  ? e(n, m, h.time)
                  : (c[g.formatPrefix + "Formatter"] || c.formatter).call(
                      m,
                      c
                    )),
                (n = c.style),
                (q = c.rotation),
                (n.color = w(c.color, n.color, f.color, "#000000")),
                "contrast" === n.color &&
                  ((g.contrastColor = E.getContrast(g.color || f.color)),
                  (n.color =
                    c.inside || 0 > w(c.distance, g.labelDistance) || k.stacking
                      ? g.contrastColor
                      : "#000000")),
      ...
      var b = this.chart,
        ...
        r =
          ...
          (a.series.forceDL ||
            ...
            (e && b.isInsidePlot(m, l ? e.x + 1 : e.y + e.height - 1, l))),
        ...
        p
          ? ((v = !1),
            ...
            "left" === g
              ...
              : "right" === g && ((m.x -= n.width), (m.y -= k ? 0 : n.height)),
            (c.placed = !0),
            (c.alignAttr = m))
          : (c.align(d, null, e), (m = c.alignAttr)),
        v && 0 <= e.height
          ? (a.isLabelJustified = this.justifyDataLabel(c, d, m, n, e, h))
          : w(d.crop, !0) &&
            (r =
    ...
    c.prototype.justifyDataLabel = function (a, c, d, e, f, h) {
      ...
      n = d.y + p;
      0 > n &&
        ("bottom" === k ? (c.verticalAlign = "top") : (c.y = -n), (q = !0));
      n = d.y + e.height - p;
      n > b.plotHeight &&
        ("top" === k ? (c.verticalAlign = "bottom") : (c.y = b.plotHeight - n),
        (q = !0));
              ...
              for (
                b.sortByAngle(c, d - 0.5),
                  0 < b.maxLabelDistance &&
                    ...
                    (q = Math.min(r + g + b.maxLabelDistance, f.plotHeight)),
                    n(c, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, r - g - a.labelDistance)),
                        (a.bottom = Math.min(
                          r + g + a.labelDistance,
                          f.plotHeight
                        )),
                  ...
                  v &&
                    ...
                    (void 0 === e.distributeBox.pos
                      ...
                      : ((K = e.distributeBox.size),
                        (P = e.top + e.distributeBox.pos))),
                  delete e.positionIndex,
                  (z = h.justify
                    ? x[0] + (d ? -1 : 1) * (g + e.labelDistance)
                    : b.getX(P < e.top + 2 || P > e.bottom - 2 ? l : P, d, e)),
                  (y._attr = { visibility: T, align: H[6] }),
                  (y._pos = {
                    x: z + h.x + ({ left: k, right: -k }[H[6]] || 0),
                    y: P + h.y - 10,
                  }),
                  (H.x = z),
                  (H.y = P),
                  w(h.crop, !0) &&
                    ...
                    z - C < k && 1 === d
                      ...
                      : z + C > m - k &&
                        ...
                        (U[1] = Math.max(l, U[1]))),
                    0 > P - K / 2
                      ? (U[0] = Math.max(Math.round(-P + K / 2), U[0]))
                      : P + K / 2 > p &&
                        (U[2] = Math.max(Math.round(P + K / 2 - p), U[2])),
                    (y.sideOverflow = l));
          }),
        ...
        h ||
          (null !== d[0]
            ...
            : ((f = Math.max(b[2] - a[1] - a[3], e)),
              (b[0] += (a[3] - a[1]) / 2)),
          null !== d[1]
            ? (f = Math.max(Math.min(f, b[2] - Math.max(a[0], a[2])), e))
        ...
        for (p = (y = a[w]) && y.absoluteBox, n = w + 1; n < e; ++n)
          if (
            ...
            p &&
              ...
              0 !== y.newOpacity &&
              0 !== c.newOpacity &&
              (h = k(p.x, p.y, p.width, p.height, h.x, h.y, h.width, h.height)))
          )
      ...
      pan: function (a, b) {
        ...
        u("xy" === b ? [1, 0] : [1], function (b) {
          ...
          var d = b.horiz,
            ...
            l = Math.min(
              m.dataMin,
              g ? m.min : b.toValue(b.toPixels(m.min) - b.minPixelPadding)
            ),
            g = Math.max(
              m.dataMax,
              g ? m.max : b.toValue(b.toPixels(m.max) + b.minPixelPadding)
            ),
            n = l - h;
          0 < n && ((k += n), (h = l));
          n = k - g;
          ...
          if (this.graphic)
            this.state &&
              ...
              y &&
                this.graphic.animate(
                  y,
                  k(u.options.chart.animation, q.animation, l.animation)
                ),
              p && p.hide();
          else {
            if (a && q) {
              ...
              if (p) p[b ? "animate" : "attr"]({ x: y.x, y: y.y });
              else
                l &&
            ...
            p &&
              (p[a && u.isInsidePlot(c, d, u.inverted) ? "show" : "hide"](),
              (p.element.point = this));
          }
          (c = h.halo) && c.size
            ? (w ||
                (f.halo = w =
                  u.renderer.path().add((this.graphic || p).parentGroup)),
              ...
              w.attr(
                x(
                  { fill: this.color || f.color, "fill-opacity": c.opacity },
                  c.attributes
                )
              ))
            : w &&
