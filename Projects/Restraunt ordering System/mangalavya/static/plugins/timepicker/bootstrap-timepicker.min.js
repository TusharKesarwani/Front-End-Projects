  ...
  (i.prototype = {
      ...
      this.$element.parent().hasClass("input-prepend")
        ...
        this.template !== !1
          ? (this.$widget = e(this.getTemplate())
              .appendTo(this.$element.parents(this.appendWidgetTo))
    ...
    decrementMinute: function (e) {
      ...
      e ? (t = this.minute - e) : (t = this.minute - this.minuteStep),
        t < 0
          ? (this.decrementHour(), (this.minute = t + 60))
          : (this.minute = t),
        this.update();
    },
    decrementSecond: function () {
      ...
      e < 0
        ? (this.decrementMinute(!0), (this.second = e + 60))
        : (this.second = e),
        this.update();
    },
    ...
    getTemplate: function () {
      ...
      this.showInputs
        ? ((t =
            '<input type="text" name="hour" class="form-control bootstrap-timepicker-hour" maxlength="2"/>'),
          (n =
            '<input type="text" name="minute" class="form-control bootstrap-timepicker-minute" maxlength="2"/>'),
          (r =
            '<input type="text" name="second" class="form-control bootstrap-timepicker-second" maxlength="2"/>'),
          (i =
            '<input type="text" name="meridian" class="form-control bootstrap-timepicker-meridian" maxlength="2"/>'))
        ...
        (s =
          '<table><tr><td><a href="#" data-action="incrementHour"><i class="glyphicon glyphicon-chevron-up"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><i class="glyphicon glyphicon-chevron-up"></i></a></td>' +
          (this.showSeconds
            ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><i class="glyphicon glyphicon-chevron-up"></i></a></td>'
            : "") +
          (this.showMeridian
            ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="glyphicon glyphicon-chevron-up"></i></a></td>'
            : "") +
          "</tr>" +
          "<tr>" +
          "<td>" +
          ...
          (this.showSeconds
            ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><i class="glyphicon glyphicon-chevron-down"></i></a></td>'
            : "") +
          (this.showMeridian
            ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><i class="glyphicon glyphicon-chevron-down"></i></a></td>'
            : "") +
          "</tr>" +
          "</table>");
    ...
    incrementMinute: function (e) {
      ...
      e
        ...
        t > 59
          ? (this.incrementHour(), (this.minute = t - 60))
          : (this.minute = t),
        this.update();
    },
    incrementSecond: function () {
      ...
      e > 59
        ? (this.incrementMinute(!0), (this.second = e - 60))
        : (this.second = e),
        this.update();
    },
    remove: function () {
    ...
    setTime: function (e) {
      var t, n;
      this.showMeridian
        ? ((t = e.split(" ")), (n = t[0].split(":")), (this.meridian = t[1]))
        : (n = e.split(":")),
    ...
    showWidget: function () {
      ...
      e(n).on("mousedown.timepicker", function (n) {
        e(n.target).closest(".bootstrap-timepicker-widget").length === 0 &&
          t.hideWidget();
      }),
        this.$element.trigger({
        ...
        this.template === "modal"
          ? this.$widget
              .modal("show")
              .on("hidden", e.proxy(this.hideWidget, this))
