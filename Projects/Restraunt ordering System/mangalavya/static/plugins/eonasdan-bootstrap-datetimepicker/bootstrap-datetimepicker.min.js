  ...
  var n = function (n, a) {
    var r,
      ...
      Y = function () {
        ...
        else if (n.is("input")) t = n.after(m).parent();
        else {
        ...
        if (
          ("auto" === o &&
            (o =
              ...
              m.height() + n.outerHeight() < i.top
                ? "top"
                : "bottom"),
          "auto" === s &&
            (s =
              t.width() < i.left + m.outerWidth() / 2 &&
              i.left + m.outerWidth() > e(window).width()
                ? "right"
                : "left"),
          "top" === o
      ...
      X = function () {
        var e,
          t,
          n = m.find(".timepicker span[data-time-component]");
        s ||
          ((e = m.find(".timepicker [data-action=togglePeriod]")),
