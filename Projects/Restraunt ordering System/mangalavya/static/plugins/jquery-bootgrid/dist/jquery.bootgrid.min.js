...
!(function (a, b, c) {
    ...
    c.children().each(function () {
      var c = a(this),
        ...
        f = {
          ...
          converter:
            b.options.converters[e.converter || e.type] ||
            b.options.converters.string,
          text: c.text(),
          align: e.align || "left",
  ...
  function n() {
    function c(a) {
      for (
        var b,
          c = new RegExp(e.searchPhrase, e.options.caseSensitive ? "g" : "gi"),
          d = 0;
        d < e.columns.length;
        d++
      )
        if (
          ((b = e.columns[d]),
          b.searchable && b.visible && b.converter.to(a[b.id]).search(c) > -1)
        )
          return !0;
      return !1;
    }
    function d(a, b) {
      (e.currentRows = a),
        ...
        t.call(e),
        v.call(e),
        e.element._bgBusyAria(!1).trigger("loaded" + H);
    }
    var e = this;
    if (
      (this.element._bgBusyAria(!0).trigger("load" + H),
      F.call(this),
      this.options.ajax)
    ) {
      var f = g.call(this),
        h = i.call(this);
      if (null == h || "string" != typeof h || 0 === h.length)
        throw new Error(
      ...
      var j = {
        ...
        error: function (a, b, c) {
          (e.xqr = null),
            "abort" !== b &&
              (u.call(e), e.element._bgBusyAria(!1).trigger("loaded" + H));
        },
      };
      ...
      var k = this.searchPhrase.length > 0 ? this.rows.where(c) : this.rows,
        l = k.length;
      -1 !== this.rowCount && (k = k.page(this.current, this.rowCount)),
  ...
  function q() {
    var b = this.options.templates,
      c = this.element.parent().hasClass(this.options.css.responsiveTable)
        ? this.element.parent()
        : this.element;
    this.element.addClass(this.options.css.table),
      0 === this.element.children("tbody").length &&
        this.element.append(b.body),
      1 & this.options.navigation &&
        ((this.header = a(
          b.header.resolve(
            f.call(this, { id: this.element._bgId() + "-header" })
          )
        )),
      ...
      2 & this.options.navigation &&
        ((this.footer = a(
          b.footer.resolve(
            f.call(this, { id: this.element._bgId() + "-footer" })
          )
        )),
        c.after(this.footer));
  }
      ...
      if (d.length > 0) {
        ...
        if (this.options.ajax) {
          var k = i.icon.resolve(f.call(this, { iconCss: b.iconRefresh })),
            l = a(
              i.actionButton.resolve(
                f.call(this, { content: k, text: this.options.labels.refresh })
              )
  ...
  function s(b) {
    if (this.options.columnSelection && this.columns.length > 1) {
      var c = this,
        ...
        i = a(e.actionDropDown.resolve(f.call(this, { content: g }))),
        j = h(d.dropDownItem),
      ...
      a.each(this.columns, function (b, g) {
        if (g.visibleInSelection) {
          var o = a(
            e.actionDropDownCheckboxItem.resolve(
              f.call(c, { name: g.id, label: g.text, checked: g.visible })
            )
  ...
  function u() {
    ...
    this.selection && (c += 1),
      a.html(b.noResults.resolve(f.call(this, { columns: c })));
  }
  function v() {
    if (0 !== this.options.navigation) {
      ...
      if (-1 !== this.rowCount && c.length > 0) {
        var d = this.options.templates,
          ...
          m =
            k >= this.options.padding
              ? Math.max(l, 1)
              : Math.max(l - this.options.padding + k, 1),
        ...
        for (var p = 0; o > p; p++) {
          var q = p + m;
          w.call(this, j, q, q, "page-" + q)
            ._bgEnableAria()
            ._bgSelectAria(q === g);
        }
        0 === o &&
          w.call(this, j, 1, 1, "page-1")._bgEnableAria(!1)._bgSelectAria(),
  ...
  function w(b, c, d, e) {
    var g = this,
      ...
      l = a(i.paginationItem.resolve(k)).on(
        "click" + H,
        h(j.paginationButton),
        function (b) {
  ...
  function x(b) {
    ...
    if (a.isArray(e)) {
      var g = this.options.css,
        i = this.options.templates,
        j = a(
          i.actionDropDown.resolve(f.call(this, { content: c(this.rowCount) }))
        ),
        k = h(g.dropDownMenu),
      ...
      a.each(e, function (b, e) {
        var g = a(
          i.actionDropDownItem.resolve(f.call(d, { text: c(e), action: e }))
        )
          ._bgSelectAria(e === d.rowCount)
          .on("click" + H, o, function (b) {
            b.preventDefault();
            var e = a(this),
              f = e.data("action");
            f !== d.rowCount &&
    ...
    if (b.length > 0) {
      ...
      a.each(b, function (b, g) {
        var h = "",
          k =
            ' data-row-id="' +
            (null == c.identifier ? b : g[c.identifier]) +
            '"',
          l = "";
        if (c.selection) {
          ...
          (h += e.cell.resolve(f.call(c, { content: n, css: d.selectCell }))),
            (i = i && m),
            m && ((l += d.selected), (k += ' aria-selected="true"'));
        }
        var o = null != g.status && c.options.statusMapping[g.status];
        o && (l += o),
          a.each(c.columns, function (b, i) {
            if (i.visible) {
              var j = a.isFunction(i.formatter)
                  ? i.formatter.call(c, i, g)
                  : i.converter.to(g[i.id]),
          ...
          (j += e.row.resolve(f.call(c, { attr: k, cells: h })));
      }),
        c.element
          .find("thead " + h(c.options.css.selectBox))
          .prop("checked", i),
        g.html(j),
        z.call(this, g);
    } else u.call(this);
  ...
  function z(b) {
    ...
    this.selection &&
      b.off("click" + H, d).on("click" + H, d, function (b) {
        b.stopPropagation();
        var d = a(this),
      ...
      b.off("click" + H, "> tr").on("click" + H, "> tr", function (b) {
        ...
        var d = a(this),
          e =
            null == c.identifier
              ? d.data("row-id")
              : c.converter.from(d.data("row-id") + ""),
          f =
            null == c.identifier
              ? c.currentRows[e]
              : c.currentRows.first(function (a) {
                  return a[c.identifier] === e;
                });
        c.selection &&
          c.options.rowSelect &&
          (d.hasClass(c.options.css.selected)
            ? c.deselect([e])
            : c.select([e])),
      ...
      if (g.length > 0) {
        ...
        o.on("keyup" + H, function (c) {
          ...
          (l !== d || (13 === c.which && "" !== d)) &&
            ...
            (13 === c.which ||
              0 === d.length ||
              d.length >= i.options.searchSettings.characters) &&
              (b.clearTimeout(k),
  ...
  function B(a) {
    this.searchPhrase !== a &&
      ((this.current = 1), (this.searchPhrase = a), n.call(this));
  }
  function C() {
    var b = this,
    ...
    if (this.selection) {
      var j = this.options.multiSelect
        ? e.select.resolve(f.call(b, { type: "checkbox", value: "all" }))
        : "";
      g += e.rawHeaderCell.resolve(
        f.call(b, { content: j, css: d.selectCell })
      );
    }
    if (
          ...
          var h = b.sortDictionary[c.id],
            j =
              i && h && "asc" === h
                ...
                ? d.iconDown
                : "",
            k = e.icon.resolve(f.call(b, { iconCss: j })),
            l = c.headerAlign,
            m = c.headerCssClass.length > 0 ? " " + c.headerCssClass : "";
          g += e.headerCell.resolve(
            f.call(b, {
              column: c,
              icon: k,
              sortable: (i && c.sortable && d.sortable) || "",
              css:
                ("right" === l ? d.right : "center" === l ? d.center : d.left) +
                m,
  ...
  function F() {
    ...
    b.setTimeout(function () {
      if ("true" === a.element._bgAria("busy")) {
        ...
        a.selection && (h += 1),
          d.html(b.loading.resolve(f.call(a, { columns: h }))),
          -1 !== a.rowCount &&
            g > 0 &&
            d.find("tr > td").css("padding", "20px 0 " + g + "px");
      }
    }, 250);
  }
  function G() {
    ...
    var b = [];
    if (!this.options.ajax) {
      for (var c in this.sortDictionary)
        (this.options.multiSort || 0 === b.length) &&
          b.push({ id: c, order: this.sortDictionary[c] });
  ...
  var H = ".rs.jquery.bootgrid",
    I = function (b, c) {
      (this.element = a(b)),
        ...
        (this.options = a.extend(!0, {}, I.defaults, this.element.data(), c));
      var d = (this.options.rowCount =
        this.element.data().rowCount || c.rowCount || this.options.rowCount);
      (this.columns = []),
        (this.current = 1),
        (this.currentRows = []),
  ...
  if (
    ((I.defaults = {
      ...
      templates: {
        ...
        actionDropDownCheckboxItem:
          '<li><label class="{{css.dropDownItem}}"><input name="{{ctx.name}}" type="checkbox" value="1" class="{{css.dropDownItemCheckbox}}" {{ctx.checked}} /> {{ctx.label}}</label></li>',
    ...
    (I.prototype.select = function (b) {
      if (this.selection) {
        ...
        for (
          var c, d, e = [];
          b.length > 0 && (this.options.multiSelect || 1 !== e.length);
        ...
        if (e.length > 0) {
          ...
          for (
            d = 0;
            !this.options.keepSelection && g && d < this.currentRows.length;

          )
            g =
              -1 !==
              a.inArray(
                this.currentRows[d++][this.identifier],
                this.selectedRows
              );
          for (
            this.element.find("thead " + f).prop("checked", g),
              this.options.multiSelect ||
                this.element
                  .find("tbody > tr " + f + ":checked")
                  .trigger("click" + H),
              d = 0;
            d < this.selectedRows.length;
            d++
          )
            this.element
              .find('tbody > tr[data-row-id="' + this.selectedRows[d] + '"]')
    ...
    (I.prototype.deselect = function (b) {
      if (this.selection) {
        ...
        if (f.length > 0) {
          ...
          for (
            this.element.find("thead " + g).prop("checked", !1), d = 0;
            d < f.length;
            d++
          )
            this.element
              .find('tbody > tr[data-row-id="' + f[d][this.identifier] + '"]')
    ...
    (I.prototype.sort = function (b) {
      var c = b ? a.extend({}, b) : {};
      return c === this.sortDictionary
        ? this
        : ((this.sortDictionary = c),
          C.call(this),
          G.call(this),
          n.call(this),
          this);
  ...
  Array.prototype.first ||
    ...
    Array.prototype.page ||
      (Array.prototype.page = function (a, b) {
        var c = (a - 1) * b,
          d = c + b;
    ...
    Array.prototype.where ||
      (Array.prototype.where = function (a) {
    ...
    Array.prototype.propValues ||
      (Array.prototype.propValues = function (a) {
  ...
  (a.fn.bootgrid = function (b) {
    var c = Array.prototype.slice.call(arguments, 1),
      ...
      e = this.each(function (e) {
        ...
        if (
          (g || "destroy" !== b) &&
          (g || (f.data(H, (g = new I(this, h))), j.call(g)),
          "string" == typeof b)
        )
