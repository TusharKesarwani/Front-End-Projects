        ...
        if (((b = b || a.noop), "slide-in" == this.state)) {
          ...
          a.support.transition
            ? this.$backdrop
                ...
                .emulateTransitionEnd(150)
            : (this.$backdrop.remove(), (this.$backdrop = null), b());
        } else b && b();
      }),
  ...
  +(function (a) {
    ...
    (e.DEFAULTS = {
      ...
      (e.prototype.blurEvent = function () {
        this.checkVal(),
          this.$element.val() !== this.focusText &&
            (this.$element.trigger("change"), this.$element.trigger("input"));
      }),
      ...
      (e.prototype.keypressEvent = function (a) {
        ...
        if (c) {
          d.end - d.begin !== 0 &&
            (this.clearBuffer(d.begin, d.end), this.shiftL(d.begin, d.end - 1));
