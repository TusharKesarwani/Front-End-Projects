      ...
      B = (A.prototype = {
        ...
        start: function () {
          return w && w.start
            ...
            : ((w.methods = {}),
              ...
              (B.$root = a(
                '<div class="' + y.picker + '" id="' + f.id + '_root" />'
              )),
              p(),
          ...
          return w.open
            ...
            : (z.addClass(y.active),
              ...
              c !== !1 &&
                ((w.open = !0),
                v &&
                  k.css("overflow", "hidden").css("padding-right", "+=" + d()),
                s(),
                j
                  ...
                  .on("keydown." + w.id, function (c) {
                    ...
                    27 == d
                      ...
                      : (c.preventDefault(),
                        e
                          ? b._.trigger(B.component.key.go, B, [b._.trigger(e)])
                          : B.$root
                              .find("." + y.highlighted)
                              .hasClass(y.disabled) ||
        ...
        close: function (a) {
          return (
            ...
            w.open
              ? ((w.open = !1),
                v && k.css("overflow", "").css("padding-right", "-=" + d()),
                j.off("." + w.id),
                B.trigger("close"))
              : B
          );
