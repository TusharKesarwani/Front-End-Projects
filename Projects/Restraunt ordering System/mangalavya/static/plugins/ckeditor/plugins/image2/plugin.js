...
(function () {
    ...
    function c() {
      ...
      if (this.deflated)
        ...
        if (d) {
          ...
          "center" == c
            ? b && e.addClass(d[1])
            : "none" != c && e.addClass(d[q[c]]);
        } else
          "center" == c
            ? (b
                ? e.setStyle("text-align", "center")
    ...
    return {
      ...
      data: function () {
        ...
        if (a.filter.checkFeature(d.dimension)) {
          ...
          e = this.parts.image;
          for (var g in d)
            d[g] ? e.setAttribute(g, d[g]) : e.removeAttribute(g);
        }
      ...
      init: function () {
        ...
        c.align ||
          ...
          g
            ? (b.hasClass(g[0])
                ? (c.align = "left")
                : b.hasClass(g[2]) && (c.align = "right"),
              c.align ? b.removeClass(g[q[c.align]]) : (c.align = "none"))
            : ((c.align = b.getStyle("float") || "none"),
              b.removeStyle("float")));
        a.plugins.link &&
          this.parts.link &&
          ...
          (b = c.link.advanced) &&
            b.advCSSClasses &&
            (b.advCSSClasses = CKEDITOR.tools.trim(
              b.advCSSClasses.replace(/cke_\S+/, "")
            )));
        this.wrapper[(c.hasCaption ? "remove" : "add") + "Class"](
          "cke_image_nocaption"
        );
        this.setData(c);
    ...
    return function (a) {
      ...
      d &&
        ...
        "center" == d && "figure" == a.name
          ...
          : d in { left: 1, right: 1 } &&
            (b ? g.addClass(b[q[d]]) : (e["float"] = d)),
        b ||
          CKEDITOR.tools.isEmpty(e) ||
          (f.style = CKEDITOR.tools.writeCssText(e)));
      return a;
    };
  }
  function n(a) {
    ...
    return function (f) {
      ...
      return (
        c
          ? f.hasClass(c[1])
          : "center" ==
            CKEDITOR.tools.parseCssText(f.attributes.style || "", !0)[
              "text-align"
            ]
      )
        ? !0
  ...
  function G(a) {
    ...
    a.on("data", function () {
      f["right" == a.data.align ? "addClass" : "removeClass"](
  ...
  CKEDITOR.plugins.image2 = {
    stateShifter: function (a) {
      function b(a, b) {
        var d = {};
        f
          ? (d.attributes = { class: f[1] })
          : (d.styles = { "text-align": "center" });
        d = g.createElement(
          a.activeEnterMode == CKEDITOR.ENTER_P ? "p" : "div",
          d
        );
            ...
            if (b.changed.link) {
              ...
              c
                ? (d ||
                  ...
                  CKEDITOR.tools.isEmpty(c.set) ||
                    (k || f).setAttributes(c.set),
