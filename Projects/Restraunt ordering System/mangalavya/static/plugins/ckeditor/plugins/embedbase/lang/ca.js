CKEDITOR.plugins.setLang("embedbase", "ca", {
  ...
  unsupportedUrl:
    "La URL {url} no és compatible pels objectes multimèdia incrustats.",
  fetchingFailedGiven:
    "No s'ha pogut obtenir el contingut de la URL especificada.",
  fetchingFailed: "No s'ha pogut obtenir el contingut de {url}.",
  fetchingOne: "Recuperant resposta de oEmbed...",
  fetchingMany:
    "Recuperant respostes dels oEmbed, {current} de {max} finalitzats...",
});
