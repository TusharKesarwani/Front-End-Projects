...
(function () {
  function k(a, b, d, e) {
    ...
    if (
      ...
      if ((d(a), e)) return;
    for (; (a = c.next()); )
      if ((a = a.getAscendant(b, !0))) if ((d(a), e)) break;
  }
  function u(a, b) {
    var d = { ul: "ol", ol: "ul" };
    return (
  ...
  CKEDITOR.plugins.add("copyformatting", {
    ...
    init: function (a) {
      ...
      a.copyFormatting.on("extractFormatting", function (d) {
        ...
        if (e.contains(a.editable()) || e.equals(a.editable()))
          return d.cancel();
        e = b._convertElementToStyleDef(e);
        if (!a.copyFormatting.filter.check(new CKEDITOR.style(e), !0, !0))
          return d.cancel();
        d.data.styleDef = e;
      });
              ...
              (f = c[h]),
                ...
                -1 === l(b.preservedElements, f.element)
                  ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome
                    ...
                    : c[h].remove(d.editor)
                  : u(f.element, d.data.styles) &&
                    b._removeStylesFromElementInRange(e, f.element),
                e.moveToBookmark(g);
        }
      });
      a.copyFormatting.on(
        ...
        function (b) {
          ...
          "list" === c && a.copyFormatting._isContextAllowed("list")
            ...
            ? e._applyStylesToTableContext(
                b.editor,
                b.data.range,
                b.data.styles
              )
            : a.copyFormatting._isContextAllowed("text") &&
              e._applyStylesToTextContext(
                b.editor,
                b.data.range,
                b.data.styles
              );
  ...
  CKEDITOR.plugins.copyformatting = {
    ...
    commands: {
      copyFormatting: {
        exec: function (a, b) {
          ...
          e.styles = d._extractStylesFromElement(
            a,
    ...
    _removeStylesFromElementInRange: function (a, b) {
      for (
        var d = -1 !== l(["ol", "ul", "table"], b),
          e = new CKEDITOR.dom.walker(a),
          c;
        (c = e.next());
    ...
    _filterStyles: function (a) {
      ...
      for (c = 0; c < a.length; c++)
        (e = a[c]._.definition),
          ...
          ("span" === e.element && b(e.attributes) && b(e.styles)) ||
            d.push(a[c]);
      return d;
    },
    ...
    _applyStylesToTextContext: function (a, b, d) {
      ...
      for (f = 0; f < d.length; f++)
        if (
          ((b = d[f]),
          -1 === l(e.excludedElementsFromInlineTransform, b.element))
        ) {
