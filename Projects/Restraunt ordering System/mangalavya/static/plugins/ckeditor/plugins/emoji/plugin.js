    ...
    h = CKEDITOR.tools.createClass({
      $: function (a, d) {
        ...
        a.ui.add("EmojiPanel", CKEDITOR.UI_PANELBUTTON, {
          ...
          onBlock: function (d, b) {
            ...
            c.blockObject = b;
            c.elements.emojiItems = b.element.find(
              ".cke_emoji-outer_emoji_block li \x3e a"
            );
            c.elements.sectionHeaders = b.element.find(
            ...
            c.elements.emojiBlock = b.element.findOne(
            ...
            c.elements.statusDescription = b.element.findOne(
              "p.cke_emoji-status_description"
            );
            c.elements.statusName = b.element.findOne(
      ...
      proto: {
          ...
          f.forEach(
            ...
            function (a) {
              var d = a.listener,
                ...
                c = a.ctx || this;
              f.forEach(
                this.blockElement.find(a.selector).toArray(),
                function (a) {
                  a.on(b, d, c);
                }
              );
        ...
        createEmojiBlock: function () {
          ...
          return (
            '\x3cdiv class\x3d"cke_emoji-inner_panel"\x3e' +
            a.join("") +
            "\x3c/div\x3e"
          );
        },
        ...
        createEmojiListBlock: function () {
          this.listeners.push({
            ...
            event: "scroll",
            listener: CKEDITOR.tools.throttle(
              150,
        ...
        moveFocus: function (a) {
          a = this.blockElement.findOne(
            'a[data-cke-emoji-group\x3d"' + e(a) + '"]'
          );
          var d;
          a &&
        ...
        CKEDITOR.ajax.load(
          ...
          function (b) {
            ...
            function e() {
              return function (a) {
                return a.collapsed
                  ? CKEDITOR.plugins.textMatch.match(a, f)
                  : null;
              };
            }
            function f(a, b) {
