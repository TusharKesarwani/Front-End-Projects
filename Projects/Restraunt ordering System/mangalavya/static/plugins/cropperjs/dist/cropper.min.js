...
!(function (t, i) {
  ...
  var o = "undefined" != typeof window,
    ...
    x = "cropstart",
    y = "dblclick",
    M = h.PointerEvent ? "pointerdown" : "touchstart mousedown",
  ...
  function J(t) {
    ...
    try {
      var i = t.constructor,
        e = i.prototype;
      return i && e && V.call(e, "isPrototypeOf");
    } catch (t) {
      return !1;
    }
  }
  ...
  function tt(i, e) {
    if (i && _(e))
      if (Array.isArray(i) || F(i.length)) {
        var t,
          a = i.length;
        for (t = 0; t < a && !1 !== e.call(i, i[t], t, i); t += 1);
      } else
        G(i) &&
  ...
  var it =
      ...
      function (e) {
        for (
          var t = arguments.length, i = new Array(1 < t ? t - 1 : 0), a = 1;
          a < t;
          a++
        )
          i[a - 1] = arguments[a];
  ...
  function xt(t) {
    ...
    return et.test(t) ? Math.round(t * i) / i : t;
  }
  var at = /^(?:width|height|left|top|marginLeft|marginTop)$/;
  function nt(t, i) {
    var e = t.style;
    tt(i, function (t, i) {
      at.test(i) && F(t) && (t += "px"), (e[i] = t);
    });
  }
  function ot(t, i) {
    if (i)
  ...
  function dt(t, i) {
    return G(t[i])
      ...
      : t.dataset
      ? t.dataset[i]
      : t.getAttribute("data-".concat(ct(i)));
  }
  function lt(t, i, e) {
    G(e)
      ? (t[i] = e)
      : t.dataset
      ? (t.dataset[i] = e)
      : t.setAttribute("data-".concat(ct(i)), e);
  }
  var pt = /\s\s*/,
    mt = (function () {
      var t = !1;
      if (o) {
        ...
        h.addEventListener("test", e, a), h.removeEventListener("test", e, a);
      }
      return t;
    })();
  function gt(e, t, a) {
  ...
  function Mt(t) {
    var i = t.match(yt);
    return (
      i && (i[1] !== wt.protocol || i[2] !== wt.hostname || i[3] !== wt.port)
    );
  }
  function Ct(t) {
  ...
  function Dt(t) {
    var i = t.rotate,
      ...
      o = t.translateY,
      h = [];
    F(n) && 0 !== n && h.push("translateX(".concat(n, "px)")),
      F(o) && 0 !== o && h.push("translateY(".concat(o, "px)")),
      F(i) && 0 !== i && h.push("rotate(".concat(i, "deg)")),
      F(e) && 1 !== e && h.push("scaleX(".concat(e, ")")),
      F(a) && 1 !== a && h.push("scaleY(".concat(a, ")"));
  ...
  function Bt(t, i) {
    var e = t.pageX,
      a = t.pageY,
      n = { endX: e, endY: a };
    return i ? n : it({ startX: e, startY: a }, n);
  }
  var kt = Number.isFinite || h.isFinite;
  function Tt(t) {
    var i = t.aspectRatio,
      e = t.height,
      a = t.width,
  ...
  function Nt(t) {
    ...
    try {
      ...
      if (255 === e.getUint8(0) && 216 === e.getUint8(1))
        for (var h = e.byteLength, r = 2; r + 1 < h; ) {
      ...
      if (n) {
        ...
        if (
          ...
          (function (t, i, e) {
            var a,
              n = "";
            for (e += i, a = i; a < e; a += 1) n += Et(t.getUint8(a));
            return n;
          })(e, n + 4, 4)
        ) {
          var c = e.getUint16(s);
          if (
            ((a = 18761 === c) || 19789 === c) &&
            42 === e.getUint16(s + 2, a)
          ) {
            var d = e.getUint32(s + 4, a);
            8 <= d && (o = s + d);
          }
        }
      }
      if (o) {
        var l,
          ...
          m = e.getUint16(o, a);
        for (p = 0; p < m; p += 1)
          if (((l = o + 12 * p + 2), 274 === e.getUint16(l, a))) {
            (l += 8), (i = e.getUint16(l, a)), e.setUint16(l, 1, a);
            break;
          }
      }
    } catch (t) {
  ...
  var Ht = {
      ...
      initContainer: function () {
        ...
        nt(a, { width: (this.containerData = n).width, height: n.height }),
          ot(t, S),
          ht(a, S);
      },
      initCanvas: function () {
        ...
        (c.left = (t.width - r) / 2),
          ...
          (this.initialImageData = it({}, i)),
          (this.initialCanvasData = it({}, c));
      },
              ...
              (c
                ...
                : s &&
                  ((c = o.width) < (d = o.height) * r
                    ? (c = d * r)
                    : (d = c / r)));
          var l = Tt({ aspectRatio: r, width: c, height: d });
          (c = l.width),
            (d = l.height),
            (n.minWidth = c),
            (n.minHeight = d),
        ...
        (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
          ...
          nt(
            ...
            it(
              ...
              Dt({ translateX: e.left, translateY: e.top })
            )
          ),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        it(e, {
          ...
          nt(
            ...
            it(
              { width: e.width, height: e.height },
              Dt(it({ translateX: e.left, translateY: e.top }, e))
            )
          ),
          t && this.output();
      },
        ...
        (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
          ...
          t.movable &&
            ...
            lt(
              this.face,
              g,
              e.width >= i.width && e.height >= i.height ? E : k
            ),
          nt(
            this.cropBox,
            it(
      ...
      output: function () {
        this.preview(), ft(this.element, a, this.getData());
      },
    },
    Lt = {
      ...
      resetPreview: function () {
        tt(this.previews, function (t) {
          var i = dt(t, u);
          nt(t, { width: i.width, height: i.height }),
            (t.innerHTML = i.html),
            (function (i, e) {
              if (G(i[e]))
                try {
      ...
      preview: function () {
        ...
        this.cropped &&
          ...
          (nt(
            ...
            it(
              { width: d, height: l },
              Dt(it({ translateX: -p, translateY: -m }, r))
            )
          ),
          tt(this.previews, function (t) {
            var i = dt(t, u),
            ...
            s && (o = c * (h = e / s)),
              c && a < o && ((n = s * (h = a / c)), (o = a)),
              nt(t, { width: n, height: o }),
              nt(
                t.getElementsByTagName("img")[0],
                it(
                  { width: d * h, height: l * h },
                  Dt(it({ translateX: -p * h, translateY: -m * h }, r))
                )
              );
          }));
      },
    ...
    Ot = {
      bind: function () {
        var t = this.element,
          i = this.options,
          e = this.cropper;
        _(i.cropstart) && ut(t, x, i.cropstart),
          _(i.cropmove) && ut(t, b, i.cropmove),
          _(i.cropend) && ut(t, w, i.cropend),
          _(i.crop) && ut(t, a, i.crop),
          _(i.zoom) && ut(t, j, i.zoom),
          ut(e, M, (this.onCropStart = this.cropStart.bind(this))),
          i.zoomable &&
            i.zoomOnWheel &&
            ut(e, I, (this.onWheel = this.wheel.bind(this))),
          i.toggleDragModeOnDblclick &&
            ut(e, y, (this.onDblclick = this.dblclick.bind(this))),
          ut(t.ownerDocument, C, (this.onCropMove = this.cropMove.bind(this))),
          ut(t.ownerDocument, D, (this.onCropEnd = this.cropEnd.bind(this))),
          i.responsive &&
            ut(window, A, (this.onResize = this.resize.bind(this)));
      },
      unbind: function () {
        var t = this.element,
          i = this.options,
          e = this.cropper;
        _(i.cropstart) && gt(t, x, i.cropstart),
          _(i.cropmove) && gt(t, b, i.cropmove),
          _(i.cropend) && gt(t, w, i.cropend),
          _(i.crop) && gt(t, a, i.crop),
          _(i.zoom) && gt(t, j, i.zoom),
          gt(e, M, this.onCropStart),
          i.zoomable && i.zoomOnWheel && gt(e, I, this.onWheel),
          i.toggleDragModeOnDblclick && gt(e, y, this.onDblclick),
          gt(t.ownerDocument, C, this.onCropMove),
          gt(t.ownerDocument, D, this.onCropEnd),
          i.responsive && gt(window, A, this.onResize);
      },
    },
    zt = {
      resize: function () {
        ...
        if (!(this.disabled || e.width <= a || e.height <= n)) {
          var o,
            h,
            r = i.offsetWidth / e.width;
          if (1 !== r || i.offsetHeight !== e.height)
            t.restore &&
      ...
      cropStart: function (t) {
        if (!this.disabled) {
          var i,
            ...
            a = this.pointers;
          t.changedTouches
            ? tt(t.changedTouches, function (t) {
                a[t.identifier] = Bt(t);
              })
            : (a[t.pointerId || 0] = Bt(t)),
            (i =
              1 < Object.keys(a).length && e.zoomable && e.zoomOnTouch
                ? W
                : dt(t.target, g)),
            P.test(i) &&
              !1 !== ft(this.element, x, { originalEvent: t, action: i }) &&
              (t.preventDefault(),
              (this.action = i),
              (this.cropping = !1),
              i === T && ((this.cropping = !0), ot(this.dragBox, s)));
        }
      },
      cropMove: function (t) {
        var i = this.action;
        if (!this.disabled && i) {
          var e = this.pointers;
          t.preventDefault(),
            !1 !== ft(this.element, b, { originalEvent: t, action: i }) &&
              (t.changedTouches
                ? tt(t.changedTouches, function (t) {
                    it(e[t.identifier] || {}, Bt(t, !0));
                  })
                : it(e[t.pointerId || 0] || {}, Bt(t, !0)),
              this.change(t));
        }
      },
      cropEnd: function (t) {
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            i &&
              ...
              this.cropping &&
                ((this.cropping = !1),
                rt(this.dragBox, s, this.cropped && this.options.modal)),
              ft(this.element, w, { originalEvent: t, action: i }));
        }
      },
    },
    Yt = {
      change: function (t) {
        var i,
          ...
          w = n.height,
          b = !0;
        !s && t.shiftKey && (s = l && p ? l / p : 1),
          this.limited &&
            ((u = o.minLeft),
            (f = o.minTop),
            (v = u + Math.min(n.width, a.width, a.left + a.width)),
        ...
        switch (r) {
          case k:
            ...
            break;
          case N:
            if (0 <= D.x && (v <= m || (s && (d <= f || w <= g)))) {
              b = !1;
              break;
            }
            B(N),
              (l += D.x) < 0 && ((r = H), (c -= l = -l)),
              s && ((p = l / s), (d += (o.height - p) / 2));
            break;
          case O:
            if (D.y <= 0 && (d <= f || (s && (c <= u || v <= m)))) {
              b = !1;
              break;
            }
            B(O),
              ...
              (d += D.y),
              p < 0 && ((r = L), (d -= p = -p)),
              s && ((l = p * s), (c += (o.width - l) / 2));
            break;
          case H:
            if (D.x <= 0 && (c <= u || (s && (d <= f || w <= g)))) {
              b = !1;
              break;
            }
            B(H),
          ...
          case Y:
            if (s) {
              ...
              B(O), (p -= D.y), (d += D.y), (l = p * s), (c += o.width - l);
            } else
              B(O),
                B(H),
                D.x <= 0
    ...
    Xt = {
      ...
      reset: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.imageData = it({}, this.initialImageData)),
            (this.canvasData = it({}, this.initialCanvasData)),
            (this.cropBoxData = it({}, this.initialCropBoxData)),
            this.renderCanvas(),
            this.cropped && this.renderCropBox()),
          this
        );
      ...
      clear: function () {
        return (
          this.cropped &&
            !this.disabled &&
            (it(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
            (this.cropped = !1),
            this.renderCropBox(),
            this.limitCanvas(!0, !0),
            this.renderCanvas(),
      ...
      enable: function () {
        return (
          this.ready &&
            this.disabled &&
            ((this.disabled = !1), ht(this.cropper, t)),
          this
        );
      },
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), ot(this.cropper, t)),
          this
        );
      },
      destroy: function () {
      ...
      move: function (t) {
        var i =
          ...
          a = e.left,
          n = e.top;
        return this.moveTo(K(t) ? t : a + Number(t), K(i) ? i : n + Number(i));
      },
      moveTo: function (t) {
        var i =
            1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : t,
      ...
      zoomTo: function (t, i, e) {
        ...
        if (
          ...
          if (
            !1 ===
            ft(this.element, j, { ratio: t, oldRatio: s / d, originalEvent: e })
          )
            return this;
          if (e) {
            var g = this.pointers,
            ...
            (r.left -= (p - s) * ((f.pageX - u.left - r.left) / s)),
              (r.top -= (m - c) * ((f.pageY - u.top - r.top) / c));
          } else
            J(i) && F(i.x) && F(i.y)
      ...
      scaleX: function (t) {
        ...
        return this.scale(t, F(i) ? i : 1);
      },
      scaleY: function (t) {
        var i = this.imageData.scaleX;
        return this.scale(F(i) ? i : 1, t);
      },
      scale: function (t) {
        var i =
            1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : t,
      ...
      getData: function () {
        ...
        return (
          i.rotatable && (e.rotate = a.rotate || 0),
          i.scalable &&
            ((e.scaleX = a.scaleX || 1), (e.scaleY = a.scaleY || 1)),
          e
        );
      },
      setData: function (t) {
        var i = this.options,
          ...
          a = this.canvasData,
          n = {};
        if (this.ready && !this.disabled && J(t)) {
          var o = !1;
          i.rotatable &&
            F(t.rotate) &&
            t.rotate !== e.rotate &&
          ...
          F(t.x) && (n.left = t.x * h + a.left),
            F(t.y) && (n.top = t.y * h + a.top),
            F(t.width) && (n.width = t.width * h),
            F(t.height) && (n.height = t.height * h),
            this.setCropBoxData(n);
        }
        return this;
      },
      getContainerData: function () {
        return this.ready ? it({}, this.containerData) : {};
      },
      getImageData: function () {
        return this.sized ? it({}, this.imageData) : {};
      },
      ...
      getCroppedCanvas: function () {
        ...
        var i,
          ...
          P =
            ...
            (L = H.getContext("2d")),
            (O = Tt({ aspectRatio: g, width: D, height: k })),
            (z = Tt({ aspectRatio: g, width: E, height: N }, "cover")),
            (Y = Math.min(O.width, Math.max(z.width, u))),
            (X = Math.min(O.height, Math.max(z.height, f))),
            (R = Tt({ aspectRatio: o, width: D, height: k })),
            (S = Tt({ aspectRatio: o, width: E, height: N }, "cover")),
        ...
        var G = Z / F,
          ...
          _ = Tt({
            aspectRatio: G,
            width: t.width || (1 !== K ? P.width : Z),
            height: t.height || (1 !== K ? P.height : F),
          }),
          tt = _.width,
          it = _.height;
        (tt = Math.min(V.width, Math.max(J.width, tt))),
          (it = Math.min(V.height, Math.max(J.height, it)));
        ...
        ut <= -Z || mt < ut
          ? (lt = ct = rt = ut = 0)
          : ut <= 0
          ? ((ct = -ut), (ut = 0), (lt = rt = Math.min(mt, Z + ut)))
          : ut <= mt && ((ct = 0), (lt = rt = Math.min(Z, mt - ut))),
          rt <= 0 || ft <= -F || gt < ft
            ? (pt = dt = st = ft = 0)
            : ft <= 0
            ? ((dt = -ft), (ft = 0), (pt = st = Math.min(gt, F + ft)))
            : ft <= gt && ((dt = 0), (pt = st = Math.min(F, gt - ft)));
        var vt = [ut, ft, rt, st];
        if (0 < lt && 0 < pt) {
          var wt = tt / Z;
          vt.push(ct * wt, dt * wt, lt * wt, pt * wt);
        }
        return (
          at.drawImage.apply(
            at,
      ...
      setDragMode: function (t) {
        ...
        if (this.ready && !this.disabled) {
          ...
          (t = n || o ? t : v),
            ...
            rt(e, r, n),
            rt(e, m, o),
            i.cropBoxMovable || (lt(a, g, t), rt(a, r, n), rt(a, m, o));
        }
        return this;
      },
    },
                  ...
                  if (q.test(t))
                    $.test(t)
                      ? this.read(
                          ...
                          tt((r = new Uint8Array(h)), function (t, i) {
                            r[i] = o.charCodeAt(i);
                          }),
                          h)
                        )
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (1 < a) {
                this.url = (function (t, i) {
                  for (var e = [], a = new Uint8Array(t); 0 < a.length; )
                    e.push(Et.apply(void 0, bt(a.subarray(0, 8192)))),
                      (a = a.subarray(8192));
                  return "data:".concat(i, ";base64,").concat(btoa(e.join("")));
                })(t, U);
                var r = (function (t) {
                  var i = 0,
                    e = 1,
              ...
              i.rotatable && (e.rotate = n),
                i.scalable && ((e.scaleX = o), (e.scaleY = h)),
                this.clone();
            },
          },
          {
            ...
            value: function () {
              ...
              this.options.checkCrossOrigin &&
                Mt(a) &&
                (i = (t = e.crossOrigin) ? a : ((t = "anonymous"), Ct(a))),
                (this.crossOrigin = t),
            ...
            value: function () {
              if (this.sized && !this.ready) {
                ...
                var o = n.querySelector(".".concat(d, "-container")),
                  h = o.querySelector(".".concat(d, "-canvas")),
                  r = o.querySelector(".".concat(d, "-drag-box")),
                ...
                (this.container = a),
                  ...
                  (this.dragBox = r),
                  (this.cropBox = s),
                  (this.viewBox = o.querySelector(".".concat(d, "-view-box"))),
                  (this.face = c),
                  h.appendChild(e),
                  ot(t, S),
                  ...
                  ot(s, S),
                  i.guides ||
                    ot(s.getElementsByClassName("".concat(d, "-dashed")), S),
                  i.center ||
                    ot(s.getElementsByClassName("".concat(d, "-center")), S),
                  i.background && ot(o, "".concat(d, "-bg")),
                  i.highlight || ot(c, p),
                  i.cropBoxMovable && (ot(c, m), lt(c, g, k)),
                  i.cropBoxResizable ||
                    (ot(s.getElementsByClassName("".concat(d, "-line")), S),
                    ot(s.getElementsByClassName("".concat(d, "-point")), S)),
                  this.render(),
                  (this.ready = !0),
                  this.setDragMode(i.dragMode),
                  i.autoCrop && this.crop(),
                  this.setData(i.data),
                  _(i.ready) && ut(t, B, i.ready, { once: !0 }),
                  ft(t, B);
              }
            },
          },
  ...
  return it(St.prototype, Ht, Lt, Ot, zt, Yt, Xt), St;
});
