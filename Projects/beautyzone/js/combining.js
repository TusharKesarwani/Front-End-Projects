  ...
  (function (t, e) {
    ...
    var s,
      a = (function () {
        ...
        for (
          var t = ["Winkit", "moz", "ms", "o"], i = 0, n = t.length;
          n > i;
          i++
        ) {
          var o = t[i],
...
var BeautyZone = (function () {
  ...
  var e = $(window).width(),
    t = function (e) {
      ...
      jQuery(".navbar-nav-scroll > li").each(function () {
        var e = jQuery(this).find("a:first"),
          ...
          n = parseInt($(".main-bar").css("height"), 10);
        r.offset().top - n - 20 <= t && r.offset().top + r.height() > t
    ...
    i = function (e) {
      ...
      $(e).each(function () {
        if (
          ...
          (i.length = 0), (n = topPostion), (r = t.height()), i.push(t);
    ...
    a = function () {
      ...
      e > 1280 &&
        jQuery(".footer-fixed > .page-wraper").css("padding-bottom", t),
        jQuery(".site-footer").css("height", t);
    },
    o = function () {
      "use strict";
      var t = [];
  ...
  return {
      ...
      jQuery(".box-hover").on("mouseenter", function () {
        ...
        (function () {
          ...
          if (
            ...
            jQuery(document).on("scroll", t);
            var r = parseInt($(".main-bar").css("height"), 10);
        ...
        jQuery(window).on("resize", function () {
          jQuery(".modal:visible").each(l),
            jQuery(".equal-wraper").length && i(".equal-wraper .equal-col"),
            a();
        }),
        ...
        (function () {
          if ($("#smartwizard").length > 0) {
            $("#smartwizard").on("showStep", function (e, t, r, n, i) {
              "first" === i
            ...
            $("#smartwizard").smartWizard({
              ...
              $("#theme_selector").on("change", function () {
                return (
                  $("#smartwizard").smartWizard("theme", $(this).val()), !0
                );
              }),
        ...
        (function () {
          ...
          $(".dz-demo-trigger").on("click", function () {
            ...
            $(".dz-demo-close, .bg-close,.dz_theme_demo").on(
              "click",
              function () {
    ...
    load: function () {
      e > 1023 &&
        ...
        jQuery("input[name='demo_vertical2']").length &&
          jQuery("input[name='demo_vertical2']").TouchSpin({
            verticalbuttons: !0,
            verticalupclass: "ti-plus",
            verticaldownclass: "ti-minus",
          }),
        i(".equal-wraper .equal-col"),
...
jQuery(document).ready(function () {
  ...
  e
    ...
    .on("changed.owl.carousel", function (e) {
      ...
      var s = a.find(".owl-item.active").length - 1,
        l = a.find(".owl-item.active").first().index(),
        o = a.find(".owl-item.active").last().index();
      t > o && a.data("owl.carousel").to(t, 100, !0);
      t < l && a.data("owl.carousel").to(t - s, 100, !0);
    }),
    a
