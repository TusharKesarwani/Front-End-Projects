...
function App() {
  return (
    <div className="app">
      ...
      {/* Reels Text */}
      // Certain test videos for working however Coonecting to firebase is
      preffered
      <div className="app__videos">
        ...
        <VideoCard
          url={
            "https://mobstatus.com/wp-content/uploads/2022/09/Indian-cricket-team-attitude-_-Whatsapp-attitude-status_-_shorts-_motivation-_india-_attitude720P_HD.mp4"
          }
          likes={2000}
          shares={80}
          channel={"Sports Info"}
