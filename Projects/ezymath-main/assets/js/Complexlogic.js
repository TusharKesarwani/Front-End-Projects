function Complex(real, imaginary) {
  ...
  this.imaginary =
    typeof imaginary === "undefined" ? this.imaginary : parseFloat(imaginary);
}
...
function complexDiv(first, second) {
  ...
  var imaginary =
    (num2.real * num1.imaginary - num1.real * num2.imaginary) / denom;
  return display(real, imaginary);
}

function add() {
  var a = new Complex(
    document.getElementById("creal1").value,
    document.getElementById("cimg1").value
  );
  var b = new Complex(
    document.getElementById("creal2").value,
    document.getElementById("cimg2").value
  );
...
function mag() {
  var x = new Complex(
    document.getElementById("creal").value,
...
function arg() {
  ...
  let explain =
    "\\[Argument =tan^{-1}\\frac{imaginary}{real}\\]" +
    "\\[Argument =tan^{-1}\\frac{" +
    x.imaginary +
    "}{" +
    x.real +
    "}=tan^{-1}" +
    (x.imaginary / x.real).toFixed(3) +
    "\\]";
  explain += "\\[Argument =" + ans + "\\space radians\\]";
  document.getElementById("comresult").innerHTML =
    "Argument is &nbsp;" + ans + "&nbsp; radians";
  document.getElementById("comexplain").innerHTML = explain;
  renderMathInElement(document.getElementById("comexplain"));
}
function conj() {
  ...
  if (x.imaginary >= 0) {
    explain =
      "\\[Conjugate = real\\space+ \\space(-1)*imaginary \\]" +
      "\\[Conjugate = " +
      x.real +
      "+" +
      x.imaginary +
      " i\\]";
    document.getElementById("comresult").innerHTML =
      "Conjugate is &nbsp;" + x.real + "&nbsp; +" + x.imaginary + "i";
  } else {
    explain =
      "\\[Conjugate = real\\space+ \\space(-1)*imaginary \\]" +
      "\\[Conjugate = " +
...
function volofsphere() {
  ...
  if (x != "") {
    document.getElementById("sphereAns").innerHTML =
      "\\[Percentage \\space increase \\space in \\space the \\space volume \\space of \\space the \\space sphere \\space is \\space\\]";
    document.getElementById("sphereAns1").innerHTML =
      "\\[\\frac{(change \\space in \\space radius)^3}{10000} + 3\\times (change \\space in \\space radius) + \\frac{(3 \\times (change \\space in \\space radius)^2)}{100}\\]";
    ...
    document.getElementById("sphereAns3").innerHTML =
      "\\[ " +
      (Math.pow(x, 3) / 10000).toFixed(2) +
      " + " +
      (3 * x).toFixed(2) +
      " + " +
      ((3 * Math.pow(x, 2)) / 100).toFixed(2) +
      " \\space = \\space " +
      per.toFixed(3) +
      " \\% \\]";
  } else {
...
function sqr_rt() {
  let explain =
    "\\[From\\space De\\space Moivre's\\space Formula,\\space z^n=(r^n)(cos(n\\theta)+i \\space sin(n\\theta))\\]" +
    "\\[So,\\space \\sqrt{z}=\\sqrt{r}(cos(\\frac{\\theta}{2})+i \\space sin(\\frac{\\theta}{2}))\\]";
  explain +=
    "\\[where, \\space r=\\sqrt{real^2+imaginary^2} \\space\\space , \\space \\space \\theta=tan^{-1}\\frac{imaginary}{real}\\]";
  var x = new Complex(
    document.getElementById("creal").value,
    document.getElementById("cimg").value
  );
  ...
  explain +=
    ...
    ")^2}=" +
    r +
    "\\space \\space , \\space \\space \\theta=tan^{-1}\\frac{" +
    x.imaginary +
    "}{" +
    x.real +
    "}=" +
...
function volofcuboid() {
  ...
  if (l != "" && b != "" && h != "") {
    document.getElementById("cuboidAns").innerHTML =
      "\\[Percentage \\space increase \\space in \\space the \\space volume \\space of \\space the \\space cuboid \\space is \\space\\]";
    document.getElementById("cuboidAns1").innerHTML =
      "\\[((1 + \\frac{Change \\space in \\space length}{100}) \\times (1 + \\frac{Change \\space in \\space breadth}{100}) \\times (1 + \\frac{Change \\space in \\space height}{100}) -1 ) \\times 100\\]";
    ...
    document.getElementById("cuboidAns3").innerHTML =
      ...
      " \\times " +
      (1 + h / 100).toFixed(2) +
      "-1 ) \\times 100 \\space = \\space " +
      percentInc.toFixed(3) +
      " \\% \\]";
  } else {
    document.getElementById("cuboidAns").innerHTML = "";
    document.getElementById("cuboidAns1").innerHTML =
...
function euler() {
  ...
  if (!isNaN(r) && !isNaN(i)) {
    ...
    explain +=
      "\\[\\theta=tan^{-1}\\frac{" + i + "}{" + r + "}\\space radians=";
    if (y < 0) {
    ...
    document.getElementById("compeexplain").innerHTML =
      "\\[Please \\space enter \\space valid \\space input\\]";
    result.innerHTML = "";
  }
...
function npower() {
  ...
  var y = Math.atan(i / r);
  explain +=
    "\\[argument(\\theta)=tan^{-1}\\frac{" + i + "}{" + r + "}\\space radians=";
  if (i >= 0) result = "\\[(" + r + "+" + i + "i)^" + n;
  else result = "\\[(" + r + i + "i)^" + n;

  if (r > 0 && i < 0) y = y + 6.28319;
  else if (r < 0 && i > 0) y = y + 3.14159;
  y = y.toFixed(3);

  explain += y + "radians\\]";
  explain +=
    "\\[2.By \\space De  \\space Moivre's  \\space Theorem,\\space z^n=(r^n)(cos(n\\theta)+i \\space sin(n\\theta))\\]";
  explain +=
    "\\[(" +
    r +
    "+" +
  ...
  explain +=
    "\\[\\space \\space \\space =" + x + "(cos(" + y + ")+isin(" + y + "))\\]";
...
function samvar() {
  ...
  if (num == "") {
    ...
    document.getElementById("std-var-rslt").innerHTML =
      "Enter space separated numbers. Use of alphabets and special character is not allowed for calculation purpose";
  } else {
    var outputstring = "";
    num = num.trim();
    num = num.split(" ");
    ...
    outputstring +=
      "Sample Standard Deviation: " + sampstddev + " <p>&nbsp;</p>";
    outputstring +=
      "Confidence Interval(s" + text.sub() + "): " + conint + "<br>";
...
function popvar() {
  ...
  if (num == "") {
    ...
    outputstring += "Variance(σ" + text2.sub() + "): " + varrzlt + "<br>";
    outputstring +=
      "Population Standard Deviation: " + sampstddev + " <p>&nbsp;</p>";
    outputstring +=
      "Confidence Interval(s" + text.sub() + "): " + conint + "<br>";
...
function hydrocal() {
  ...
  if (a === "" || b == "") {
    ...
    document.getElementById("hydroans1").innerHTML =
      "\\[p \\space = \\space ρ \\space \\times g \\times h \\space + \\space p0\\]";
    document.getElementById("hydroans2").innerHTML =
      "\\[p \\space = \\space " +
      b +
      " \\space \\times 9.806 \\times " +
      a +
      " \\space + 1.013 \\space \\]";
    document.getElementById("hydroans3").innerHTML =
      "\\[p \\space = " +
      (b * 9.80655 * a).toFixed(3) +
      " \\space + \\space 1.013 = \\space " +
      prs.toFixed(3) +
      "\\]";
    ...
    document.getElementById("hydroans4").innerHTML =
      "\\[Your \\space answer \\space is \\space : \\space " +
      prs.toFixed(3) +
      " \\space atm\\]";
    renderMathInElement(document.getElementById("hydroans4"));
    ans =
      "Our hydrostatic pressure calculator uses the below hydrostatic pressure formula <br>    p = ρ * g * h + p0 where <br>  p is the hydrostatic pressure, ρ is the density of fluid,<br>  g is the gravitational acceleration (the average value for the Earth is g = 9.80655 m/s²), <br>   h is the depth,<br> p0 is the external pressure (usually atmospheric pressure p0 = 1 atm = 1013.25 hPa).";
  }
...
function straincal() {
  ...
  if (a == "" || b == "") {
    ...
    ans +=
      "Strain is a measure of a materials dimensions due to a load deformation. It takes the initial length and the extension of that length due to the load and creates a ratio of the two.<br>  ε= Δl/l<br> Where: <br>   ε = Strain<br>Δl = Change in length<br>l = Length";
  }
...
function hp() {
  ...
  if (a == "" || d == "" || n == "") {
    ...
    printemp +=
      "\\[Sum \\space of \\space Nterms \\space of \\space HP \\space = \\space \\frac{1}{d} ln \\frac{2a+(2n-1)d}{2a-d} \\]";
    printemp +=
      "\\[S_n \\space = \\space \\frac{1}{" +
      d +
      "} ln \\frac{2*" +
      a +
      "+(2*" +
    ...
    printemp +=
      "\\[Enter \\space numbers \\space only. \\space Blank \\space inputs \\space are \\space not \\space allowed \\]";
    printseries.innerHTML = printemp;
    renderMathInElement(printseries);
  }
}
...
function bpcal(op) {
  ...
  if (a == "" || b == "" || c == "") {
    ...
    ans =
      "Input Error: Successful events can't be greater than total number of trials.";
  } else {
    if (op === 1) {
...
function arcal() {
  ...
  if (a == "" || b == "") {
    document.getElementById("arcans1").innerHTML =
      "\\[Error: \\space All \\space values \\space are \\space required \\space to \\space obtain \\space answer\\]";
    renderMathInElement(document.getElementById("arcans1"));
    document.getElementById("arcans2").innerHTML = "";
    document.getElementById("arcans3").innerHTML = "";
    document.getElementById("arcans4").innerHTML = "";
    document.getElementById("arcans5").innerHTML = "";
    document.getElementById("arcans6").innerHTML = "";
    return;
  } else {
    if (d == "degree") {
      b /= 57.296;
      document.getElementById("arcans1").innerHTML =
        "\\[\\frac{\\theta \\space (degree)}{57.296} \\space = " +
        b.toFixed(2) +
        " \\space (radian)\\]";
      renderMathInElement(document.getElementById("arcans1"));
    } else {
    ...
    if (y == "cm") {
      c = c / 100;
      document.getElementById("arcans3").innerHTML =
        "\\[\\frac{Arc \\space length \\space (m)}{100} = \\space " +
        c.toFixed(3) +
        " \\space cm\\]";
      ...
      c = c / 1000;
      document.getElementById("arcans4").innerHTML =
        "\\[\\frac{Arc \\space length \\space (m)}{1000} = \\space " +
        c.toFixed(3) +
        " \\space mm\\]";
      ...
      c = c / 0.0254;
      document.getElementById("arcans5").innerHTML =
        "\\[\\frac{Arc \\space length \\space (m)}{0.0254} = \\space " +
        c.toFixed(3) +
        " \\space inch\\]";
    ...
    document.getElementById("arcans6").innerHTML =
      "\\[The \\space Arc \\space length \\space is: \\space " +
      c.toFixed(3) +
      " \\space " +
      y +
      "\\]";
...
function cresccal() {
  ...
  if (r1 == "" || r2 == "" || d == "") {
    document.getElementById("crescans1").innerHTML =
      "\\[Error: \\space All \\space values \\space are \\space required \\space to \\space obtain \\space answer \\space\\]";
    ...
    if (
      !isNaN(Math.acos((r2 ** 2 - r1 ** 2 - d ** 2) / (2 * r1 * d))) &&
      !isNaN(Math.acos((r2 ** 2 + d ** 2 - r1 ** 2) / (2 * r2 * d)))
    ) {
      var lune1 = Math.trunc(
        2 *
          (Math.sqrt(
            (r1 + r2 + d) * (r2 + d - r1) * (d + r1 - r2) * (r1 + r2 - d)
          ) /
            4) +
          r1 ** 2 * Math.acos((r2 ** 2 - r1 ** 2 - d ** 2) / (2 * r1 * d)) -
          r2 ** 2 * Math.acos((r2 ** 2 + d ** 2 - r1 ** 2) / (2 * r2 * d))
      );
      var op = Math.trunc(Math.PI * r1 ** 2 - lune1);
      var lune2 = Math.trunc(Math.PI * r2 ** 2 - op);
      document.getElementById("crescans1").innerHTML =
        "\\[r1 = Radius \\space of \\space circle \\space 1 \\space = \\space " +
        r1 +
        " \\newline r2 = Radius \\space of \\space circle \\space 2 \\space = \\space " +
        r2 +
        " \\newline d = Circle \\space center \\space distance \\space = \\space " +
        d +
        "\\]";
      document.getElementById("crescans2").innerHTML =
        "\\[Area \\space of \\space Lune \\space 1: \\newline 2 \\times \\frac{\\sqrt{(r1 + r2 + d) \\times (r2 + d - r1) \\times (d + r1 - r2) \\times (r1 + r2 - d)} }{4} + \\newline r1^2 \\times acos(\\frac{(r2^2 - r1^2 - d^2)}{(2^r1 \\times d)}) - r2^2 \\times acos(\\frac{(r2^2 + d^2 - r1^2)}{ (2 \\times r2 \\times d)})\\]";
      document.getElementById("crescans3").innerHTML =
        "\\[2 \\times \\frac{\\sqrt{(" +
        r1 +
        " + " +
        ...
        lune1.toFixed(3) +
        "\\]";
      document.getElementById("crescans5").innerHTML =
        "\\[Overlap \\space Area: \\space \\newline \\pi \\times r1^2 - (Area \\space of \\space Lune \\space 1) \\newline " +
        math.pi.toFixed(2) +
        " \\times " +
        r1 +
        "^2 - (" +
        ...
        op.toFixed(3) +
        "\\]";
      document.getElementById("crescans6").innerHTML =
        "\\[ Area \\space of \\space Lune \\space 2:  \\space \\newline \\pi \\times r1^2 - (Overlap \\space Area) \\newline " +
        math.pi.toFixed(2) +
        " \\times " +
        r2 +
        "^2 - (" +
...
function sspncal() {
  ...
  if (!valid.test(num)) {
    powertemp +=
      "\\[Enter \\space any \\space numbers. \\space Use \\space of \\space alphabets \\space and \\space special \\space character \\space is \\space not \\space allowed \\space for \\space calculation \\space purpose \\]";
    poweroutput.innerHTML = powertemp;
    renderMathInElement(poweroutput);
  } else if (num < 1) {
    powertemp +=
      "\\[Natural \\space Numbers \\space cannot \\space be \\space negative \\]";
    poweroutput.innerHTML = powertemp;
    renderMathInElement(poweroutput);
  } else {
    var powersum = Math.trunc(
      num * (num + 1) * (2 * num + 1) * (3 * num ** 2 + 3 * num - 1)
    );
    var powersum1 = powersum / 30;
    powertemp +=
      "\\[Sum \\space of \\space the \\space Power \\space Four \\space of \\space the \\space First \\space n \\space Natural \\space Numbers \\space is \\]";
    powertemp +=
      "\\[ \\sum {n}^4 \\space = \\space \\frac{n(n+1)(2n+1)(3n^2+3n-1)}{30}  \\]";
    powertemp +=
      "\\[\\sum {n}^4 \\space = \\space \\frac{" +
      num +
      "(" +
      num +
      " + 1)(2 \\times" +
    ...
    powertemp +=
      ...
      "}{30}  \\]";
    powertemp +=
      "\\[\\sum {n}^4 \\space = \\space \\frac{" + powersum + "}{30} \\]";
...
function ssfncal() {
  ...
  if (!valid.test(num)) {
    ...
    var powersum = Math.trunc(
      num ** 2 * (num + 1) ** 2 * (2 * num ** 2 + 2 * num - 1)
    );
    var powersum1 = powersum / 12;
    powertemp +=
      "\\[Sum \\space of \\space the \\space Power \\space Five \\space of \\space the \\space First \\space n \\space Natural \\space Numbers \\space is \\]";
    powertemp +=
      "\\[ \\sum {n}^5 \\space = \\space \\frac{n^2 (n+1)^2 (2n^2 + 2n -1 )}{12}  \\]";
    powertemp +=
      "\\[ \\sum {" +
      num +
      "}^5 \\space = \\space \\frac{" +
...
function ssqncal() {
  ...
  if (num == "") {
    ...
    s +=
      "\\[Enter \\space space \\space separated \\space numbers. \\space Use \\space of \\space alphabets \\space and \\space special \\space character \\space is \\space not \\space allowed \\space for \\space calculation \\space purpose \\]";
    soutput.innerHTML = s;
    renderMathInElement(soutput);
  } else if (num < 1) {
    s +=
    ...
    var sum1 = sum / 6;
    s +=
      "\\[Sum \\space of \\space the \\space Squares \\space of \\space the \\space First \\space n \\space Natural \\space Numbers \\space is \\]";
    s += "\\[ \\sum {n}^2 \\space = \\space \\frac{n(n+1)(2n+1)}{6}  \\]";
    s +=
      "\\[\\sum {n}^2 \\space = \\space \\frac{" +
      num +
      "(" +
      num +
      " + 1)(2 \\times" +
...
function scbncal() {
  ...
  if (num == "") {
    ...
    var sum2 = sum1 ** 2;
    stemp +=
      "\\[Sum \\space of \\space the \\space Cubes \\space of \\space the \\space First \\space n \\space Natural \\space Numbers \\space is \\]";
    stemp += "\\[ \\sum {n}^3 \\space = \\space (\\frac{n(n+1)}{2})^2  \\]";
    stemp +=
      "\\[\\sum {n}^3 \\space = \\space (\\frac{" +
      num +
      "(" +
      num +
      " + 1)}{2})^2 \\]";
...
function ssncal() {
  ...
  if (num == "") {
    ...
    var sum1N = sumN / 2;
    sumtemp +=
      "\\[Sum \\space of \\space the \\space First \\space n \\space Natural \\space Numbers \\space is \\]";
    sumtemp += "\\[ \\sum {n} \\space = \\space \\frac{n(n+1)}{2}  \\]";
    sumtemp +=
      "\\[ \\sum {n} \\space = \\space \\frac{" +
      num +
      "(" +
      num +
      " + 1)}{2} \\]";
...
function sencal() {
  ...
  if (num == "") {
    ...
    var sumN = Math.trunc(num * (num + 1));
    sumtemp +=
      "\\[Sum \\space of \\space the \\space First \\space n \\space Even \\space Natural \\space Numbers \\space is \\]";
    sumtemp += "\\[ \\sum {2n} \\space = \\space n(n+1)  \\]";
    sumtemp +=
      "\\[ \\sum {2n} \\space = \\space " + num + "(" + num + " + 1) \\]";
    sumtemp +=
      "\\[ \\sum {2n} \\space = \\space " +
      num +
      "\\times" +
...
function ssoncal() {
  ...
  if (num == "") {
    ...
    var sumCN = num ** 2;
    sumtemp1 +=
      "\\[Sum \\space of \\space the \\space First \\space n \\space Odd \\space Natural \\space Numbers \\space is \\]";
...
function squaresRangecal() {
  ...
  if (num1 == "" || num2 == "") {
    ...
    print +=
      "STEP1 : Take square root ( only integer part )of the two given inputs<br>";
    print +=
      "So,square root of &nbsp;" +
      num1 +
      "&nbsp; = &nbsp;" +
      ...
      "<br>";
    print +=
      "<br>STEP2 : Print squares of &nbsp;" +
      sqrt1 +
      "&nbsp; to &nbsp;" +
      sqrt2 +
      "&nbsp; that comes under the range of &nbsp;" +
      sqrt1 +
      "&nbsp; and &nbsp;" +
      sqrt2 +
      "&nbsp; <br> (including &nbsp;" +
      ...
      "&nbsp; and &nbsp;" +
      sqrt2 +
      "&nbsp; both if their squares also are in range)<br><br>";
...
function cubesRangecal() {
  ...
  if (num1 == "" || num2 == "") {
    ...
    cbrt2 = Math.trunc(Math.cbrt(num2));
    print +=
      "STEP1 : Take cube root ( only integer part )of the two given inputs<br>";
    print +=
      "So,Cube root of &nbsp;" +
      num1 +
      "&nbsp; = &nbsp;" +
    ...
    print +=
      ...
      "&nbsp; and &nbsp;" +
      cbrt2 +
      "&nbsp; both if their cubes also are in range)<br><br>";
    for (var i = cbrt1; i <= cbrt2; i++) {
      if (i ** 3 >= num1 && i ** 3 <= num2) {
        var ans = i ** 3;
        pr += ans.toString() + "   ";
...
function segcal() {
  ...
  if (a == "" || b == "") {
    ans +=
      "\\[Enter \\space all \\space the \\space values \\space to \\space obtain \\space answer \\]";
    ...
    if (c == "degree") {
      ...
      ans +=
        ...
        " \\]";
      ans +=
        "\\[Area \\space of \\space segment \\space in \\space degrees \\space is \\space " +
        a * a * ((Math.PI / 180) * (b - t)) * 0.5 +
        " \\]";
      output.innerHTML = ans;
    } else {
      var t = Math.sin(b);
      ...
      ans +=
        "\\[Area \\space of \\space segment \\space in \\space radian \\space is \\space " +
        area +
        " \\]";
      output.innerHTML = ans;
    }
...
function impcal() {
  ...
  if (a == "" || b == "") {
    document.getElementById("impans").innerHTML =
      "\\[Enter \\space all \\space the \\space required \\space inputs \\space to \\space obtain \\space answer\\]";
    renderMathInElement(document.getElementById("impans"));
  } else if (b >= a) {
    document.getElementById("impans").innerHTML =
      "\\[The \\space value \\space of \\space numerator \\space must \\space be \\space greater \\space than \\space be \\space denominator\\]";
    renderMathInElement(document.getElementById("impans"));
  } else if (b == 0) {
    document.getElementById("impans").innerHTML =
      "\\[The \\space value \\space of \\space denominator \\space cannot \\space be \\space 0\\]";
    renderMathInElement(document.getElementById("impans"));
  } else {
    var r = a % b;
    var q = (a - r) / b;
    document.getElementById("impans").innerHTML =
      "\\[The \\space required \\space answer \\space is: \\space" +
      q +
      " \\space \\frac{" +
      r +
      "}{" +
...
function hpcal() {
  ...
  if (x == "" || y == "" || z == "") {
    ...
    var num6 = 1 / numb;
    anstemp +=
      "\\[nth \\space Term \\space of \\space HP \\space = \\space \\frac{1}{a+(n-1)d} \\]";
    anstemp +=
      "\\[nth \\space Term \\space of \\space HP \\space = \\space \\frac{1}{" +
      x +
      "+ (" +
      y +
      " - 1)" +
      ...
      "} \\]";
    anstemp +=
      "\\[nth \\space Term \\space of \\space HP \\space = \\space" +
      num6.toFixed(3) +
      "\\]";
    ansout.innerHTML = anstemp;
    renderMathInElement(ansout);
...
function hpcal11() {
  ...
  if (!isNaN(parseInt(x)) && !isNaN(parseInt(y)) && !isNaN(parseInt(z))) {
    ...
    var num6 = 1 / numb;
    anstemp +=
      "\\[nth \\space Term \\space of \\space HP \\space from \\space End \\space = \\space \\frac{1}{l-(n-1)d} \\]";
    anstemp +=
      "\\[nth \\space Term \\space of \\space HP \\space from \\space End \\space = \\space \\frac{1}{" +
      x +
      "- (" +
      y +
      " - 1) \\times" +
      ...
      "} \\]";
    anstemp +=
      "\\[nth \\space Term \\space of \\space HP \\space from \\space End \\space = \\space" +
      num6.toFixed(3) +
      "\\]";
    ansout.innerHTML = anstemp;
  } else {
...
function eircal() {
  ...
  if (a == "" || b == "" || c == "") {
    ...
    var x = R / 100;
    ans =
      "\\[Interest \\space Rate \\space per \\space period = \\frac{R}{100} = \\frac{" +
      R +
      "}{100} = " +
      x +
      "\\]";
    ...
    ans +=
      "\\[Effective \\space interest \\space rate \\space per \\space period(i) \\space \\] \\[=(1+ \\frac{r}{m})^{m}-1\\]";
    ans += "\\[=(1+\\frac{" + x + "}{" + z + "})^{" + z + "}-1\\]";
    ans += "\\[=" + rate_period + "\\]";
    ans +=
      "\\[Effective \\space interest \\space Rate \\space per \\space period(i \\%)=" +
      rate_period +
      "\\space X \\space 100=" +
      rate_p +
      "\\% \\]";
    ans +=
      "\\[Effective \\space Interest \\space rate \\space for \\space m \\space periods(i_t) \\space \\]";
    ...
    ans += "\\[= \\space " + rate + "\\]";
    ans +=
      "\\[Effective \\space Interest \\space rate \\space for \\space m \\space periods(i_t \\%)=" +
      rate +
...
function errpercal() {
  ...
  if (a == "" || b == "") {
    document.getElementById("errperans").innerHTML =
      "\\[Please \\space enter \\space all \\space the \\space values\\]";
    ...
    var c = ((b - a) / a) * 100;
    document.getElementById("errperans1").innerHTML =
      "\\[Percentage \\space Error = \\frac{Observed \\space value - \\space True \\space value}{True \\space value} \\times 100 \\]";
    ...
    document.getElementById("errperans2").innerHTML =
      ...
      ")}{" +
      a +
      "} \\times 100 \\space = \\space \\frac{(" +
      (b - a) +
      ")}{" +
      a +
      "} \\times 100 \\space = \\space " +
      ((b - a) / a).toFixed(2) +
      " \\times 100\\]";
    renderMathInElement(document.getElementById("errperans2"));
    document.getElementById("errperans").innerHTML =
      "\\[Hence, \\space the \\space error \\space percentage \\space is \\space = \\space" +
      c.toFixed(3) +
      "%\\]";
    renderMathInElement(document.getElementById("errperans"));
  }
...
function confidence() {
  ...
  if (z === "Select Z value") {
    ...
    s =
      "Use of alphabets and special character is not allowed for calculation purpose";
  } else {
    if (z === "80%") {
      zval = 1.282;
    } else if (z === "85%") {
...
function unitcircCal() {
  ...
  if (deg == "" || isNaN(deg)) {
    document.getElementById("unitcircxans").innerHTML =
    ...
    document.getElementById("unitcircxans").innerHTML =
      "\\[X: " + x + "\\newline Y:  " + y + "\\]";
    document.getElementById("unitcircyans").innerHTML =
      "\\[X \\space =cos(" +
      deg +
      "\\degree )=" +
      x +
...
function dbltimeCal() {
  ...
  document.getElementById("dbltimeans").innerHTML =
    "\\[Doubling \\space Time \\space is \\space \\space \\frac{log \\space (2) }{log \\space (1 + (\\% \\space per \\space period \\space increase)) } \\space \\space that \\space is, \\]";
  renderMathInElement(document.getElementById("dbltimeans"));
  document.getElementById("dbltimeans1").innerHTML =
    "\\[\\frac{log \\space (2)}{log \\space (1 + (" +
    inc +
    ")) } \\space = \\space " +
    ans.toFixed(3) +
    " \\space periods\\]";
...
function perchngCal() {
  ...
  if (!isNaN(initial) && !isNaN(final)) {
    ...
    temp +=
      "\\[The \\space Percentage \\space change \\space will \\space be,\\]";
    temp +=
      "\\[\\space = \\space \\frac{((Final value) - (Initial value))}{ |(Initial value)| } \\times 100\\]";
    temp +=
      "\\[\\space = \\space \\frac{((" +
      final +
      ") - (" +
    ...
    temp +=
      "\\[\\space = \\space " +
      ((final - initial) / Math.abs(initial)).toFixed(2) +
      " \\times 100\\]";
...
function peroffCal() {
  ...
  if (!isNaN(original) && !isNaN(tax) && !isNaN(off)) {
    temp1 +=
      "\\[The \\space Percentage \\space Off \\space will \\space be,\\]";
    temp1 +=
      "\\[First, \\space we \\space calculate \\space the \\space final \\space value\\]";
    temp1 +=
      "\\[Final \\space Price \\space = \\space (Original \\space Price) +  ( (Original \\space Price) \\times \\frac{(Tax \\space value)}{100} ) \\times \\frac{(Off \\space value)}{100}\\]";
    temp1 +=
      "\\[\\space = \\space (" +
      original +
      ") +  ( (" +
    ...
    temp1 +=
      ...
      original +
      ") +  ( " +
      (original * (tax / 100)).toFixed(2) +
      " ) \\times " +
      (off / 100).toFixed(2) +
      "\\]";
    temp1 +=
      "\\[\\space = \\space " +
      (original * (original * (tax / 100))).toFixed(2) +
      "  \\times " +
      (off / 100).toFixed(2) +
      "\\]";
    ...
    temp2 +=
      "\\[Finally,\\space we \\space subtract \\space this \\space (Final \\space Price) \\space value \\space from \\space the \\space (Orginal \\space Price)\\]";
    temp2 +=
      "\\[Savings \\space = \\space (Orginal \\space Price) \\space - \\space (Final \\space Price)\\]";
    temp2 +=
      "\\[\\space = \\space " + original + " - " + final.toFixed(2) + "\\]";
...
function covcalcu() {
  ...
  if (num1 == "" || num2 == "") {
    ...
    s =
      "\\[Enter \\space space \\space separated \\space numbers. \\space Use \\space of \\space alphabets \\space and \\space special \\space character \\space is \\space not \\space allowed\\]";
    output.innerHTML = s;
    renderMathInElement(output);
    return;
  } else {
    ...
    if (len1 == 1 || len2 == 1) {
      s =
        "\\[Please \\space enter \\space more \\space than \\space value \\space for \\space each \\space data \\space set\\]";
      output.innerHTML = s;
      renderMathInElement(output);
      return;
    }
    if (len1 != len2) {
      s =
        "\\[Your \\space datasets \\space X \\space and \\space Y \\space contain \\space different \\space numbers \\space of \\space element\\]";
      output.innerHTML = s;
      renderMathInElement(output);
      return;
    } else {
      ...
      s +=
        "\\[Calculate the mean value for xi by adding all values and dividing them by sample size\\]";
      s +=
        "\\[Calculate the mean value for yi by adding all values and dividing them by sample size\\]";
      s +=
        "\\[Now, calculate the x diff. It can be calculated by subtracting each element of x from the mean value of x\\]";
      s +=
        "\\[Do the same for y, calculate ydiff by subtracting all values of y from the mean value of y\\]";
      s +=
        "\\[ Multiply all values of xdiff and ydiff and place them in a new column\\]";
      s +=
        "\\[Add the last column values, which are the product of the two differences. Divide by the sample size,\\]";
      ...
      s +=
        "\\[he value after dividing by sample size is covariance, which is " +
        cov +
        " in this case\\]";
      s +=
        "\\[The \\space calculated \\space covariance \\space is:\\space " +
        cov +
        "\\]";
      output.innerHTML = s;
      renderMathInElement(output);
...
function covcal() {
  ...
  if (num == "") {
    ...
    if (len == 1) {
      s =
        "\\[Please \\space enter \\space more \\space than \\space one \\space value\\]";
      return;
    }
    var number = [];
    for (var i = 0; i < len; i++) {
    ...
    var sum = 0;
    s +=
      "\\[First, \\space take \\space a \\space loop \\space upto \\space the \\space length \\space of \\space dataset, " +
      len +
      "\\]";
    s +=
      "\\[And, \\space add \\space all \\space of \\space the \\space data \\space in \\space dataset\\]";
    for (i = 0; i < len; i++) {
      sum = sum + number[i];
    }
    var mean = sum / len;
    s +=
      "\\[We \\space get \\space the \\space sum \\space here \\space " +
      sum +
      " \\space\\]";
    s +=
      "\\[Then \\space we \\space divide \\space this \\space sum \\space by \\space the \\space length \\space the \\space dataset\\]";
    s +=
      "\\[\\space Mean \\space = \\space \\frac{" + sum + "}{" + len + "}\\]";
    ...
    s +=
      "\\[Then \\space we \\space take \\space a \\space loop \\space where \\space each \\space data \\space from \\space dataset \\space is\\]";
    s +=
      "\\[Substracted \\space and \\space squared, \\space we \\space get, \\space " +
      varrzlt.toFixed(2) +
      " \\space as \\space the \\space value\\]";
    varrzlt = varrzlt / (len - 1);
    s +=
      "\\[This \\space value \\space is \\space now \\space divided \\space by \\space the \\space (length - 1)\\]";
    s +=
      "\\[\\space = \\space \\frac{" +
      varrzlt.toFixed(2) +
      "}{" +
    ...
    s +=
      "\\[Finally, \\space the \\space Coeffecient \\space of \\space Variation \\space will \\space be,\\]";
    s +=
      "\\[\\space = \\space \\frac{(\\sqrt{" +
      varrzlt.toFixed(2) +
      "})}{" +
      mean +
      "}\\]";
    s +=
      "\\[\\space = \\space \\frac{" + sdev.toFixed(2) + "}{" + mean + "}\\]";
...
function rmscal() {
  ...
  if (num == "") {
    ...
    answer +=
      "\\[RMS \\space = \\space \\sqrt{\\frac{1}{" +
      len +
      "} \\times " +
      sum.toFixed(4) +
      "}\\]";
    answer +=
      "\\[RMS \\space = \\space \\sqrt{" +
      1 / len.toFixed(4) +
      " \\times " +
      sum.toFixed(4) +
      "}\\]";
    answer +=
      "\\[RMS \\space = \\space \\sqrt{" + (1 / len) * sum.toFixed(4) + "}\\]";
    answer +=
      "\\[RMS \\space = \\space " +
      Math.sqrt((1 / len) * sum).toFixed(4) +
      "\\]";
    answer +=
      "\\[The \\space root \\space mean  \\space square \\space of\\space  given\\space  input \\space is: " +
      rmss.toFixed(4) +
      "\\]";
  }
...
function pvaluecal() {
  ...
  if (isNaN(z)) {
    ...
    exp +=
      "\\[\\phi (Z)\\space = \\space frac{1}{\\sqrt{(2\\times \\pi)} \\times (e)^{frac{z^2}{2}}} \\]";
    exp +=
      "\\[P\\space value\\space = \\space 2\\times frac{1}{\\sqrt{(2\\times 3.14)} \\times (2.71)^{frac{" +
      z +
      "^2}{2}}}\\]";
...
function zscorecal() {
  ...
  if (isNaN(a) || isNaN(b) || isNaN(c)) {
    ...
    if (b < 0) {
      temp +=
        "\\[Z \\space Score \\space = \\space \\frac{Raw \\space Score \\space (X) \\space - \\space Population \\space Mean \\space (μ)}{Standard \\space Deviation \\space (σ)} \\]";
      temp +=
        "\\[Z \\space Score \\space = \\space \\frac {" +
        a +
        "- (" +
        b +
        ")}{" +
...
function suppangcal() {
  ...
  if (a == "") {
    ...
    var v = 180 - t;
    ans =
      "\\[The \\space supplementary \\space angle \\space of \\space" +
      a +
      " \\space will \\space be \\newline 180 \\degree \\space - \\space t \\degree \\newline 180 \\degree \\space - \\space " +
      t +
      " \\degree \\newline = \\space " +
      v +
      " \\degree \\]";
  ...
  if (a == "" || b == "") {
    ...
    if (x + y == 180)
      ans =
        ...
        " \\degree \\space + \\space " +
        b +
        " \\degree \\space = 180 \\degree \\newline Hence, \\newline Both \\space the \\space entered \\space angles \\space " +
        a +
        "\\degree \\space and \\space " +
        b +
...
function compangcal() {
  ...
  if (a == "") {
    ...
    var v = 90 - t;
    ans =
      "\\[The \\space complementary \\space angle \\space of \\space" +
      a +
      " \\space will \\space be \\newline 90 \\degree \\space - \\space t \\degree \\newline 90 \\degree \\space - \\space " +
      t +
      " \\degree \\newline = \\space " +
      v +
      " \\degree \\]";
  ...
  if (a == "" || b == "") {
    ...
    if (m1 == m2 || Math.abs(m1) + Math.abs(m2) == 360)
      ans =
        "\\[Here \\space \\space " +
        a +
        " \\degree \\space mod \\space360 \\degree \\space = " +
        b +
        " \\degree \\space mod \\space 360 \\degree \\newline Hence,Both \\space the \\space entered \\space angles \\space " +
        a +
        "\\degree \\space and \\space " +
        b +
...
function skewcal() {
  ...
  if (num == "") {
    ...
    steps +=
      "\\[Sum\\space of\\space data\\space set\\space you\\space entered:\\space " +
      sum +
      " \\]";
    sum = sum / len;
    var ansno = 0;
    ...
    steps +=
      "\\[Now\\space calculate\\space the\\space Mean\\space and\\space the\\space Standard\\space Deviation\\]";
    steps +=
      "\\[Subtract\\space the\\space mean\\space from\\space each\\space raw\\space score\\]";
    steps +=
      "\\[Raise\\space each\\space of\\space these\\space deviations\\space from\\space the\\space mean\\space to\\space the\\space third\\space power\\space and\\space sum\\]";
    steps +=
      "\\[Skewness\\space = \\space sum\\space of\\space the\\space deviations\\space from\\space the\\space mean,\\space raise\\space to\\space the\\space third\\space power,\\space divided\\space by\\space number\\space of\\space cases\\space minus\\space 1,\\space times\\space the\\space standard\\space deviation\\space raised\\space to\\space the\\space third\\space power.</p>\\]";
    var varrzlt = 0;
    for (i = 0; i < len; i++) {
...
function kurtcal() {
  ...
  if (num == "" || num1 == "") {
    ...
    ans +=
      "\\[\\sigma => Standard \\space deviation \\space of \\space the \\space sample\\]";
    ans += "\\[\\bar{x} => Mean \\space of \\space the \\space sample\\]";
    ans += "\\[N=>Sample \\space size\\]";

    ans +=
      "\\[Measure \\space of \\space kurtosis \\space \\beta_2 = \\frac{\\mu_4}{\\sigma^{4}}\\]";
    ans +=
      "\\[\\because \\mu_4= \\frac{\\sum_{i=1}^{n} (x_i- \\bar{x})^{4}}{N} \\]";
    ans +=
      "\\[\\therefore \\beta_2 = \\frac{\\sum_{i=1}^{n} (x_i- \\bar{x})^{4}}{N\\sigma^{4}} \\]";
    ans +=
      "\\[\\beta_2 = \\frac{" +
      numer +
      "}{ (" +
    ...
    ans +=
      ...
      n1 +
      " \\times " +
      Math.pow(num1, 4).toFixed(4) +
      "} \\]";
    ans +=
      "\\[\\beta_2 = " +
      (numer / (n1 * Math.pow(num1, 4)).toFixed(4)).toFixed(4) +
      "\\]";

    if ((numer / (n1 * Math.pow(num1, 4)).toFixed(4)).toFixed(4) == 3)
      ans +=
        "\\[Since \\space \\beta_2 \\space is \\space equal \\space to \\space 3 \\space the  \\space distribution  \\space is  \\space mesokurtic. \\]";
    else if ((numer / (n1 * Math.pow(num1, 4)).toFixed(4)).toFixed(4) > 3)
      ans +=
        "\\[Since \\space \\beta_2 \\space > \\space 3 \\space the  \\space distribution  \\space is  \\space leptokurtic. \\]";
    else if ((numer / (n1 * Math.pow(num1, 4)).toFixed(4)).toFixed(4) < 3)
      ans +=
        "\\[Since \\space \\beta_2 \\space < \\space 3 \\space the  \\space distribution  \\space is  \\space platykurtic. \\]";
  }
...
function bmifind() {
  ...
  if (a == "" || b == "" || c == "") {
    ...
    var vi =
      "The B.M.I is the ratio of your weight in kg and your height in metre's square<br>";
...
function clockcal() {
  ...
  if (a == "" || b == "") {
    ...
    ans =
      "Angle from minute to hour hands: " +
      Math.abs(anghour - angmin) +
      " degree";
    ans += "<br>";
    ans +=
      "Angle from hour to minute hands: " +
      Math.abs(360 - Math.abs(anghour - angmin)) +
      " degree";
  }
...
function traprzlt() {
  ...
  if (isNaN(a) || isNaN(b) || isNaN(c) || isNaN(d)) {
    ...
    temp += "\\[" + c + "\\times" + k + " \\]";
    temp +=
      "\\[ Area \\space of \\space Trapezoid \\space is \\space" +
      traparea +
      "\\]";
    temp +=
      "\\[" +
    ...
    temp +=
      "\\[ Volume \\space of \\space Trapezoid \\space is \\space" +
      trapvol +
      "\\]";
    output.innerHTML = temp;
    renderMathInElement(output);
...
function perrankcal() {
  ...
  if (num == "" || num2 == "") {
    ...
    document.getElementById("perrankans3").innerHTML =
      "\\[\\frac{Number \\space of \\space times \\space " +
      num2 +
      " \\space was \\space > or \\space = \\space any \\space marks \\space form \\space all \\space marks \\space dataset}{Total \\space no. \\space of \\space data \\space in \\space dataset} \\times 100 \\]";
    renderMathInElement(document.getElementById("perrankans3"));
    document.getElementById("perrankans").innerHTML =
      "\\[Hence, \\space the \\space percentile \\space rank \\space for \\space given \\space marks \\space is: \\space \\newline \\frac{" +
      count +
      "}{" +
      len +
      "} \\times 100 = " +
...
function halflifeCalc() {
  ...
  if (decay == "") {
    //   answer="";
    //   ans="";
    document.getElementById("halflifeAns").innerHTML =
...
function oocal() {
  ...
  if (num4 == "") {
    ...
    answer +=
      "\\[Here, \\space N = \\space no \\space whose \\space order \\space of \\space magintude \\space we \\space have \\space to \\space find\\]";
    answer +=
      "\\[n \\space should \\space be \\space in \\space the \\space range : 0.5 < n \\leq 5\\]";
    answer += "\\[x \\space => \\space order \\space of \\space magnitude \\]";
    answer +=
      "\\[N \\space = \\space " + num4 + " \\times 10 ^ {" + count + "} \\]";
    answer +=
      "\\[The \\space order \\space of \\space mangnitude \\space is : " +
      count +
      "\\]";
  }
...
function mifcal() {
  ...
  if (num1 == "" || num2 == "") {
    ...
    num2 = parseFloat(num2);
    ans +=
      "\\[[Note \\space :- \\space Multiplicative \\space Inverse \\space of \\space a \\space number \\space is \\space an \\space another \\space number \\space which \\]";
    ans +=
      "\\[\\space when \\space multiplied \\space with \\space it, \\space always \\space gives \\space 1 ] \\]";
    ans +=
      "\\[Divide \\space the \\space number \\space by \\space 1 \\space\\]";
    ans +=
      "\\[Multiplicative \\space inverse \\space of \\space \\frac{" +
      num1 +
      "}{" +
      num2 +
      "} \\space = \\space \\frac{1}{\\frac{" +
      num1 +
      "}{" +
      num2 +
      "}}\\]";
...
function ainvcal() {
  ...
  if (num == "") {
    ...
    ans1 = -1 * num;
    ans +=
      "\\[[Note \\space :- \\space Additive \\space Inverse \\space of \\space a \\space number \\space is \\space an \\space another \\space number \\space which\\]";
    ans +=
      "\\[ \\space on \\space adding \\space with \\space the \\space original \\space number \\space results \\space in \\space zero \\space value. ]\\]";
    ans +=
      "\\[Additive \\space Inverse \\space of \\space" +
      num +
      " \\space = \\space (" +
      -1 +
      ") \\times " +
...
function hypergeos2cal() {
  ...
  if (isNaN(num1) || isNaN(num2) || isNaN(num3) || isNaN(num4)) {
    ...
    var d = (num2 * num3) / num4;
    temp +=
      "\\[The \\space value \\space of \\space hypergeometric \\space distribution \\space mean \\space will \\space be,\\]";
    temp +=
      "\\[\\space = \\space \\frac{(Sample \\space Size) \\times (Successes \\space of \\space Lot)}{(Lot \\space Size)}\\]";
    temp +=
      "\\[\\space = \\space \\frac{(" +
      num2 +
      ") \\times (" +
    ...
    temp +=
      "\\[Hence, \\space the \\space value \\space of \\space mean \\space is,\\]";
...
function hypergeosvarcal() {
  ...
  if (isNaN(num2) || isNaN(num1) || isNaN(num3) || isNaN(num4)) {
    ...
    temp +=
      "\\[\\space = \\space \\frac{ " +
      num2 * num3 * (num4 - num3)(num4 - num2) +
      " }{" +
      num4 * num4(num4 - 1) +
      "}\\]";
    temp += "\\[\\space = \\space " + d.toFixed(3) + "\\]";
    temp +=
      "\\[Hence, \\space the \\space values \\space Hypergeometric \\space Standard \\space Deviation \\space is,\\]";
...
function hypergeosvar2cal() {
  ...
  var d =
    (num2 * num3 * (num4 - num3) * (num4 - num2)) / (num4 * num4 * (num4 - 1));
  var ans = Math.sqrt(d);
  var output = document.getElementById("hypergeos2ans");
  var temp = "";
  if (isNaN(num2) || isNaN(num1) || isNaN(num3) || isNaN(num4)) {
    ...
    temp +=
      "\\[Hypergeometric \\space Standard \\space Deviation \\space will \\space be,\\]";
    temp +=
      "\\[\\space = \\space \\frac{ (" +
      num2 +
      " \\times " +
...
function egccal() {
  ...
  if (num1 == "" || num2 == "" || num3 == "") {
    ...
    ans =
      "\\[The \\space effective \\space rate \\space of \\space growth \\space is: " +
      si +
      "\\]";
    explain =
      "\\[x(t)=" +
...
function iskaprekar(n) {
  ...
  for (let r_digits = 1; r_digits < count_digits; r_digits++) {
    ...
    let sum = parseInt(sq_n1 / eq_parts + (sq_n1 % eq_parts));
...
function kapfind() {
  ...
  if (num == "" || isNaN(num)) {
    ...
    ans += `<br> Step 2: The Square of ${num} => ${num}^2 = ${Math.pow(
      num,
      2
    )}`;
    if (iskaprekar(num)) {
  ...
  if (num1 == "" || isNaN(num1)) {
    ...
    if (isPrime(num1) && isPowerOfTwo(num1 * 3 - 1)) {
      ...
      explain =
        "\\[" +
        num1 +
        "\\space is \\space prime \\space and \\space" +
        num1 +
        "=" +
        "\\frac{2^{" +
        Math.log2(num1 * 3 - 1) +
