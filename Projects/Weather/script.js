...
<!-- 
<img src="https://png.pngtree.com/png-vector/20220607/ourmid/pngtree-cloudy-thunder-cloud-bolt-climate-png-image_4812793.png"
    alt="cloud-image" width="50" height="60">
 -->
...
<body>
    ...
    <div class="container">
        ...
        <main>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-dark">Click here for more details</button>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Humidity Related Information</h4>
                        </div>
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title"><span id="humidity2"> </span></li><small
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-dark">Know more</button>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm border-primary">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Wind Related Information</h4>
                        </div>
                        <div class="card-body">
            ...
            <!-- Not responsive as of now create object of each and do-->
            <!-- 
